	component gmii2rgmii is
		port (
			...
			pll_50m_clock_clk      : in  std_logic                    := 'X';             -- clk
			pll_5m_clock_clk       : in  std_logic                    := 'X';             -- clk
	...
	u0 : component gmii2rgmii
		port map (
			...
			pll_50m_clock_clk      => CONNECTED_TO_pll_50m_clock_clk,      --  pll_50m_clock.clk
			pll_5m_clock_clk       => CONNECTED_TO_pll_5m_clock_clk,       --   pll_5m_clock.clk
