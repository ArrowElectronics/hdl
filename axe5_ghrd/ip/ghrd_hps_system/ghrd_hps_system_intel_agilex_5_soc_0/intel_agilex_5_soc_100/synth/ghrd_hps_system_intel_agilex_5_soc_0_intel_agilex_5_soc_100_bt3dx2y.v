// ghrd_hps_system_intel_agilex_5_soc_0_intel_agilex_5_soc_100_bt3dx2y.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_intel_agilex_5_soc_0_intel_agilex_5_soc_100_bt3dx2y (
	...
	ghrd_hps_system_intel_agilex_5_soc_0_intel_sundancemesa_hps_100_owam7qi sm_hps (
	...
	ghrd_hps_system_intel_agilex_5_soc_0_intel_sundancemesa_mpfe_100_xbjeczi sm_mpfe (
		.emif_csr_axi_clk      (emif0_csr_axi_clk_clk),                  //   input,    width = 1,         emif0_csr_axi_clk.clk
		.emif_csr_axi_rst      (emif0_csr_axi_rst_reset_n),              //   input,    width = 1,         emif0_csr_axi_rst.reset_n
		.emif_mem_cfg_arready  (emif0_csr_axi_arready),                  //   input,    width = 1,             emif0_csr_axi.arready
		.emif_mem_cfg_awready  (emif0_csr_axi_awready),                  //   input,    width = 1,                          .awready
		.emif_mem_cfg_bresp    (emif0_csr_axi_bresp),                    //   input,    width = 2,                          .bresp
		.emif_mem_cfg_bvalid   (emif0_csr_axi_bvalid),                   //   input,    width = 1,                          .bvalid
		.emif_mem_cfg_rdata    (emif0_csr_axi_rdata),                    //   input,   width = 32,                          .rdata
		.emif_mem_cfg_rresp    (emif0_csr_axi_rresp),                    //   input,    width = 2,                          .rresp
		.emif_mem_cfg_rvalid   (emif0_csr_axi_rvalid),                   //   input,    width = 1,                          .rvalid
		.emif_mem_cfg_wready   (emif0_csr_axi_wready),                   //   input,    width = 1,                          .wready
		.emif_mem_cfg_araddr   (emif0_csr_axi_araddr),                   //  output,   width = 32,                          .araddr
		.emif_mem_cfg_arvalid  (emif0_csr_axi_arvalid),                  //  output,    width = 1,                          .arvalid
		.emif_mem_cfg_awaddr   (emif0_csr_axi_awaddr),                   //  output,   width = 32,                          .awaddr
		.emif_mem_cfg_awvalid  (emif0_csr_axi_awvalid),                  //  output,    width = 1,                          .awvalid
		.emif_mem_cfg_bready   (emif0_csr_axi_bready),                   //  output,    width = 1,                          .bready
		.emif_mem_cfg_rready   (emif0_csr_axi_rready),                   //  output,    width = 1,                          .rready
		.emif_mem_cfg_wdata    (emif0_csr_axi_wdata),                    //  output,   width = 32,                          .wdata
		.emif_mem_cfg_wstrb    (emif0_csr_axi_wstrb),                    //  output,    width = 4,                          .wstrb
		.emif_mem_cfg_wvalid   (emif0_csr_axi_wvalid),                   //  output,    width = 1,                          .wvalid
		.emif_mem_cfg_arprot   (emif0_csr_axi_arprot),                   //  output,    width = 3,                          .arprot
		.emif_mem_cfg_awprot   (emif0_csr_axi_awprot),                   //  output,    width = 3,                          .awprot
		.emif_ch0_axi_clk      (emif0_ch0_axi_clk_clk),                  //   input,    width = 1,         emif0_ch0_axi_clk.clk
		.emif_ch0_axi_rst      (emif0_ch0_axi_rst_reset_n),              //   input,    width = 1,         emif0_ch0_axi_rst.reset_n
		.emif0_arready         (emif0_ch0_axi_arready),                  //   input,    width = 1,             emif0_ch0_axi.arready
		.emif0_awready         (emif0_ch0_axi_awready),                  //   input,    width = 1,                          .awready
		.emif0_bid             (emif0_ch0_axi_bid),                      //   input,    width = 7,                          .bid
		.emif0_bresp           (emif0_ch0_axi_bresp),                    //   input,    width = 2,                          .bresp
		.emif0_bvalid          (emif0_ch0_axi_bvalid),                   //   input,    width = 1,                          .bvalid
		.emif0_rdata           (emif0_ch0_axi_rdata),                    //   input,  width = 256,                          .rdata
		.emif0_rid             (emif0_ch0_axi_rid),                      //   input,    width = 7,                          .rid
		.emif0_rlast           (emif0_ch0_axi_rlast),                    //   input,    width = 1,                          .rlast
		.emif0_rresp           (emif0_ch0_axi_rresp),                    //   input,    width = 2,                          .rresp
		.emif0_ruser           (emif0_ch0_axi_ruser),                    //   input,   width = 32,                          .ruser
		.emif0_rvalid          (emif0_ch0_axi_rvalid),                   //   input,    width = 1,                          .rvalid
		.emif0_wready          (emif0_ch0_axi_wready),                   //   input,    width = 1,                          .wready
		.emif0_araddr          (emif0_ch0_axi_araddr),                   //  output,   width = 44,                          .araddr
		.emif0_arburst         (emif0_ch0_axi_arburst),                  //  output,    width = 2,                          .arburst
		.emif0_arid            (emif0_ch0_axi_arid),                     //  output,    width = 7,                          .arid
		.emif0_arlen           (emif0_ch0_axi_arlen),                    //  output,    width = 8,                          .arlen
		.emif0_arlock          (emif0_ch0_axi_arlock),                   //  output,    width = 1,                          .arlock
		.emif0_arqos           (emif0_ch0_axi_arqos),                    //  output,    width = 4,                          .arqos
		.emif0_arsize          (emif0_ch0_axi_arsize),                   //  output,    width = 3,                          .arsize
		.emif0_aruser          (emif0_ch0_axi_aruser),                   //  output,   width = 14,                          .aruser
		.emif0_arvalid         (emif0_ch0_axi_arvalid),                  //  output,    width = 1,                          .arvalid
		.emif0_awaddr          (emif0_ch0_axi_awaddr),                   //  output,   width = 44,                          .awaddr
		.emif0_awburst         (emif0_ch0_axi_awburst),                  //  output,    width = 2,                          .awburst
		.emif0_awid            (emif0_ch0_axi_awid),                     //  output,    width = 7,                          .awid
		.emif0_awlen           (emif0_ch0_axi_awlen),                    //  output,    width = 8,                          .awlen
		.emif0_awlock          (emif0_ch0_axi_awlock),                   //  output,    width = 1,                          .awlock
		.emif0_awqos           (emif0_ch0_axi_awqos),                    //  output,    width = 4,                          .awqos
		.emif0_awsize          (emif0_ch0_axi_awsize),                   //  output,    width = 3,                          .awsize
		.emif0_awuser          (emif0_ch0_axi_awuser),                   //  output,   width = 14,                          .awuser
		.emif0_awvalid         (emif0_ch0_axi_awvalid),                  //  output,    width = 1,                          .awvalid
		.emif0_bready          (emif0_ch0_axi_bready),                   //  output,    width = 1,                          .bready
		.emif0_rready          (emif0_ch0_axi_rready),                   //  output,    width = 1,                          .rready
		.emif0_wdata           (emif0_ch0_axi_wdata),                    //  output,  width = 256,                          .wdata
		.emif0_wlast           (emif0_ch0_axi_wlast),                    //  output,    width = 1,                          .wlast
		.emif0_wstrb           (emif0_ch0_axi_wstrb),                    //  output,   width = 32,                          .wstrb
		.emif0_wuser           (emif0_ch0_axi_wuser),                    //  output,   width = 32,                          .wuser
		.emif0_wvalid          (emif0_ch0_axi_wvalid),                   //  output,    width = 1,                          .wvalid
		.emif0_arprot          (emif0_ch0_axi_arprot),                   //  output,    width = 3,                          .arprot
		.emif0_awprot          (emif0_ch0_axi_awprot),                   //  output,    width = 3,                          .awprot
