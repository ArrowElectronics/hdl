...
module hps_ready_latency_adp_conduit # (
...
// aw channel
 ...
 // aw channel 
  ...
  assign indata_aw = {awready,awvalid,awid,awaddr,awlen,awsize,awburst,awlock,awuser,awqos,awbar,awcache,awdomain,awprot,awsnoop,awregion,awstashid,awstashiden,awstashlpid,awstashlpiden,awatop };
  ...
  assign {awready_r,awvalid_r,awid_r,awaddr_r,awlen_r,awsize_r,awburst_r,awlock_r,awuser_r,awqos_r,awbar_r,awcache_r,awdomain_r,awprot_r,awsnoop_r,awregion_r,awstashid_r,awstashiden_r,awstashlpid_r,awstashlpiden_r,awatop_r } = outdata_aw;


 // ar channel 

 assign indata_ar = {arready,arvalid,arid,araddr,arlen,arsize,arburst,arlock,aruser,arqos,arbar,arcache,ardomain,arprot,arsnoop,arregion};
  ...
  assign {arready_r,arvalid_r,arid_r,araddr_r,arlen_r,arsize_r,arburst_r,arlock_r,aruser_r,arqos_r,arbar_r,arcache_r,ardomain_r,arprot_r,arsnoop_r,arregion_r} = outdata_ar;
...
module hps_ready_latency_adp_acelite # (
parameter LOG_DEPTH =3 ,
parameter NUM_PIPELINES =2,
parameter ID_WIDTH = 5,
parameter ADDR_WIDTH =44,
...
// aw channel
 ...
 // aw channel 
  ...
  assign indata_aw = {awready,awvalid,awid,awaddr,awlen,awsize,awburst,awlock,awuser,awqos,awbar,awcache,awdomain,awprot,awsnoop,awregion};
  ...
  assign {awready_r,awvalid_r,awid_r,awaddr_r,awlen_r,awsize_r,awburst_r,awlock_r,awuser_r,awqos_r,awbar_r,awcache_r,awdomain_r,awprot_r,awsnoop_r,awregion_r} = outdata_aw;
...
module hps_ready_latency_adp_axi5 # (
parameter LOG_DEPTH =3 ,
parameter NUM_PIPELINES =2,
parameter ID_WIDTH = 5,
parameter ADDR_WIDTH =44,
