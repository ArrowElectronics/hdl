// ghrd_hps_system_emif_ph2_0_emif_ph2_400_32btuby.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_emif_ph2_0_emif_ph2_400_32btuby (
	...
	ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy #(
		.PHY_NOC_EN                (0),
		...
		.mem_lbd_0            (1'b0),                                      // (terminated),                                 
		.mem_lbs_0            (1'b0)                                       // (terminated),                                 
	);

	ghrd_hps_system_emif_ph2_0_emif_ph2_cal_210_igfd5fi calip_0 (
		...
		.s0_axil_clk                 (s0_axil_clk),                               //   input,      width = 1,     s0_axil_clk.clk
		.s0_axil_rst_n               (s0_axil_rst_n),                             //   input,      width = 1,   s0_axil_rst_n.reset_n
		.s0_axil_awaddr              (s0_axil_awaddr),                            //   input,     width = 27,         s0_axil.awaddr
		.s0_axil_awvalid             (s0_axil_awvalid),                           //   input,      width = 1,                .awvalid
		.s0_axil_awready             (s0_axil_awready),                           //  output,      width = 1,                .awready
		.s0_axil_wdata               (s0_axil_wdata),                             //   input,     width = 32,                .wdata
		.s0_axil_wstrb               (s0_axil_wstrb),                             //   input,      width = 4,                .wstrb
		.s0_axil_wvalid              (s0_axil_wvalid),                            //   input,      width = 1,                .wvalid
		.s0_axil_wready              (s0_axil_wready),                            //  output,      width = 1,                .wready
		.s0_axil_bresp               (s0_axil_bresp),                             //  output,      width = 2,                .bresp
		.s0_axil_bvalid              (s0_axil_bvalid),                            //  output,      width = 1,                .bvalid
		.s0_axil_bready              (s0_axil_bready),                            //   input,      width = 1,                .bready
		.s0_axil_araddr              (s0_axil_araddr),                            //   input,     width = 27,                .araddr
		.s0_axil_arvalid             (s0_axil_arvalid),                           //   input,      width = 1,                .arvalid
		.s0_axil_arready             (s0_axil_arready),                           //  output,      width = 1,                .arready
		.s0_axil_rdata               (s0_axil_rdata),                             //  output,     width = 32,                .rdata
		.s0_axil_rresp               (s0_axil_rresp),                             //  output,      width = 2,                .rresp
		.s0_axil_rvalid              (s0_axil_rvalid),                            //  output,      width = 1,                .rvalid
		.s0_axil_rready              (s0_axil_rready),                            //   input,      width = 1,                .rready
		.s0_axil_awprot              (s0_axil_awprot),                            //   input,      width = 3,                .awprot
		.s0_axil_arprot              (s0_axil_arprot)                             //   input,      width = 3,                .arprot
	);
