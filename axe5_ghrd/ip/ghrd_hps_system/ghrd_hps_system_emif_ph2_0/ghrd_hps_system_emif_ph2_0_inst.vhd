	component ghrd_hps_system_emif_ph2_0 is
		port (
			ref_clk_0       : in    std_logic                      := 'X';             -- clk
			core_init_n_0   : in    std_logic                      := 'X';             -- reset_n
			usr_async_clk_0 : in    std_logic                      := 'X';             -- clk
			...
			s0_axil_clk     : in    std_logic                      := 'X';             -- clk
			s0_axil_rst_n   : in    std_logic                      := 'X';             -- reset_n
			s0_axil_awaddr  : in    std_logic_vector(26 downto 0)  := (others => 'X'); -- awaddr
			s0_axil_awvalid : in    std_logic                      := 'X';             -- awvalid
			s0_axil_awready : out   std_logic;                                         -- awready
			s0_axil_wdata   : in    std_logic_vector(31 downto 0)  := (others => 'X'); -- wdata
			s0_axil_wstrb   : in    std_logic_vector(3 downto 0)   := (others => 'X'); -- wstrb
			s0_axil_wvalid  : in    std_logic                      := 'X';             -- wvalid
			s0_axil_wready  : out   std_logic;                                         -- wready
			s0_axil_bresp   : out   std_logic_vector(1 downto 0);                      -- bresp
			s0_axil_bvalid  : out   std_logic;                                         -- bvalid
			s0_axil_bready  : in    std_logic                      := 'X';             -- bready
			s0_axil_araddr  : in    std_logic_vector(26 downto 0)  := (others => 'X'); -- araddr
			s0_axil_arvalid : in    std_logic                      := 'X';             -- arvalid
			s0_axil_arready : out   std_logic;                                         -- arready
			s0_axil_rdata   : out   std_logic_vector(31 downto 0);                     -- rdata
			s0_axil_rresp   : out   std_logic_vector(1 downto 0);                      -- rresp
			s0_axil_rvalid  : out   std_logic;                                         -- rvalid
			s0_axil_rready  : in    std_logic                      := 'X';             -- rready
			s0_axil_awprot  : in    std_logic_vector(2 downto 0)   := (others => 'X'); -- awprot
			s0_axil_arprot  : in    std_logic_vector(2 downto 0)   := (others => 'X')  -- arprot
		);
	end component ghrd_hps_system_emif_ph2_0;

	u0 : component ghrd_hps_system_emif_ph2_0
		port map (
			ref_clk_0       => CONNECTED_TO_ref_clk_0,       --       ref_clk_0.clk
			core_init_n_0   => CONNECTED_TO_core_init_n_0,   --   core_init_n_0.reset_n
			usr_async_clk_0 => CONNECTED_TO_usr_async_clk_0, -- usr_async_clk_0.clk
			...
			s0_axil_clk     => CONNECTED_TO_s0_axil_clk,     --     s0_axil_clk.clk
			s0_axil_rst_n   => CONNECTED_TO_s0_axil_rst_n,   --   s0_axil_rst_n.reset_n
			s0_axil_awaddr  => CONNECTED_TO_s0_axil_awaddr,  --         s0_axil.awaddr
			s0_axil_awvalid => CONNECTED_TO_s0_axil_awvalid, --                .awvalid
			s0_axil_awready => CONNECTED_TO_s0_axil_awready, --                .awready
			s0_axil_wdata   => CONNECTED_TO_s0_axil_wdata,   --                .wdata
			s0_axil_wstrb   => CONNECTED_TO_s0_axil_wstrb,   --                .wstrb
			s0_axil_wvalid  => CONNECTED_TO_s0_axil_wvalid,  --                .wvalid
			s0_axil_wready  => CONNECTED_TO_s0_axil_wready,  --                .wready
			s0_axil_bresp   => CONNECTED_TO_s0_axil_bresp,   --                .bresp
			s0_axil_bvalid  => CONNECTED_TO_s0_axil_bvalid,  --                .bvalid
			s0_axil_bready  => CONNECTED_TO_s0_axil_bready,  --                .bready
			s0_axil_araddr  => CONNECTED_TO_s0_axil_araddr,  --                .araddr
			s0_axil_arvalid => CONNECTED_TO_s0_axil_arvalid, --                .arvalid
			s0_axil_arready => CONNECTED_TO_s0_axil_arready, --                .arready
			s0_axil_rdata   => CONNECTED_TO_s0_axil_rdata,   --                .rdata
			s0_axil_rresp   => CONNECTED_TO_s0_axil_rresp,   --                .rresp
			s0_axil_rvalid  => CONNECTED_TO_s0_axil_rvalid,  --                .rvalid
			s0_axil_rready  => CONNECTED_TO_s0_axil_rready,  --                .rready
			s0_axil_awprot  => CONNECTED_TO_s0_axil_awprot,  --                .awprot
			s0_axil_arprot  => CONNECTED_TO_s0_axil_arprot   --                .arprot
		);
