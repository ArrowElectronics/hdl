...
module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_fbr_axi_adapter_wide #(
   ...
   generate
      if (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_hmc::IS_USED[WS])
      begin : gen_fbr_axi_adapt_outputs
         ...
         assign core_to_fahmc[ 79: 78]    = {2{1'b0}};                            
   ...
   assign internal_axi_intf.awlen[6:0]          = `ZERO_PAD_PORT(PORT_AXI_AXLEN_WIDTH,   7, fbr_axi_intf.awlen);
   ...
   assign internal_axi_intf.arlen[6:0]          = `ZERO_PAD_PORT(PORT_AXI_AXLEN_WIDTH,   7, fbr_axi_intf.arlen);
   ...
   generate
      if (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_hmc::IS_USED[WS])
   ...
   generate
      if (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_hmc::IS_USED[WS] || ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_hmc::IS_USED[WS])
