module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy #(
   ...
   inout  tri              i3c_sda_0,
   input  logic            mem_lbd_0,
   input  logic            mem_lbs_0,
   input  logic            oct_rzqin_0
);
   timeunit 1ns;
   timeprecision 1ps;

   ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_top # (
   ...
   ) ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_inst (
      .ref_clk_0 (ref_clk_0),
      .core_init_n_0 (core_init_n_0),
      .usr_async_clk_0 (usr_async_clk_0),
