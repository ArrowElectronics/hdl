...
module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_hmc_slim #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_hmc_slim::*;
   ...
   generate 
      if (IS_USED) begin : gen_tennm_slim 
         tennm_hmc # (
            ...
            .i_noc_axi_wuser                  (fanoc_hmc_axi_intf.wuser),
            ...
            .o_noc_axi_ruser                  (fanoc_hmc_axi_intf.ruser),
