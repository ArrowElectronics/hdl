...
module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_pll #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_pll::*;
