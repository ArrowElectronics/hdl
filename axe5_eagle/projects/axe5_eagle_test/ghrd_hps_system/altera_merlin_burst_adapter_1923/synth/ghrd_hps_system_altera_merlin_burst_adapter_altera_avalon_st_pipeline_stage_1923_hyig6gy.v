// ghrd_hps_system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_hyig6gy.v

// Generated using ACDS version 23.2.1 194

`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_hyig6gy #(
	...
	ghrd_hps_system_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 128,          .data
		...
		.out_data          (out_data),          //  output,  width = 128,          .data
