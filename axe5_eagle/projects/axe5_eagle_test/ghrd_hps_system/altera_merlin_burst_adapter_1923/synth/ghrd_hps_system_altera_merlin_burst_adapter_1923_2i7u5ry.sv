...
// parameterization.
// -----------------------------------------------------
module ghrd_hps_system_altera_merlin_burst_adapter_1923_2i7u5ry 
#(
    parameter 
...
(
    ...
    generate if (COMPRESSED_READ_SUPPORT == 0) begin : altera_merlin_burst_adapter_uncompressed_only
        ...
        if(PIPE_INPUTS == 1) begin: pipe_inputs
            ghrd_hps_system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_hyig6gy # (
                .SYMBOLS_PER_BEAT (1),
