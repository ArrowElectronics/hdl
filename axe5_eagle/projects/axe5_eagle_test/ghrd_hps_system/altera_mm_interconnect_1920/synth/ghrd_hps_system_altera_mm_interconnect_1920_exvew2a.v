// ghrd_hps_system_altera_mm_interconnect_1920_exvew2a.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_exvew2a (
	...
	wire  [127:0] emif_bank2a_s0_axil_agent_write_rp_data;                            // emif_bank2a_s0_axil_agent:write_rp_data -> router_002:sink_data
	...
	wire  [127:0] emif_bank2a_s0_axil_agent_read_rp_data;                             // emif_bank2a_s0_axil_agent:read_rp_data -> router_003:sink_data
	...
	wire  [127:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> emif_bank2a_s0_axil_wr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                  // emif_bank2a_s0_axil_wr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> emif_bank2a_s0_axil_wr_burst_adapter:sink0_channel
	...
	wire  [127:0] emif_bank2a_s0_axil_wr_burst_adapter_source0_data;                  // emif_bank2a_s0_axil_wr_burst_adapter:source0_data -> emif_bank2a_s0_axil_agent:write_cp_data
	...
	wire    [2:0] emif_bank2a_s0_axil_wr_burst_adapter_source0_channel;               // emif_bank2a_s0_axil_wr_burst_adapter:source0_channel -> emif_bank2a_s0_axil_agent:write_cp_channel
	...
	wire  [127:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> emif_bank2a_s0_axil_rd_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                              // emif_bank2a_s0_axil_rd_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> emif_bank2a_s0_axil_rd_burst_adapter:sink0_channel
	...
	wire  [127:0] emif_bank2a_s0_axil_rd_burst_adapter_source0_data;                  // emif_bank2a_s0_axil_rd_burst_adapter:source0_data -> emif_bank2a_s0_axil_agent:read_cp_data
	...
	wire    [2:0] emif_bank2a_s0_axil_rd_burst_adapter_source0_channel;               // emif_bank2a_s0_axil_rd_burst_adapter:source0_channel -> emif_bank2a_s0_axil_agent:read_cp_channel
	...
	ghrd_hps_system_altera_merlin_axi_slave_ni_1950_ur2l4ai #(
		...
		.read_cp_data           (emif_bank2a_s0_axil_rd_burst_adapter_source0_data),                 //   input,  width = 128,                  .data
		.read_cp_channel        (emif_bank2a_s0_axil_rd_burst_adapter_source0_channel),              //   input,    width = 3,                  .channel
		...
		.write_cp_data          (emif_bank2a_s0_axil_wr_burst_adapter_source0_data),                 //   input,  width = 128,                  .data
		.write_cp_channel       (emif_bank2a_s0_axil_wr_burst_adapter_source0_channel),              //   input,    width = 3,                  .channel
		...
		.read_rp_data           (emif_bank2a_s0_axil_agent_read_rp_data),                            //  output,  width = 128,                  .data
		...
		.write_rp_data          (emif_bank2a_s0_axil_agent_write_rp_data),                           //  output,  width = 128,                  .data
	...
	ghrd_hps_system_altera_merlin_router_1921_oimdcny router (
	...
	ghrd_hps_system_altera_merlin_router_1921_66se5ry router_001 (
	...
	ghrd_hps_system_altera_merlin_router_1921_6qt3ktq router_002 (
		...
		.sink_data          (emif_bank2a_s0_axil_agent_write_rp_data),                          //   input,  width = 128,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_qnva33a router_003 (
		...
		.sink_data          (emif_bank2a_s0_axil_agent_read_rp_data),                           //   input,  width = 128,          .data
	...
	ghrd_hps_system_altera_merlin_burst_adapter_1923_2i7u5ry #(
		...
		.source0_data          (emif_bank2a_s0_axil_wr_burst_adapter_source0_data),                //  output,  width = 128,          .data
		.source0_channel       (emif_bank2a_s0_axil_wr_burst_adapter_source0_channel),             //  output,    width = 3,          .channel
	...
	ghrd_hps_system_altera_merlin_burst_adapter_1923_2i7u5ry #(
		...
		.source0_data          (emif_bank2a_s0_axil_rd_burst_adapter_source0_data),                //  output,  width = 128,          .data
		.source0_channel       (emif_bank2a_s0_axil_rd_burst_adapter_source0_channel),             //  output,    width = 3,          .channel
