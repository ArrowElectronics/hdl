// niosv_sys_altera_mm_interconnect_1920_wuwmocy.v
...
`timescale 1 ps / 1 ps
module niosv_sys_altera_mm_interconnect_1920_wuwmocy (
		...
		input  wire [31:0] niosv_jtag_master_master_address,                                               //                                                 niosv_jtag_master_master.address
		output wire        niosv_jtag_master_master_waitrequest,                                           //                                                                         .waitrequest
		input  wire [3:0]  niosv_jtag_master_master_byteenable,                                            //                                                                         .byteenable
		input  wire        niosv_jtag_master_master_read,                                                  //                                                                         .read
		output wire [31:0] niosv_jtag_master_master_readdata,                                              //                                                                         .readdata
		output wire        niosv_jtag_master_master_readdatavalid,                                         //                                                                         .readdatavalid
		input  wire        niosv_jtag_master_master_write,                                                 //                                                                         .write
		input  wire [31:0] niosv_jtag_master_master_writedata,                                             //                                                                         .writedata
		...
		output wire [0:0]  niosv_dbg_uart_avalon_rs232_slave_address,                                      //                                        niosv_dbg_uart_avalon_rs232_slave.address
		output wire        niosv_dbg_uart_avalon_rs232_slave_write,                                        //                                                                         .write
		output wire        niosv_dbg_uart_avalon_rs232_slave_read,                                         //                                                                         .read
		input  wire [31:0] niosv_dbg_uart_avalon_rs232_slave_readdata,                                     //                                                                         .readdata
		output wire [31:0] niosv_dbg_uart_avalon_rs232_slave_writedata,                                    //                                                                         .writedata
		output wire [3:0]  niosv_dbg_uart_avalon_rs232_slave_byteenable,                                   //                                                                         .byteenable
		output wire        niosv_dbg_uart_avalon_rs232_slave_chipselect,                                   //                                                                         .chipselect
		...
		input  wire        niosv_dbg_uart_reset_reset_bridge_in_reset_reset,                               //                               niosv_dbg_uart_reset_reset_bridge_in_reset.reset
		...
		input  wire        niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset_reset, // niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset.reset
	...
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_waitrequest;   // niosv_jtag_master_master_agent:av_waitrequest -> niosv_jtag_master_master_translator:uav_waitrequest
	wire   [31:0] niosv_jtag_master_master_translator_avalon_universal_master_0_readdata;      // niosv_jtag_master_master_agent:av_readdata -> niosv_jtag_master_master_translator:uav_readdata
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_debugaccess;   // niosv_jtag_master_master_translator:uav_debugaccess -> niosv_jtag_master_master_agent:av_debugaccess
	wire   [31:0] niosv_jtag_master_master_translator_avalon_universal_master_0_address;       // niosv_jtag_master_master_translator:uav_address -> niosv_jtag_master_master_agent:av_address
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_read;          // niosv_jtag_master_master_translator:uav_read -> niosv_jtag_master_master_agent:av_read
	wire    [3:0] niosv_jtag_master_master_translator_avalon_universal_master_0_byteenable;    // niosv_jtag_master_master_translator:uav_byteenable -> niosv_jtag_master_master_agent:av_byteenable
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_readdatavalid; // niosv_jtag_master_master_agent:av_readdatavalid -> niosv_jtag_master_master_translator:uav_readdatavalid
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_lock;          // niosv_jtag_master_master_translator:uav_lock -> niosv_jtag_master_master_agent:av_lock
	wire          niosv_jtag_master_master_translator_avalon_universal_master_0_write;         // niosv_jtag_master_master_translator:uav_write -> niosv_jtag_master_master_agent:av_write
	wire   [31:0] niosv_jtag_master_master_translator_avalon_universal_master_0_writedata;     // niosv_jtag_master_master_translator:uav_writedata -> niosv_jtag_master_master_agent:av_writedata
	wire    [2:0] niosv_jtag_master_master_translator_avalon_universal_master_0_burstcount;    // niosv_jtag_master_master_translator:uav_burstcount -> niosv_jtag_master_master_agent:av_burstcount
	...
	wire   [31:0] niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdata;                         // niosv_dbg_uart_avalon_rs232_slave_translator:uav_readdata -> niosv_dbg_uart_avalon_rs232_slave_agent:m0_readdata
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_waitrequest;                      // niosv_dbg_uart_avalon_rs232_slave_translator:uav_waitrequest -> niosv_dbg_uart_avalon_rs232_slave_agent:m0_waitrequest
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_debugaccess;                      // niosv_dbg_uart_avalon_rs232_slave_agent:m0_debugaccess -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_debugaccess
	wire   [31:0] niosv_dbg_uart_avalon_rs232_slave_agent_m0_address;                          // niosv_dbg_uart_avalon_rs232_slave_agent:m0_address -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_address
	wire    [3:0] niosv_dbg_uart_avalon_rs232_slave_agent_m0_byteenable;                       // niosv_dbg_uart_avalon_rs232_slave_agent:m0_byteenable -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_byteenable
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_read;                             // niosv_dbg_uart_avalon_rs232_slave_agent:m0_read -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_read
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdatavalid;                    // niosv_dbg_uart_avalon_rs232_slave_translator:uav_readdatavalid -> niosv_dbg_uart_avalon_rs232_slave_agent:m0_readdatavalid
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_lock;                             // niosv_dbg_uart_avalon_rs232_slave_agent:m0_lock -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_lock
	wire   [31:0] niosv_dbg_uart_avalon_rs232_slave_agent_m0_writedata;                        // niosv_dbg_uart_avalon_rs232_slave_agent:m0_writedata -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_writedata
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_m0_write;                            // niosv_dbg_uart_avalon_rs232_slave_agent:m0_write -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_write
	wire    [2:0] niosv_dbg_uart_avalon_rs232_slave_agent_m0_burstcount;                       // niosv_dbg_uart_avalon_rs232_slave_agent:m0_burstcount -> niosv_dbg_uart_avalon_rs232_slave_translator:uav_burstcount
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_valid;                     // niosv_dbg_uart_avalon_rs232_slave_agent:rf_source_valid -> niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:in_valid
	wire  [134:0] niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_data;                      // niosv_dbg_uart_avalon_rs232_slave_agent:rf_source_data -> niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:in_data
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_ready;                     // niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:in_ready -> niosv_dbg_uart_avalon_rs232_slave_agent:rf_source_ready
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_startofpacket;             // niosv_dbg_uart_avalon_rs232_slave_agent:rf_source_startofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:in_startofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_endofpacket;               // niosv_dbg_uart_avalon_rs232_slave_agent:rf_source_endofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:in_endofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_valid;                  // niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:out_valid -> niosv_dbg_uart_avalon_rs232_slave_agent:rf_sink_valid
	wire  [134:0] niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                   // niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:out_data -> niosv_dbg_uart_avalon_rs232_slave_agent:rf_sink_data
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_ready;                  // niosv_dbg_uart_avalon_rs232_slave_agent:rf_sink_ready -> niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:out_ready
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_startofpacket;          // niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:out_startofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent:rf_sink_startofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_endofpacket;            // niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo:out_endofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent:rf_sink_endofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_valid;                // niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_src_valid -> niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:in_valid
	wire   [33:0] niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_data;                 // niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_src_data -> niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:in_data
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_ready;                // niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:in_ready -> niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_src_ready
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_valid;                // niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:out_valid -> niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_data;                 // niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:out_data -> niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_sink_data
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_ready;                // niosv_dbg_uart_avalon_rs232_slave_agent:rdata_fifo_sink_ready -> niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo:out_ready
	...
	wire          niosv_jtag_master_master_agent_cp_valid;                                     // niosv_jtag_master_master_agent:cp_valid -> router_002:sink_valid
	wire  [133:0] niosv_jtag_master_master_agent_cp_data;                                      // niosv_jtag_master_master_agent:cp_data -> router_002:sink_data
	wire          niosv_jtag_master_master_agent_cp_ready;                                     // router_002:sink_ready -> niosv_jtag_master_master_agent:cp_ready
	wire          niosv_jtag_master_master_agent_cp_startofpacket;                             // niosv_jtag_master_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          niosv_jtag_master_master_agent_cp_endofpacket;                               // niosv_jtag_master_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rp_valid;                            // niosv_dbg_uart_avalon_rs232_slave_agent:rp_valid -> router_005:sink_valid
	wire  [133:0] niosv_dbg_uart_avalon_rs232_slave_agent_rp_data;                             // niosv_dbg_uart_avalon_rs232_slave_agent:rp_data -> router_005:sink_data
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rp_ready;                            // router_005:sink_ready -> niosv_dbg_uart_avalon_rs232_slave_agent:rp_ready
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rp_startofpacket;                    // niosv_dbg_uart_avalon_rs232_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_agent_rp_endofpacket;                      // niosv_dbg_uart_avalon_rs232_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          router_002_src_valid;                                                        // router_002:src_valid -> niosv_jtag_master_master_limiter:cmd_sink_valid
	wire  [133:0] router_002_src_data;                                                         // router_002:src_data -> niosv_jtag_master_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                        // niosv_jtag_master_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire   [13:0] router_002_src_channel;                                                      // router_002:src_channel -> niosv_jtag_master_master_limiter:cmd_sink_channel
	wire          router_002_src_startofpacket;                                                // router_002:src_startofpacket -> niosv_jtag_master_master_limiter:cmd_sink_startofpacket
	wire          router_002_src_endofpacket;                                                  // router_002:src_endofpacket -> niosv_jtag_master_master_limiter:cmd_sink_endofpacket
	wire  [133:0] niosv_jtag_master_master_limiter_cmd_src_data;                               // niosv_jtag_master_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          niosv_jtag_master_master_limiter_cmd_src_ready;                              // cmd_demux_002:sink_ready -> niosv_jtag_master_master_limiter:cmd_src_ready
	wire   [13:0] niosv_jtag_master_master_limiter_cmd_src_channel;                            // niosv_jtag_master_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	wire          niosv_jtag_master_master_limiter_cmd_src_startofpacket;                      // niosv_jtag_master_master_limiter:cmd_src_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          niosv_jtag_master_master_limiter_cmd_src_endofpacket;                        // niosv_jtag_master_master_limiter:cmd_src_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          rsp_mux_002_src_valid;                                                       // rsp_mux_002:src_valid -> niosv_jtag_master_master_limiter:rsp_sink_valid
	wire  [133:0] rsp_mux_002_src_data;                                                        // rsp_mux_002:src_data -> niosv_jtag_master_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                       // niosv_jtag_master_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire   [13:0] rsp_mux_002_src_channel;                                                     // rsp_mux_002:src_channel -> niosv_jtag_master_master_limiter:rsp_sink_channel
	wire          rsp_mux_002_src_startofpacket;                                               // rsp_mux_002:src_startofpacket -> niosv_jtag_master_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                 // rsp_mux_002:src_endofpacket -> niosv_jtag_master_master_limiter:rsp_sink_endofpacket
	wire          niosv_jtag_master_master_limiter_rsp_src_valid;                              // niosv_jtag_master_master_limiter:rsp_src_valid -> niosv_jtag_master_master_agent:rp_valid
	wire  [133:0] niosv_jtag_master_master_limiter_rsp_src_data;                               // niosv_jtag_master_master_limiter:rsp_src_data -> niosv_jtag_master_master_agent:rp_data
	wire          niosv_jtag_master_master_limiter_rsp_src_ready;                              // niosv_jtag_master_master_agent:rp_ready -> niosv_jtag_master_master_limiter:rsp_src_ready
	wire   [13:0] niosv_jtag_master_master_limiter_rsp_src_channel;                            // niosv_jtag_master_master_limiter:rsp_src_channel -> niosv_jtag_master_master_agent:rp_channel
	wire          niosv_jtag_master_master_limiter_rsp_src_startofpacket;                      // niosv_jtag_master_master_limiter:rsp_src_startofpacket -> niosv_jtag_master_master_agent:rp_startofpacket
	wire          niosv_jtag_master_master_limiter_rsp_src_endofpacket;                        // niosv_jtag_master_master_limiter:rsp_src_endofpacket -> niosv_jtag_master_master_agent:rp_endofpacket
	...
	wire          cmd_mux_src_valid;                                                           // cmd_mux:src_valid -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_valid
	wire  [133:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                           // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                                   // cmd_mux:src_startofpacket -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                                     // cmd_mux:src_endofpacket -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:sink0_endofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_valid;               // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_valid -> niosv_dbg_uart_avalon_rs232_slave_agent:cp_valid
	wire  [133:0] niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_data;                // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_data -> niosv_dbg_uart_avalon_rs232_slave_agent:cp_data
	wire          niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_ready;               // niosv_dbg_uart_avalon_rs232_slave_agent:cp_ready -> niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_ready
	wire   [13:0] niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_channel;             // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_channel -> niosv_dbg_uart_avalon_rs232_slave_agent:cp_channel
	wire          niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_startofpacket;       // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_startofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent:cp_startofpacket
	wire          niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_endofpacket;         // niosv_dbg_uart_avalon_rs232_slave_burst_adapter:source0_endofpacket -> niosv_dbg_uart_avalon_rs232_slave_agent:cp_endofpacket
	...
	wire   [13:0] niosv_jtag_master_master_limiter_cmd_valid_data;                             // niosv_jtag_master_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	niosv_sys_altera_merlin_master_translator_192_lykd4la #(
		...
		.USE_OUTPUTENABLE            (0)
	) niosv_jtag_master_master_translator (
		...
		.uav_address            (niosv_jtag_master_master_translator_avalon_universal_master_0_address),         //  output,  width = 32, avalon_universal_master_0.address
		.uav_burstcount         (niosv_jtag_master_master_translator_avalon_universal_master_0_burstcount),      //  output,   width = 3,                          .burstcount
		.uav_read               (niosv_jtag_master_master_translator_avalon_universal_master_0_read),            //  output,   width = 1,                          .read
		.uav_write              (niosv_jtag_master_master_translator_avalon_universal_master_0_write),           //  output,   width = 1,                          .write
		.uav_waitrequest        (niosv_jtag_master_master_translator_avalon_universal_master_0_waitrequest),     //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (niosv_jtag_master_master_translator_avalon_universal_master_0_readdatavalid),   //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (niosv_jtag_master_master_translator_avalon_universal_master_0_byteenable),      //  output,   width = 4,                          .byteenable
		.uav_readdata           (niosv_jtag_master_master_translator_avalon_universal_master_0_readdata),        //   input,  width = 32,                          .readdata
		.uav_writedata          (niosv_jtag_master_master_translator_avalon_universal_master_0_writedata),       //  output,  width = 32,                          .writedata
		.uav_lock               (niosv_jtag_master_master_translator_avalon_universal_master_0_lock),            //  output,   width = 1,                          .lock
		.uav_debugaccess        (niosv_jtag_master_master_translator_avalon_universal_master_0_debugaccess),     //  output,   width = 1,                          .debugaccess
		.av_address             (niosv_jtag_master_master_address),                                              //   input,  width = 32,      avalon_anti_master_0.address
		.av_waitrequest         (niosv_jtag_master_master_waitrequest),                                          //  output,   width = 1,                          .waitrequest
		.av_byteenable          (niosv_jtag_master_master_byteenable),                                           //   input,   width = 4,                          .byteenable
		.av_read                (niosv_jtag_master_master_read),                                                 //   input,   width = 1,                          .read
		.av_readdata            (niosv_jtag_master_master_readdata),                                             //  output,  width = 32,                          .readdata
		.av_readdatavalid       (niosv_jtag_master_master_readdatavalid),                                        //  output,   width = 1,                          .readdatavalid
		.av_write               (niosv_jtag_master_master_write),                                                //   input,   width = 1,                          .write
		.av_writedata           (niosv_jtag_master_master_writedata),                                            //   input,  width = 32,                          .writedata
	...
	niosv_sys_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (1)
	) niosv_dbg_uart_avalon_rs232_slave_translator (
		.clk                    (clock_in_out_clk_clk),                                                           //   input,   width = 1,                      clk.clk
		.reset                  (niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (niosv_dbg_uart_avalon_rs232_slave_agent_m0_address),                             //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (niosv_dbg_uart_avalon_rs232_slave_agent_m0_burstcount),                          //   input,   width = 3,                         .burstcount
		.uav_read               (niosv_dbg_uart_avalon_rs232_slave_agent_m0_read),                                //   input,   width = 1,                         .read
		.uav_write              (niosv_dbg_uart_avalon_rs232_slave_agent_m0_write),                               //   input,   width = 1,                         .write
		.uav_waitrequest        (niosv_dbg_uart_avalon_rs232_slave_agent_m0_waitrequest),                         //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdatavalid),                       //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (niosv_dbg_uart_avalon_rs232_slave_agent_m0_byteenable),                          //   input,   width = 4,                         .byteenable
		.uav_readdata           (niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdata),                            //  output,  width = 32,                         .readdata
		.uav_writedata          (niosv_dbg_uart_avalon_rs232_slave_agent_m0_writedata),                           //   input,  width = 32,                         .writedata
		.uav_lock               (niosv_dbg_uart_avalon_rs232_slave_agent_m0_lock),                                //   input,   width = 1,                         .lock
		.uav_debugaccess        (niosv_dbg_uart_avalon_rs232_slave_agent_m0_debugaccess),                         //   input,   width = 1,                         .debugaccess
		.av_address             (niosv_dbg_uart_avalon_rs232_slave_address),                                      //  output,   width = 1,      avalon_anti_slave_0.address
		.av_write               (niosv_dbg_uart_avalon_rs232_slave_write),                                        //  output,   width = 1,                         .write
		.av_read                (niosv_dbg_uart_avalon_rs232_slave_read),                                         //  output,   width = 1,                         .read
		.av_readdata            (niosv_dbg_uart_avalon_rs232_slave_readdata),                                     //   input,  width = 32,                         .readdata
		.av_writedata           (niosv_dbg_uart_avalon_rs232_slave_writedata),                                    //  output,  width = 32,                         .writedata
		.av_byteenable          (niosv_dbg_uart_avalon_rs232_slave_byteenable),                                   //  output,   width = 4,                         .byteenable
		.av_chipselect          (niosv_dbg_uart_avalon_rs232_slave_chipselect),                                   //  output,   width = 1,                         .chipselect
	...
	niosv_sys_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (1)
	) niosv_jtag_master_master_agent (
		.clk                   (clock_in_out_clk_clk),                                                          //   input,    width = 1,       clk.clk
		.reset                 (intel_niosv_g_0_data_manager_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.av_address            (niosv_jtag_master_master_translator_avalon_universal_master_0_address),         //   input,   width = 32,        av.address
		.av_write              (niosv_jtag_master_master_translator_avalon_universal_master_0_write),           //   input,    width = 1,          .write
		.av_read               (niosv_jtag_master_master_translator_avalon_universal_master_0_read),            //   input,    width = 1,          .read
		.av_writedata          (niosv_jtag_master_master_translator_avalon_universal_master_0_writedata),       //   input,   width = 32,          .writedata
		.av_readdata           (niosv_jtag_master_master_translator_avalon_universal_master_0_readdata),        //  output,   width = 32,          .readdata
		.av_waitrequest        (niosv_jtag_master_master_translator_avalon_universal_master_0_waitrequest),     //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (niosv_jtag_master_master_translator_avalon_universal_master_0_readdatavalid),   //  output,    width = 1,          .readdatavalid
		.av_byteenable         (niosv_jtag_master_master_translator_avalon_universal_master_0_byteenable),      //   input,    width = 4,          .byteenable
		.av_burstcount         (niosv_jtag_master_master_translator_avalon_universal_master_0_burstcount),      //   input,    width = 3,          .burstcount
		.av_debugaccess        (niosv_jtag_master_master_translator_avalon_universal_master_0_debugaccess),     //   input,    width = 1,          .debugaccess
		.av_lock               (niosv_jtag_master_master_translator_avalon_universal_master_0_lock),            //   input,    width = 1,          .lock
		.cp_valid              (niosv_jtag_master_master_agent_cp_valid),                                       //  output,    width = 1,        cp.valid
		.cp_data               (niosv_jtag_master_master_agent_cp_data),                                        //  output,  width = 134,          .data
		.cp_startofpacket      (niosv_jtag_master_master_agent_cp_startofpacket),                               //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (niosv_jtag_master_master_agent_cp_endofpacket),                                 //  output,    width = 1,          .endofpacket
		.cp_ready              (niosv_jtag_master_master_agent_cp_ready),                                       //   input,    width = 1,          .ready
		.rp_valid              (niosv_jtag_master_master_limiter_rsp_src_valid),                                //   input,    width = 1,        rp.valid
		.rp_data               (niosv_jtag_master_master_limiter_rsp_src_data),                                 //   input,  width = 134,          .data
		.rp_channel            (niosv_jtag_master_master_limiter_rsp_src_channel),                              //   input,   width = 14,          .channel
		.rp_startofpacket      (niosv_jtag_master_master_limiter_rsp_src_startofpacket),                        //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (niosv_jtag_master_master_limiter_rsp_src_endofpacket),                          //   input,    width = 1,          .endofpacket
		.rp_ready              (niosv_jtag_master_master_limiter_rsp_src_ready),                                //  output,    width = 1,          .ready
		.av_response           (),                                                                              // (terminated),                         
		.av_writeresponsevalid ()                                                                               // (terminated),                         
	);
	...
	niosv_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (1)
	) niosv_dbg_uart_avalon_rs232_slave_agent (
		.clk                     (clock_in_out_clk_clk),                                                           //   input,    width = 1,             clk.clk
		.reset                   (niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,       clk_reset.reset
		.m0_address              (niosv_dbg_uart_avalon_rs232_slave_agent_m0_address),                             //  output,   width = 32,              m0.address
		.m0_burstcount           (niosv_dbg_uart_avalon_rs232_slave_agent_m0_burstcount),                          //  output,    width = 3,                .burstcount
		.m0_byteenable           (niosv_dbg_uart_avalon_rs232_slave_agent_m0_byteenable),                          //  output,    width = 4,                .byteenable
		.m0_debugaccess          (niosv_dbg_uart_avalon_rs232_slave_agent_m0_debugaccess),                         //  output,    width = 1,                .debugaccess
		.m0_lock                 (niosv_dbg_uart_avalon_rs232_slave_agent_m0_lock),                                //  output,    width = 1,                .lock
		.m0_readdata             (niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdata),                            //   input,   width = 32,                .readdata
		.m0_readdatavalid        (niosv_dbg_uart_avalon_rs232_slave_agent_m0_readdatavalid),                       //   input,    width = 1,                .readdatavalid
		.m0_read                 (niosv_dbg_uart_avalon_rs232_slave_agent_m0_read),                                //  output,    width = 1,                .read
		.m0_waitrequest          (niosv_dbg_uart_avalon_rs232_slave_agent_m0_waitrequest),                         //   input,    width = 1,                .waitrequest
		.m0_writedata            (niosv_dbg_uart_avalon_rs232_slave_agent_m0_writedata),                           //  output,   width = 32,                .writedata
		.m0_write                (niosv_dbg_uart_avalon_rs232_slave_agent_m0_write),                               //  output,    width = 1,                .write
		.rp_endofpacket          (niosv_dbg_uart_avalon_rs232_slave_agent_rp_endofpacket),                         //  output,    width = 1,              rp.endofpacket
		.rp_ready                (niosv_dbg_uart_avalon_rs232_slave_agent_rp_ready),                               //   input,    width = 1,                .ready
		.rp_valid                (niosv_dbg_uart_avalon_rs232_slave_agent_rp_valid),                               //  output,    width = 1,                .valid
		.rp_data                 (niosv_dbg_uart_avalon_rs232_slave_agent_rp_data),                                //  output,  width = 134,                .data
		.rp_startofpacket        (niosv_dbg_uart_avalon_rs232_slave_agent_rp_startofpacket),                       //  output,    width = 1,                .startofpacket
		.cp_ready                (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_ready),                  //  output,    width = 1,              cp.ready
		.cp_valid                (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_valid),                  //   input,    width = 1,                .valid
		.cp_data                 (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_data),                   //   input,  width = 134,                .data
		.cp_startofpacket        (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_startofpacket),          //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_endofpacket),            //   input,    width = 1,                .endofpacket
		.cp_channel              (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_channel),                //   input,   width = 14,                .channel
		.rf_sink_ready           (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_ready),                     //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_valid),                     //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_startofpacket),             //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_endofpacket),               //   input,    width = 1,                .endofpacket
		.rf_sink_data            (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_data),                      //   input,  width = 135,                .data
		.rf_source_ready         (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_ready),                        //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_valid),                        //  output,    width = 1,                .valid
		.rf_source_startofpacket (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_startofpacket),                //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_endofpacket),                  //  output,    width = 1,                .endofpacket
		.rf_source_data          (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_data),                         //  output,  width = 135,                .data
		.rdata_fifo_sink_ready   (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_ready),                   //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_valid),                   //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_data),                    //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_ready),                   //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_valid),                   //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_data),                    //  output,   width = 34,                .data
	...
	niosv_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                                               //   input,    width = 1,       clk.clk
		.reset             (niosv_dbg_uart_reset_reset_bridge_in_reset_reset),                   //   input,    width = 1, clk_reset.reset
		.in_data           (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_data),             //   input,  width = 135,        in.data
		.in_valid          (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (niosv_dbg_uart_avalon_rs232_slave_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_data),          //  output,  width = 135,       out.data
		.out_valid         (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (niosv_dbg_uart_avalon_rs232_slave_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
	...
	niosv_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo (
		.clk               (clock_in_out_clk_clk),                                         //   input,   width = 1,       clk.clk
		.reset             (niosv_dbg_uart_reset_reset_bridge_in_reset_reset),             //   input,   width = 1, clk_reset.reset
		.in_data           (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_data),  //   input,  width = 34,        in.data
		.in_valid          (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_valid), //   input,   width = 1,          .valid
		.in_ready          (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_src_ready), //  output,   width = 1,          .ready
		.out_data          (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_data),  //  output,  width = 34,       out.data
		.out_valid         (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_valid), //  output,   width = 1,          .valid
		.out_ready         (niosv_dbg_uart_avalon_rs232_slave_agent_rdata_fifo_out_ready), //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                                        // (terminated),                        
		.csr_read          (1'b0),                                                         // (terminated),                        
		.csr_write         (1'b0),                                                         // (terminated),                        
		.csr_readdata      (),                                                             // (terminated),                        
	...
	niosv_sys_altera_merlin_router_1921_yctpamy router (
	...
	niosv_sys_altera_merlin_router_1921_kwthbsy router_001 (
	...
	niosv_sys_altera_merlin_router_1921_utmx2ja router_002 (
		.sink_ready         (niosv_jtag_master_master_agent_cp_ready),                                       //  output,    width = 1,      sink.ready
		.sink_valid         (niosv_jtag_master_master_agent_cp_valid),                                       //   input,    width = 1,          .valid
		.sink_data          (niosv_jtag_master_master_agent_cp_data),                                        //   input,  width = 134,          .data
		.sink_startofpacket (niosv_jtag_master_master_agent_cp_startofpacket),                               //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (niosv_jtag_master_master_agent_cp_endofpacket),                                 //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                                                          //   input,    width = 1,       clk.clk
		.reset              (intel_niosv_g_0_data_manager_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	niosv_sys_altera_merlin_router_1921_piyergq router_005 (
		.sink_ready         (niosv_dbg_uart_avalon_rs232_slave_agent_rp_ready),                               //  output,    width = 1,      sink.ready
		.sink_valid         (niosv_dbg_uart_avalon_rs232_slave_agent_rp_valid),                               //   input,    width = 1,          .valid
		.sink_data          (niosv_dbg_uart_avalon_rs232_slave_agent_rp_data),                                //   input,  width = 134,          .data
		.sink_startofpacket (niosv_dbg_uart_avalon_rs232_slave_agent_rp_startofpacket),                       //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (niosv_dbg_uart_avalon_rs232_slave_agent_rp_endofpacket),                         //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                                                           //   input,    width = 1,       clk.clk
		.reset              (niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	niosv_sys_altera_merlin_traffic_limiter_191_6blplji #(
	...
	) niosv_jtag_master_master_limiter (
		.clk                    (clock_in_out_clk_clk),                                                          //   input,    width = 1,       clk.clk
		.reset                  (intel_niosv_g_0_data_manager_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.cmd_src_ready          (niosv_jtag_master_master_limiter_cmd_src_ready),                                //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (niosv_jtag_master_master_limiter_cmd_src_data),                                 //  output,  width = 134,          .data
		.cmd_src_channel        (niosv_jtag_master_master_limiter_cmd_src_channel),                              //  output,   width = 14,          .channel
		.cmd_src_startofpacket  (niosv_jtag_master_master_limiter_cmd_src_startofpacket),                        //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (niosv_jtag_master_master_limiter_cmd_src_endofpacket),                          //  output,    width = 1,          .endofpacket
		...
		.rsp_src_ready          (niosv_jtag_master_master_limiter_rsp_src_ready),                                //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (niosv_jtag_master_master_limiter_rsp_src_valid),                                //  output,    width = 1,          .valid
		.rsp_src_data           (niosv_jtag_master_master_limiter_rsp_src_data),                                 //  output,  width = 134,          .data
		.rsp_src_channel        (niosv_jtag_master_master_limiter_rsp_src_channel),                              //  output,   width = 14,          .channel
		.rsp_src_startofpacket  (niosv_jtag_master_master_limiter_rsp_src_startofpacket),                        //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (niosv_jtag_master_master_limiter_rsp_src_endofpacket),                          //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (niosv_jtag_master_master_limiter_cmd_valid_data)                                //  output,   width = 14, cmd_valid.data
	);
	...
	niosv_sys_altera_merlin_burst_adapter_1923_ajumn7i #(
		...
		.SYNC_RESET                (1)
	) niosv_dbg_uart_avalon_rs232_slave_burst_adapter (
		.clk                   (clock_in_out_clk_clk),                                                           //   input,    width = 1,       cr0.clk
		.reset                 (niosv_dbg_uart_avalon_rs232_slave_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		...
		.source0_valid         (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_valid),                  //  output,    width = 1,   source0.valid
		.source0_data          (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_data),                   //  output,  width = 134,          .data
		.source0_channel       (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_channel),                //  output,   width = 14,          .channel
		.source0_startofpacket (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_startofpacket),          //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_endofpacket),            //  output,    width = 1,          .endofpacket
		.source0_ready         (niosv_dbg_uart_avalon_rs232_slave_burst_adapter_source0_ready)                   //   input,    width = 1,          .ready
	);
	...
	niosv_sys_altera_merlin_demultiplexer_1921_yjcstuy cmd_demux_002 (
		.clk                 (clock_in_out_clk_clk),                                                          //   input,    width = 1,        clk.clk
		.reset               (intel_niosv_g_0_data_manager_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready          (niosv_jtag_master_master_limiter_cmd_src_ready),                                //  output,    width = 1,       sink.ready
		.sink_channel        (niosv_jtag_master_master_limiter_cmd_src_channel),                              //   input,   width = 14,           .channel
		.sink_data           (niosv_jtag_master_master_limiter_cmd_src_data),                                 //   input,  width = 134,           .data
		.sink_startofpacket  (niosv_jtag_master_master_limiter_cmd_src_startofpacket),                        //   input,    width = 1,           .startofpacket
		.sink_endofpacket    (niosv_jtag_master_master_limiter_cmd_src_endofpacket),                          //   input,    width = 1,           .endofpacket
		.sink_valid          (niosv_jtag_master_master_limiter_cmd_valid_data),                               //   input,   width = 14, sink_valid.data
