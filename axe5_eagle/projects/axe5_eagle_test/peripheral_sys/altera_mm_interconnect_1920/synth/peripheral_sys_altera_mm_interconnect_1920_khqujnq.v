// peripheral_sys_altera_mm_interconnect_1920_khqujnq.v
...
`timescale 1 ps / 1 ps
module peripheral_sys_altera_mm_interconnect_1920_khqujnq (
	...
	wire  [107:0] pb_s1_agent_rf_source_data;                                        // pb_s1_agent:rf_source_data -> pb_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] pb_s1_agent_rsp_fifo_out_data;                                     // pb_s1_agent_rsp_fifo:out_data -> pb_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> pb_s1_agent:cp_data
	...
	wire  [107:0] dipsw_s1_agent_rf_source_data;                                     // dipsw_s1_agent:rf_source_data -> dipsw_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] dipsw_s1_agent_rsp_fifo_out_data;                                  // dipsw_s1_agent_rsp_fifo:out_data -> dipsw_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> dipsw_s1_agent:cp_data
	...
	wire  [107:0] rgb_led0_s1_agent_rf_source_data;                                  // rgb_led0_s1_agent:rf_source_data -> rgb_led0_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] rgb_led0_s1_agent_rsp_fifo_out_data;                               // rgb_led0_s1_agent_rsp_fifo:out_data -> rgb_led0_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_004_src_data;                                              // cmd_mux_004:src_data -> rgb_led0_s1_agent:cp_data
	...
	wire  [107:0] rgb_led1_s1_agent_rf_source_data;                                  // rgb_led1_s1_agent:rf_source_data -> rgb_led1_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] rgb_led1_s1_agent_rsp_fifo_out_data;                               // rgb_led1_s1_agent_rsp_fifo:out_data -> rgb_led1_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> rgb_led1_s1_agent:cp_data
	...
	wire  [107:0] rgb_led2_s1_agent_rf_source_data;                                  // rgb_led2_s1_agent:rf_source_data -> rgb_led2_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] rgb_led2_s1_agent_rsp_fifo_out_data;                               // rgb_led2_s1_agent_rsp_fifo:out_data -> rgb_led2_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> rgb_led2_s1_agent:cp_data
	...
	wire  [107:0] rgb_led3_s1_agent_rf_source_data;                                  // rgb_led3_s1_agent:rf_source_data -> rgb_led3_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] rgb_led3_s1_agent_rsp_fifo_out_data;                               // rgb_led3_s1_agent_rsp_fifo:out_data -> rgb_led3_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_007_src_data;                                              // cmd_mux_007:src_data -> rgb_led3_s1_agent:cp_data
	...
	wire  [106:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                         // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [106:0] sys_id_control_slave_agent_rp_data;                                // sys_id_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [106:0] pb_s1_agent_rp_data;                                               // pb_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [106:0] dipsw_s1_agent_rp_data;                                            // dipsw_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [106:0] router_004_src_data;                                               // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [106:0] rgb_led0_s1_agent_rp_data;                                         // rgb_led0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [106:0] router_005_src_data;                                               // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire  [106:0] rgb_led1_s1_agent_rp_data;                                         // rgb_led1_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [106:0] router_006_src_data;                                               // router_006:src_data -> rsp_demux_005:sink_data
	...
	wire  [106:0] rgb_led2_s1_agent_rp_data;                                         // rgb_led2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [106:0] router_007_src_data;                                               // router_007:src_data -> rsp_demux_006:sink_data
	...
	wire  [106:0] rgb_led3_s1_agent_rp_data;                                         // rgb_led3_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [106:0] router_008_src_data;                                               // router_008:src_data -> rsp_demux_007:sink_data
	...
	peripheral_sys_altera_merlin_master_agent_191_mpbm6tq #(
		.PKT_WUNIQUE               (106),
		.PKT_DOMAIN_H              (105),
		.PKT_DOMAIN_L              (104),
		.PKT_SNOOP_H               (103),
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		.PKT_ORI_BURST_SIZE_H      (97),
		.PKT_ORI_BURST_SIZE_L      (95),
		.PKT_RESPONSE_STATUS_H     (94),
		.PKT_RESPONSE_STATUS_L     (93),
		...
		.rp_data                 (jtag_uart_avalon_jtag_slave_agent_rp_data),                    //  output,  width = 107,                .data
		...
		.rf_sink_data            (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //   input,  width = 108,                .data
		...
		.rf_source_data          (jtag_uart_avalon_jtag_slave_agent_rf_source_data),             //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (jtag_uart_avalon_jtag_slave_agent_rf_source_data),             //   input,  width = 108,        in.data
		...
		.out_data          (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (sys_id_control_slave_agent_rp_data),                          //  output,  width = 107,                .data
		...
		.rf_sink_data            (sys_id_control_slave_agent_rsp_fifo_out_data),                //   input,  width = 108,                .data
		...
		.rf_source_data          (sys_id_control_slave_agent_rf_source_data),                   //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.in_data           (sys_id_control_slave_agent_rf_source_data),             //   input,  width = 108,        in.data
		...
		.out_data          (sys_id_control_slave_agent_rsp_fifo_out_data),          //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (pb_s1_agent_rp_data),                                         //  output,  width = 107,                .data
		...
		.rf_sink_data            (pb_s1_agent_rsp_fifo_out_data),                               //   input,  width = 108,                .data
		...
		.rf_source_data          (pb_s1_agent_rf_source_data),                                  //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (pb_s1_agent_rf_source_data),                    //   input,  width = 108,        in.data
		...
		.out_data          (pb_s1_agent_rsp_fifo_out_data),                 //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (dipsw_s1_agent_rp_data),                                      //  output,  width = 107,                .data
		...
		.rf_sink_data            (dipsw_s1_agent_rsp_fifo_out_data),                            //   input,  width = 108,                .data
		...
		.rf_source_data          (dipsw_s1_agent_rf_source_data),                               //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (dipsw_s1_agent_rf_source_data),                 //   input,  width = 108,        in.data
		...
		.out_data          (dipsw_s1_agent_rsp_fifo_out_data),              //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (rgb_led0_s1_agent_rp_data),                                   //  output,  width = 107,                .data
		...
		.rf_sink_data            (rgb_led0_s1_agent_rsp_fifo_out_data),                         //   input,  width = 108,                .data
		...
		.rf_source_data          (rgb_led0_s1_agent_rf_source_data),                            //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led0_s1_agent_rf_source_data),              //   input,  width = 108,        in.data
		...
		.out_data          (rgb_led0_s1_agent_rsp_fifo_out_data),           //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (rgb_led1_s1_agent_rp_data),                                   //  output,  width = 107,                .data
		...
		.rf_sink_data            (rgb_led1_s1_agent_rsp_fifo_out_data),                         //   input,  width = 108,                .data
		...
		.rf_source_data          (rgb_led1_s1_agent_rf_source_data),                            //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led1_s1_agent_rf_source_data),              //   input,  width = 108,        in.data
		...
		.out_data          (rgb_led1_s1_agent_rsp_fifo_out_data),           //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (rgb_led2_s1_agent_rp_data),                                   //  output,  width = 107,                .data
		...
		.rf_sink_data            (rgb_led2_s1_agent_rsp_fifo_out_data),                         //   input,  width = 108,                .data
		...
		.rf_source_data          (rgb_led2_s1_agent_rf_source_data),                            //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led2_s1_agent_rf_source_data),              //   input,  width = 108,        in.data
		...
		.out_data          (rgb_led2_s1_agent_rsp_fifo_out_data),           //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (rgb_led3_s1_agent_rp_data),                                   //  output,  width = 107,                .data
		...
		.rf_sink_data            (rgb_led3_s1_agent_rsp_fifo_out_data),                         //   input,  width = 108,                .data
		...
		.rf_source_data          (rgb_led3_s1_agent_rf_source_data),                            //  output,  width = 108,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led3_s1_agent_rf_source_data),              //   input,  width = 108,        in.data
		...
		.out_data          (rgb_led3_s1_agent_rsp_fifo_out_data),           //  output,  width = 108,       out.data
	...
	peripheral_sys_altera_merlin_router_1921_povfadi router (
	...
	peripheral_sys_altera_merlin_router_1921_h227eni router_001 (
		...
		.sink_data          (jtag_uart_avalon_jtag_slave_agent_rp_data),                   //   input,  width = 107,          .data
	...
	peripheral_sys_altera_merlin_router_1921_h227eni router_002 (
		...
		.sink_data          (sys_id_control_slave_agent_rp_data),                          //   input,  width = 107,          .data
	...
	peripheral_sys_altera_merlin_router_1921_h227eni router_003 (
		.sink_ready         (pb_s1_agent_rp_ready),                                        //  output,    width = 1,      sink.ready
		.sink_valid         (pb_s1_agent_rp_valid),                                        //   input,    width = 1,          .valid
		.sink_data          (pb_s1_agent_rp_data),                                         //   input,  width = 107,          .data
	...
	peripheral_sys_altera_merlin_traffic_limiter_191_6blplji #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (84),
		.PKT_DEST_ID_L                        (82),
		.PKT_SRC_ID_H                         (81),
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_mpmdfea cmd_demux (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (mm_bridge_0_m0_limiter_cmd_src_data),                         //   input,  width = 107,           .data
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_3prt3ry cmd_mux_007 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_006 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_yy6nxwy rsp_demux_007 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1921_bepdvoa rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
