// peripheral_sys_altera_mm_interconnect_1920_ei7tz2q.v
...
`timescale 1 ps / 1 ps
module peripheral_sys_altera_mm_interconnect_1920_ei7tz2q (
		...
		output wire [1:0]  usb_hub_rst_s1_address,                                      //                                        usb_hub_rst_s1.address
		output wire        usb_hub_rst_s1_write,                                        //                                                      .write
		input  wire [31:0] usb_hub_rst_s1_readdata,                                     //                                                      .readdata
		output wire [31:0] usb_hub_rst_s1_writedata,                                    //                                                      .writedata
		output wire        usb_hub_rst_s1_chipselect,                                   //                                                      .chipselect
	...
	wire  [121:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [122:0] sys_id_control_slave_agent_rf_source_data;                         // sys_id_control_slave_agent:rf_source_data -> sys_id_control_slave_agent_rsp_fifo:in_data
	...
	wire  [122:0] sys_id_control_slave_agent_rsp_fifo_out_data;                      // sys_id_control_slave_agent_rsp_fifo:out_data -> sys_id_control_slave_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> sys_id_control_slave_agent:cp_data
	...
	wire  [122:0] pb_s1_agent_rf_source_data;                                        // pb_s1_agent:rf_source_data -> pb_s1_agent_rsp_fifo:in_data
	...
	wire  [122:0] pb_s1_agent_rsp_fifo_out_data;                                     // pb_s1_agent_rsp_fifo:out_data -> pb_s1_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> pb_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                             // pb_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> pb_s1_agent:cp_channel
	...
	wire  [121:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> dipsw_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                             // dipsw_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                           // cmd_mux_003:src_channel -> dipsw_s1_agent:cp_channel
	...
	wire  [122:0] rgb_led0_s1_agent_rf_source_data;                                  // rgb_led0_s1_agent:rf_source_data -> rgb_led0_s1_agent_rsp_fifo:in_data
	...
	wire  [122:0] rgb_led0_s1_agent_rsp_fifo_out_data;                               // rgb_led0_s1_agent_rsp_fifo:out_data -> rgb_led0_s1_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_004_src_data;                                              // cmd_mux_004:src_data -> rgb_led0_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                             // rgb_led0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                           // cmd_mux_004:src_channel -> rgb_led0_s1_agent:cp_channel
	...
	wire  [122:0] rgb_led1_s1_agent_rf_source_data;                                  // rgb_led1_s1_agent:rf_source_data -> rgb_led1_s1_agent_rsp_fifo:in_data
	...
	wire  [122:0] rgb_led1_s1_agent_rsp_fifo_out_data;                               // rgb_led1_s1_agent_rsp_fifo:out_data -> rgb_led1_s1_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> rgb_led1_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                             // rgb_led1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                           // cmd_mux_005:src_channel -> rgb_led1_s1_agent:cp_channel
	...
	wire  [122:0] rgb_led2_s1_agent_rf_source_data;                                  // rgb_led2_s1_agent:rf_source_data -> rgb_led2_s1_agent_rsp_fifo:in_data
	...
	wire  [122:0] rgb_led2_s1_agent_rsp_fifo_out_data;                               // rgb_led2_s1_agent_rsp_fifo:out_data -> rgb_led2_s1_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> rgb_led2_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                             // rgb_led2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                           // cmd_mux_006:src_channel -> rgb_led2_s1_agent:cp_channel
	...
	wire  [122:0] rgb_led3_s1_agent_rf_source_data;                                  // rgb_led3_s1_agent:rf_source_data -> rgb_led3_s1_agent_rsp_fifo:in_data
	...
	wire  [122:0] rgb_led3_s1_agent_rsp_fifo_out_data;                               // rgb_led3_s1_agent_rsp_fifo:out_data -> rgb_led3_s1_agent:rf_sink_data
	...
	wire  [121:0] cmd_mux_007_src_data;                                              // cmd_mux_007:src_data -> rgb_led3_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                             // rgb_led3_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                           // cmd_mux_007:src_channel -> rgb_led3_s1_agent:cp_channel
	...
	wire   [31:0] usb_hub_rst_s1_agent_m0_readdata;                                  // usb_hub_rst_s1_translator:uav_readdata -> usb_hub_rst_s1_agent:m0_readdata
	wire          usb_hub_rst_s1_agent_m0_waitrequest;                               // usb_hub_rst_s1_translator:uav_waitrequest -> usb_hub_rst_s1_agent:m0_waitrequest
	wire          usb_hub_rst_s1_agent_m0_debugaccess;                               // usb_hub_rst_s1_agent:m0_debugaccess -> usb_hub_rst_s1_translator:uav_debugaccess
	wire   [23:0] usb_hub_rst_s1_agent_m0_address;                                   // usb_hub_rst_s1_agent:m0_address -> usb_hub_rst_s1_translator:uav_address
	wire    [3:0] usb_hub_rst_s1_agent_m0_byteenable;                                // usb_hub_rst_s1_agent:m0_byteenable -> usb_hub_rst_s1_translator:uav_byteenable
	wire          usb_hub_rst_s1_agent_m0_read;                                      // usb_hub_rst_s1_agent:m0_read -> usb_hub_rst_s1_translator:uav_read
	wire          usb_hub_rst_s1_agent_m0_readdatavalid;                             // usb_hub_rst_s1_translator:uav_readdatavalid -> usb_hub_rst_s1_agent:m0_readdatavalid
	wire          usb_hub_rst_s1_agent_m0_lock;                                      // usb_hub_rst_s1_agent:m0_lock -> usb_hub_rst_s1_translator:uav_lock
	wire   [31:0] usb_hub_rst_s1_agent_m0_writedata;                                 // usb_hub_rst_s1_agent:m0_writedata -> usb_hub_rst_s1_translator:uav_writedata
	wire          usb_hub_rst_s1_agent_m0_write;                                     // usb_hub_rst_s1_agent:m0_write -> usb_hub_rst_s1_translator:uav_write
	wire    [2:0] usb_hub_rst_s1_agent_m0_burstcount;                                // usb_hub_rst_s1_agent:m0_burstcount -> usb_hub_rst_s1_translator:uav_burstcount
	wire          usb_hub_rst_s1_agent_rf_source_valid;                              // usb_hub_rst_s1_agent:rf_source_valid -> usb_hub_rst_s1_agent_rsp_fifo:in_valid
	wire  [122:0] usb_hub_rst_s1_agent_rf_source_data;                               // usb_hub_rst_s1_agent:rf_source_data -> usb_hub_rst_s1_agent_rsp_fifo:in_data
	wire          usb_hub_rst_s1_agent_rf_source_ready;                              // usb_hub_rst_s1_agent_rsp_fifo:in_ready -> usb_hub_rst_s1_agent:rf_source_ready
	wire          usb_hub_rst_s1_agent_rf_source_startofpacket;                      // usb_hub_rst_s1_agent:rf_source_startofpacket -> usb_hub_rst_s1_agent_rsp_fifo:in_startofpacket
	wire          usb_hub_rst_s1_agent_rf_source_endofpacket;                        // usb_hub_rst_s1_agent:rf_source_endofpacket -> usb_hub_rst_s1_agent_rsp_fifo:in_endofpacket
	wire          usb_hub_rst_s1_agent_rsp_fifo_out_valid;                           // usb_hub_rst_s1_agent_rsp_fifo:out_valid -> usb_hub_rst_s1_agent:rf_sink_valid
	wire  [122:0] usb_hub_rst_s1_agent_rsp_fifo_out_data;                            // usb_hub_rst_s1_agent_rsp_fifo:out_data -> usb_hub_rst_s1_agent:rf_sink_data
	wire          usb_hub_rst_s1_agent_rsp_fifo_out_ready;                           // usb_hub_rst_s1_agent:rf_sink_ready -> usb_hub_rst_s1_agent_rsp_fifo:out_ready
	wire          usb_hub_rst_s1_agent_rsp_fifo_out_startofpacket;                   // usb_hub_rst_s1_agent_rsp_fifo:out_startofpacket -> usb_hub_rst_s1_agent:rf_sink_startofpacket
	wire          usb_hub_rst_s1_agent_rsp_fifo_out_endofpacket;                     // usb_hub_rst_s1_agent_rsp_fifo:out_endofpacket -> usb_hub_rst_s1_agent:rf_sink_endofpacket
	wire          usb_hub_rst_s1_agent_rdata_fifo_src_valid;                         // usb_hub_rst_s1_agent:rdata_fifo_src_valid -> usb_hub_rst_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] usb_hub_rst_s1_agent_rdata_fifo_src_data;                          // usb_hub_rst_s1_agent:rdata_fifo_src_data -> usb_hub_rst_s1_agent:rdata_fifo_sink_data
	wire          usb_hub_rst_s1_agent_rdata_fifo_src_ready;                         // usb_hub_rst_s1_agent:rdata_fifo_sink_ready -> usb_hub_rst_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_008_src_valid;                                             // cmd_mux_008:src_valid -> usb_hub_rst_s1_agent:cp_valid
	wire  [121:0] cmd_mux_008_src_data;                                              // cmd_mux_008:src_data -> usb_hub_rst_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                             // usb_hub_rst_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                           // cmd_mux_008:src_channel -> usb_hub_rst_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                     // cmd_mux_008:src_startofpacket -> usb_hub_rst_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                       // cmd_mux_008:src_endofpacket -> usb_hub_rst_s1_agent:cp_endofpacket
	wire          mm_bridge_0_m0_agent_cp_valid;                                     // mm_bridge_0_m0_agent:cp_valid -> router:sink_valid
	wire  [121:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [121:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                         // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [121:0] router_001_src_data;                                               // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [121:0] sys_id_control_slave_agent_rp_data;                                // sys_id_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [121:0] router_002_src_data;                                               // router_002:src_data -> rsp_demux_001:sink_data
	...
	wire  [121:0] pb_s1_agent_rp_data;                                               // pb_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [121:0] router_003_src_data;                                               // router_003:src_data -> rsp_demux_002:sink_data
	...
	wire  [121:0] dipsw_s1_agent_rp_data;                                            // dipsw_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [121:0] router_004_src_data;                                               // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [121:0] rgb_led0_s1_agent_rp_data;                                         // rgb_led0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [121:0] router_005_src_data;                                               // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire  [121:0] rgb_led1_s1_agent_rp_data;                                         // rgb_led1_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [121:0] router_006_src_data;                                               // router_006:src_data -> rsp_demux_005:sink_data
	...
	wire  [121:0] rgb_led2_s1_agent_rp_data;                                         // rgb_led2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [121:0] router_007_src_data;                                               // router_007:src_data -> rsp_demux_006:sink_data
	...
	wire  [121:0] rgb_led3_s1_agent_rp_data;                                         // rgb_led3_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [121:0] router_008_src_data;                                               // router_008:src_data -> rsp_demux_007:sink_data
	...
	wire          usb_hub_rst_s1_agent_rp_valid;                                     // usb_hub_rst_s1_agent:rp_valid -> router_009:sink_valid
	wire  [121:0] usb_hub_rst_s1_agent_rp_data;                                      // usb_hub_rst_s1_agent:rp_data -> router_009:sink_data
	wire          usb_hub_rst_s1_agent_rp_ready;                                     // router_009:sink_ready -> usb_hub_rst_s1_agent:rp_ready
	wire          usb_hub_rst_s1_agent_rp_startofpacket;                             // usb_hub_rst_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          usb_hub_rst_s1_agent_rp_endofpacket;                               // usb_hub_rst_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire          router_009_src_valid;                                              // router_009:src_valid -> rsp_demux_008:sink_valid
	wire  [121:0] router_009_src_data;                                               // router_009:src_data -> rsp_demux_008:sink_data
	...
	wire  [121:0] router_src_data;                                                   // router:src_data -> mm_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [121:0] mm_bridge_0_m0_limiter_cmd_src_data;                               // mm_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [121:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [121:0] mm_bridge_0_m0_limiter_rsp_src_data;                               // mm_bridge_0_m0_limiter:rsp_src_data -> mm_bridge_0_m0_agent:rp_data
	...
	peripheral_sys_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (1)
	) usb_hub_rst_s1_translator (
		.clk                    (clock_in_out_clk_clk),                                        //   input,   width = 1,                      clk.clk
		.reset                  (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (usb_hub_rst_s1_agent_m0_address),                             //   input,  width = 24, avalon_universal_slave_0.address
		.uav_burstcount         (usb_hub_rst_s1_agent_m0_burstcount),                          //   input,   width = 3,                         .burstcount
		.uav_read               (usb_hub_rst_s1_agent_m0_read),                                //   input,   width = 1,                         .read
		.uav_write              (usb_hub_rst_s1_agent_m0_write),                               //   input,   width = 1,                         .write
		.uav_waitrequest        (usb_hub_rst_s1_agent_m0_waitrequest),                         //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (usb_hub_rst_s1_agent_m0_readdatavalid),                       //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (usb_hub_rst_s1_agent_m0_byteenable),                          //   input,   width = 4,                         .byteenable
		.uav_readdata           (usb_hub_rst_s1_agent_m0_readdata),                            //  output,  width = 32,                         .readdata
		.uav_writedata          (usb_hub_rst_s1_agent_m0_writedata),                           //   input,  width = 32,                         .writedata
		.uav_lock               (usb_hub_rst_s1_agent_m0_lock),                                //   input,   width = 1,                         .lock
		.uav_debugaccess        (usb_hub_rst_s1_agent_m0_debugaccess),                         //   input,   width = 1,                         .debugaccess
		.av_address             (usb_hub_rst_s1_address),                                      //  output,   width = 2,      avalon_anti_slave_0.address
		.av_write               (usb_hub_rst_s1_write),                                        //  output,   width = 1,                         .write
		.av_readdata            (usb_hub_rst_s1_readdata),                                     //   input,  width = 32,                         .readdata
		.av_writedata           (usb_hub_rst_s1_writedata),                                    //  output,  width = 32,                         .writedata
		.av_chipselect          (usb_hub_rst_s1_chipselect),                                   //  output,   width = 1,                         .chipselect
		.av_read                (),                                                            // (terminated),                                       
		.av_begintransfer       (),                                                            // (terminated),                                       
		.av_beginbursttransfer  (),                                                            // (terminated),                                       
		.av_burstcount          (),                                                            // (terminated),                                       
	...
	peripheral_sys_altera_merlin_master_agent_1921_2inlndi #(
		...
		.cp_data               (mm_bridge_0_m0_agent_cp_data),                                      //  output,  width = 122,          .data
		...
		.rp_data               (mm_bridge_0_m0_limiter_rsp_src_data),                               //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (jtag_uart_avalon_jtag_slave_agent_rp_data),                    //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_src_data),                                             //   input,  width = 122,                .data
		...
		.rf_sink_data            (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //   input,  width = 123,                .data
		...
		.rf_source_data          (jtag_uart_avalon_jtag_slave_agent_rf_source_data),             //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (jtag_uart_avalon_jtag_slave_agent_rf_source_data),             //   input,  width = 123,        in.data
		...
		.out_data          (jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data),          //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (sys_id_control_slave_agent_rp_data),                          //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_001_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (sys_id_control_slave_agent_rsp_fifo_out_data),                //   input,  width = 123,                .data
		...
		.rf_source_data          (sys_id_control_slave_agent_rf_source_data),                   //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.in_data           (sys_id_control_slave_agent_rf_source_data),             //   input,  width = 123,        in.data
		...
		.out_data          (sys_id_control_slave_agent_rsp_fifo_out_data),          //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (pb_s1_agent_rp_data),                                         //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_002_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (pb_s1_agent_rsp_fifo_out_data),                               //   input,  width = 123,                .data
		...
		.rf_source_data          (pb_s1_agent_rf_source_data),                                  //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (pb_s1_agent_rf_source_data),                    //   input,  width = 123,        in.data
		...
		.out_data          (pb_s1_agent_rsp_fifo_out_data),                 //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (dipsw_s1_agent_rp_data),                                      //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_003_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (dipsw_s1_agent_rsp_fifo_out_data),                            //   input,  width = 123,                .data
		...
		.rf_source_data          (dipsw_s1_agent_rf_source_data),                               //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (dipsw_s1_agent_rf_source_data),                 //   input,  width = 123,        in.data
		...
		.out_data          (dipsw_s1_agent_rsp_fifo_out_data),              //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (rgb_led0_s1_agent_rp_data),                                   //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_004_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (rgb_led0_s1_agent_rsp_fifo_out_data),                         //   input,  width = 123,                .data
		...
		.rf_source_data          (rgb_led0_s1_agent_rf_source_data),                            //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led0_s1_agent_rf_source_data),              //   input,  width = 123,        in.data
		...
		.out_data          (rgb_led0_s1_agent_rsp_fifo_out_data),           //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (rgb_led1_s1_agent_rp_data),                                   //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_005_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (rgb_led1_s1_agent_rsp_fifo_out_data),                         //   input,  width = 123,                .data
		...
		.rf_source_data          (rgb_led1_s1_agent_rf_source_data),                            //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led1_s1_agent_rf_source_data),              //   input,  width = 123,        in.data
		...
		.out_data          (rgb_led1_s1_agent_rsp_fifo_out_data),           //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (rgb_led2_s1_agent_rp_data),                                   //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_006_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (rgb_led2_s1_agent_rsp_fifo_out_data),                         //   input,  width = 123,                .data
		...
		.rf_source_data          (rgb_led2_s1_agent_rf_source_data),                            //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led2_s1_agent_rf_source_data),              //   input,  width = 123,        in.data
		...
		.out_data          (rgb_led2_s1_agent_rsp_fifo_out_data),           //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (rgb_led3_s1_agent_rp_data),                                   //  output,  width = 122,                .data
		...
		.cp_data                 (cmd_mux_007_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_data            (rgb_led3_s1_agent_rsp_fifo_out_data),                         //   input,  width = 123,                .data
		...
		.rf_source_data          (rgb_led3_s1_agent_rf_source_data),                            //  output,  width = 123,                .data
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (rgb_led3_s1_agent_rf_source_data),              //   input,  width = 123,        in.data
		...
		.out_data          (rgb_led3_s1_agent_rsp_fifo_out_data),           //  output,  width = 123,       out.data
	...
	peripheral_sys_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.USE_PKT_DATACHK           (0),
		.ROLE_BASED_USER           (0)
	) usb_hub_rst_s1_agent (
		.clk                     (clock_in_out_clk_clk),                                        //   input,    width = 1,             clk.clk
		.reset                   (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,       clk_reset.reset
		.m0_address              (usb_hub_rst_s1_agent_m0_address),                             //  output,   width = 24,              m0.address
		.m0_burstcount           (usb_hub_rst_s1_agent_m0_burstcount),                          //  output,    width = 3,                .burstcount
		.m0_byteenable           (usb_hub_rst_s1_agent_m0_byteenable),                          //  output,    width = 4,                .byteenable
		.m0_debugaccess          (usb_hub_rst_s1_agent_m0_debugaccess),                         //  output,    width = 1,                .debugaccess
		.m0_lock                 (usb_hub_rst_s1_agent_m0_lock),                                //  output,    width = 1,                .lock
		.m0_readdata             (usb_hub_rst_s1_agent_m0_readdata),                            //   input,   width = 32,                .readdata
		.m0_readdatavalid        (usb_hub_rst_s1_agent_m0_readdatavalid),                       //   input,    width = 1,                .readdatavalid
		.m0_read                 (usb_hub_rst_s1_agent_m0_read),                                //  output,    width = 1,                .read
		.m0_waitrequest          (usb_hub_rst_s1_agent_m0_waitrequest),                         //   input,    width = 1,                .waitrequest
		.m0_writedata            (usb_hub_rst_s1_agent_m0_writedata),                           //  output,   width = 32,                .writedata
		.m0_write                (usb_hub_rst_s1_agent_m0_write),                               //  output,    width = 1,                .write
		.rp_endofpacket          (usb_hub_rst_s1_agent_rp_endofpacket),                         //  output,    width = 1,              rp.endofpacket
		.rp_ready                (usb_hub_rst_s1_agent_rp_ready),                               //   input,    width = 1,                .ready
		.rp_valid                (usb_hub_rst_s1_agent_rp_valid),                               //  output,    width = 1,                .valid
		.rp_data                 (usb_hub_rst_s1_agent_rp_data),                                //  output,  width = 122,                .data
		.rp_startofpacket        (usb_hub_rst_s1_agent_rp_startofpacket),                       //  output,    width = 1,                .startofpacket
		.cp_ready                (cmd_mux_008_src_ready),                                       //  output,    width = 1,              cp.ready
		.cp_valid                (cmd_mux_008_src_valid),                                       //   input,    width = 1,                .valid
		.cp_data                 (cmd_mux_008_src_data),                                        //   input,  width = 122,                .data
		...
		.rf_sink_ready           (usb_hub_rst_s1_agent_rsp_fifo_out_ready),                     //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (usb_hub_rst_s1_agent_rsp_fifo_out_valid),                     //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (usb_hub_rst_s1_agent_rsp_fifo_out_startofpacket),             //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (usb_hub_rst_s1_agent_rsp_fifo_out_endofpacket),               //   input,    width = 1,                .endofpacket
		.rf_sink_data            (usb_hub_rst_s1_agent_rsp_fifo_out_data),                      //   input,  width = 123,                .data
		.rf_source_ready         (usb_hub_rst_s1_agent_rf_source_ready),                        //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (usb_hub_rst_s1_agent_rf_source_valid),                        //  output,    width = 1,                .valid
		.rf_source_startofpacket (usb_hub_rst_s1_agent_rf_source_startofpacket),                //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (usb_hub_rst_s1_agent_rf_source_endofpacket),                  //  output,    width = 1,                .endofpacket
		.rf_source_data          (usb_hub_rst_s1_agent_rf_source_data),                         //  output,  width = 123,                .data
		.rdata_fifo_sink_ready   (usb_hub_rst_s1_agent_rdata_fifo_src_ready),                   //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (usb_hub_rst_s1_agent_rdata_fifo_src_valid),                   //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (usb_hub_rst_s1_agent_rdata_fifo_src_data),                    //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (usb_hub_rst_s1_agent_rdata_fifo_src_ready),                   //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (usb_hub_rst_s1_agent_rdata_fifo_src_valid),                   //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (usb_hub_rst_s1_agent_rdata_fifo_src_data),                    //  output,   width = 34,                .data
		.m0_response             (2'b00),                                                       // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                        // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                         // (terminated),                               
	);
	...
	peripheral_sys_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) usb_hub_rst_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (usb_hub_rst_s1_agent_rf_source_data),             //   input,  width = 123,        in.data
		.in_valid          (usb_hub_rst_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (usb_hub_rst_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (usb_hub_rst_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (usb_hub_rst_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (usb_hub_rst_s1_agent_rsp_fifo_out_data),          //  output,  width = 123,       out.data
		.out_valid         (usb_hub_rst_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (usb_hub_rst_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (usb_hub_rst_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (usb_hub_rst_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                           // (terminated),                         
		.csr_read          (1'b0),                                            // (terminated),                         
		.csr_write         (1'b0),                                            // (terminated),                         
		.csr_readdata      (),                                                // (terminated),                         
	...
	peripheral_sys_altera_merlin_router_1921_qhuuwfa router (
		...
		.sink_data          (mm_bridge_0_m0_agent_cp_data),                                //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_router_1921_qo6xtmi router_001 (
		...
		.sink_data          (jtag_uart_avalon_jtag_slave_agent_rp_data),                   //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_router_1921_qo6xtmi router_002 (
		...
		.sink_data          (sys_id_control_slave_agent_rp_data),                          //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_router_1921_qo6xtmi router_003 (
		.sink_ready         (pb_s1_agent_rp_ready),                                        //  output,    width = 1,      sink.ready
		.sink_valid         (pb_s1_agent_rp_valid),                                        //   input,    width = 1,          .valid
		.sink_data          (pb_s1_agent_rp_data),                                         //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_router_1921_qo6xtmi router_009 (
		.sink_ready         (usb_hub_rst_s1_agent_rp_ready),                               //  output,    width = 1,      sink.ready
		.sink_valid         (usb_hub_rst_s1_agent_rp_valid),                               //   input,    width = 1,          .valid
		.sink_data          (usb_hub_rst_s1_agent_rp_data),                                //   input,  width = 122,          .data
		.sink_startofpacket (usb_hub_rst_s1_agent_rp_startofpacket),                       //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (usb_hub_rst_s1_agent_rp_endofpacket),                         //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_traffic_limiter_1921_js7yfey #(
		...
		.cmd_src_data           (mm_bridge_0_m0_limiter_cmd_src_data),                         //  output,  width = 122,          .data
		...
		.rsp_src_data           (mm_bridge_0_m0_limiter_rsp_src_data),                         //  output,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_qfeq53y cmd_demux (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (mm_bridge_0_m0_limiter_cmd_src_data),                         //   input,  width = 122,           .data
		...
		.src6_data          (cmd_demux_src6_data),                                         //  output,  width = 122,           .data
		...
		.src7_data          (cmd_demux_src7_data),                                         //  output,  width = 122,           .data
		...
		.src8_data          (cmd_demux_src8_data),                                         //  output,  width = 122,           .data
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_006_src_ready),                                       //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_006_src_valid),                                       //  output,    width = 1,          .valid
		.src_data            (cmd_mux_006_src_data),                                        //  output,  width = 122,          .data
		...
		.sink0_data          (cmd_demux_src6_data),                                         //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_007 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_007_src_ready),                                       //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_007_src_valid),                                       //  output,    width = 1,          .valid
		.src_data            (cmd_mux_007_src_data),                                        //  output,  width = 122,          .data
		...
		.sink0_data          (cmd_demux_src7_data),                                         //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_multiplexer_1922_ukqcl7i cmd_mux_008 (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_008_src_ready),                                       //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_008_src_valid),                                       //  output,    width = 1,          .valid
		.src_data            (cmd_mux_008_src_data),                                        //  output,  width = 122,          .data
		...
		.sink0_data          (cmd_demux_src8_data),                                         //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                                        //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                                      //   input,    width = 9,          .channel
		.sink_data          (router_001_src_data),                                         //   input,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_006 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (rsp_demux_006_src0_data),                                     //  output,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_007 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (rsp_demux_007_src0_data),                                     //  output,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_demultiplexer_1921_zarpduy rsp_demux_008 (
		.clk                (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset              (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (rsp_demux_008_src0_data),                                     //  output,  width = 122,          .data
	...
	peripheral_sys_altera_merlin_multiplexer_1922_4pp4lma rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset               (mm_bridge_0_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink6_data          (rsp_demux_006_src0_data),                                     //   input,  width = 122,          .data
		...
		.sink7_data          (rsp_demux_007_src0_data),                                     //   input,  width = 122,          .data
		...
		.sink8_data          (rsp_demux_008_src0_data),                                     //   input,  width = 122,          .data
