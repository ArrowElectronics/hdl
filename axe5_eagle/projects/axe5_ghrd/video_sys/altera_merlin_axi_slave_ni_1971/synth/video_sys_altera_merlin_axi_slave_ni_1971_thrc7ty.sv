...
module video_sys_altera_merlin_axi_slave_ni_1971_thrc7ty
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    video_sys_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_sl2uxwa #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    video_sys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ufj2aqq #(
      .SYMBOLS_PER_BEAT (1),
    ...
    video_sys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_qv4qemy #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       video_sys_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_xih2ywq #(
             .SYMBOLS_PER_BEAT (1),
