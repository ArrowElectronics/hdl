// video_sys_altera_mm_interconnect_1920_ucuxaca.v
...
`timescale 1 ps / 1 ps
module video_sys_altera_mm_interconnect_1920_ucuxaca (
	...
	wire  [115:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> hdmi_dmac_0_s_axi_agent:write_cp_data
	wire          cmd_mux_src_ready;                                                     // hdmi_dmac_0_s_axi_agent:write_cp_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> hdmi_dmac_0_s_axi_agent:write_cp_channel
	...
	wire  [115:0] cmd_mux_001_src_data;                                                  // cmd_mux_001:src_data -> hdmi_dmac_0_s_axi_agent:read_cp_data
	wire          cmd_mux_001_src_ready;                                                 // hdmi_dmac_0_s_axi_agent:read_cp_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                               // cmd_mux_001:src_channel -> hdmi_dmac_0_s_axi_agent:read_cp_channel
	...
	wire          cmd_mux_002_src_valid;                                                 // cmd_mux_002:src_valid -> axi_hdmi_tx_0_s_axi_agent:write_cp_valid
	wire  [115:0] cmd_mux_002_src_data;                                                  // cmd_mux_002:src_data -> axi_hdmi_tx_0_s_axi_agent:write_cp_data
	wire          cmd_mux_002_src_ready;                                                 // axi_hdmi_tx_0_s_axi_agent:write_cp_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                               // cmd_mux_002:src_channel -> axi_hdmi_tx_0_s_axi_agent:write_cp_channel
	wire          cmd_mux_002_src_startofpacket;                                         // cmd_mux_002:src_startofpacket -> axi_hdmi_tx_0_s_axi_agent:write_cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                           // cmd_mux_002:src_endofpacket -> axi_hdmi_tx_0_s_axi_agent:write_cp_endofpacket
	wire          cmd_mux_003_src_valid;                                                 // cmd_mux_003:src_valid -> axi_hdmi_tx_0_s_axi_agent:read_cp_valid
	wire  [115:0] cmd_mux_003_src_data;                                                  // cmd_mux_003:src_data -> axi_hdmi_tx_0_s_axi_agent:read_cp_data
	wire          cmd_mux_003_src_ready;                                                 // axi_hdmi_tx_0_s_axi_agent:read_cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                               // cmd_mux_003:src_channel -> axi_hdmi_tx_0_s_axi_agent:read_cp_channel
	wire          cmd_mux_003_src_startofpacket;                                         // cmd_mux_003:src_startofpacket -> axi_hdmi_tx_0_s_axi_agent:read_cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                           // cmd_mux_003:src_endofpacket -> axi_hdmi_tx_0_s_axi_agent:read_cp_endofpacket
	wire          mm_video_bridge_m0_agent_cp_valid;                                     // mm_video_bridge_m0_agent:cp_valid -> router:sink_valid
	wire  [115:0] mm_video_bridge_m0_agent_cp_data;                                      // mm_video_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [115:0] hdmi_dmac_0_s_axi_agent_write_rp_data;                                 // hdmi_dmac_0_s_axi_agent:write_rp_data -> router_001:sink_data
	...
	wire  [115:0] hdmi_dmac_0_s_axi_agent_read_rp_data;                                  // hdmi_dmac_0_s_axi_agent:read_rp_data -> router_002:sink_data
	...
	wire          axi_hdmi_tx_0_s_axi_agent_write_rp_valid;                              // axi_hdmi_tx_0_s_axi_agent:write_rp_valid -> router_003:sink_valid
	wire  [115:0] axi_hdmi_tx_0_s_axi_agent_write_rp_data;                               // axi_hdmi_tx_0_s_axi_agent:write_rp_data -> router_003:sink_data
	wire          axi_hdmi_tx_0_s_axi_agent_write_rp_ready;                              // router_003:sink_ready -> axi_hdmi_tx_0_s_axi_agent:write_rp_ready
	wire          axi_hdmi_tx_0_s_axi_agent_write_rp_startofpacket;                      // axi_hdmi_tx_0_s_axi_agent:write_rp_startofpacket -> router_003:sink_startofpacket
	wire          axi_hdmi_tx_0_s_axi_agent_write_rp_endofpacket;                        // axi_hdmi_tx_0_s_axi_agent:write_rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          axi_hdmi_tx_0_s_axi_agent_read_rp_valid;                               // axi_hdmi_tx_0_s_axi_agent:read_rp_valid -> router_004:sink_valid
	wire  [115:0] axi_hdmi_tx_0_s_axi_agent_read_rp_data;                                // axi_hdmi_tx_0_s_axi_agent:read_rp_data -> router_004:sink_data
	wire          axi_hdmi_tx_0_s_axi_agent_read_rp_ready;                               // router_004:sink_ready -> axi_hdmi_tx_0_s_axi_agent:read_rp_ready
	wire          axi_hdmi_tx_0_s_axi_agent_read_rp_startofpacket;                       // axi_hdmi_tx_0_s_axi_agent:read_rp_startofpacket -> router_004:sink_startofpacket
	wire          axi_hdmi_tx_0_s_axi_agent_read_rp_endofpacket;                         // axi_hdmi_tx_0_s_axi_agent:read_rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [115:0] router_src_data;                                                       // router:src_data -> mm_video_bridge_m0_limiter:cmd_sink_data
	wire          router_src_ready;                                                      // mm_video_bridge_m0_limiter:cmd_sink_ready -> router:src_ready
	wire    [3:0] router_src_channel;                                                    // router:src_channel -> mm_video_bridge_m0_limiter:cmd_sink_channel
	...
	wire  [115:0] mm_video_bridge_m0_limiter_cmd_src_data;                               // mm_video_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          mm_video_bridge_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> mm_video_bridge_m0_limiter:cmd_src_ready
	wire    [3:0] mm_video_bridge_m0_limiter_cmd_src_channel;                            // mm_video_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [115:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_video_bridge_m0_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                     // mm_video_bridge_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                   // rsp_mux:src_channel -> mm_video_bridge_m0_limiter:rsp_sink_channel
	...
	wire  [115:0] mm_video_bridge_m0_limiter_rsp_src_data;                               // mm_video_bridge_m0_limiter:rsp_src_data -> mm_video_bridge_m0_agent:rp_data
	wire          mm_video_bridge_m0_limiter_rsp_src_ready;                              // mm_video_bridge_m0_agent:rp_ready -> mm_video_bridge_m0_limiter:rsp_src_ready
	wire    [3:0] mm_video_bridge_m0_limiter_rsp_src_channel;                            // mm_video_bridge_m0_limiter:rsp_src_channel -> mm_video_bridge_m0_agent:rp_channel
	...
	wire    [3:0] mm_video_bridge_m0_limiter_cmd_valid_data;                             // mm_video_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	video_sys_altera_merlin_master_agent_1921_2inlndi #(
		.PKT_WUNIQUE               (102),
		.PKT_DOMAIN_H              (101),
		.PKT_DOMAIN_L              (100),
		.PKT_SNOOP_H               (99),
		...
		.cp_data               (mm_video_bridge_m0_agent_cp_data),                                      //  output,  width = 116,          .data
		...
		.rp_data               (mm_video_bridge_m0_limiter_rsp_src_data),                               //   input,  width = 116,          .data
		.rp_channel            (mm_video_bridge_m0_limiter_rsp_src_channel),                            //   input,    width = 4,          .channel
	...
	video_sys_altera_merlin_axi_slave_ni_1971_thrc7ty #(
		.PKT_QOS_H                   (78),
		.PKT_QOS_L                   (78),
		.PKT_THREAD_ID_H             (81),
		.PKT_THREAD_ID_L             (81),
		...
		.read_cp_data           (cmd_mux_001_src_data),                                             //   input,  width = 116,                  .data
		...
		.write_cp_data          (cmd_mux_src_data),                                                 //   input,  width = 116,                  .data
		...
		.read_rp_data           (hdmi_dmac_0_s_axi_agent_read_rp_data),                             //  output,  width = 116,                  .data
		...
		.write_rp_data          (hdmi_dmac_0_s_axi_agent_write_rp_data),                            //  output,  width = 116,                  .data
	...
	video_sys_altera_merlin_axi_slave_ni_1971_taj4bri #(
		.PKT_QOS_H                   (78),
		.PKT_QOS_L                   (78),
		.PKT_THREAD_ID_H             (81),
		.PKT_THREAD_ID_L             (81),
		...
		.read_cp_data           (cmd_mux_003_src_data),                                             //   input,  width = 116,                  .data
		...
		.write_cp_data          (cmd_mux_002_src_data),                                             //   input,  width = 116,                  .data
		...
		.read_rp_data           (axi_hdmi_tx_0_s_axi_agent_read_rp_data),                           //  output,  width = 116,                  .data
		...
		.write_rp_data          (axi_hdmi_tx_0_s_axi_agent_write_rp_data),                          //  output,  width = 116,                  .data
	...
	video_sys_altera_merlin_router_1921_s5wm43a router (
		...
		.sink_data          (mm_video_bridge_m0_agent_cp_data),                                //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_router_1921_uemcnxy router_001 (
		...
		.sink_data          (hdmi_dmac_0_s_axi_agent_write_rp_data),                           //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_router_1921_uemcnxy router_002 (
		...
		.sink_data          (hdmi_dmac_0_s_axi_agent_read_rp_data),                            //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_router_1921_uemcnxy router_003 (
		...
		.sink_data          (axi_hdmi_tx_0_s_axi_agent_write_rp_data),                         //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_router_1921_uemcnxy router_004 (
		...
		.sink_data          (axi_hdmi_tx_0_s_axi_agent_read_rp_data),                          //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_traffic_limiter_1921_js7yfey #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (80),
		.PKT_DEST_ID_L                        (80),
		.PKT_SRC_ID_H                         (79),
		...
		.cmd_src_data           (mm_video_bridge_m0_limiter_cmd_src_data),                         //  output,  width = 116,          .data
		.cmd_src_channel        (mm_video_bridge_m0_limiter_cmd_src_channel),                      //  output,    width = 4,          .channel
		...
		.rsp_src_data           (mm_video_bridge_m0_limiter_rsp_src_data),                         //  output,  width = 116,          .data
		.rsp_src_channel        (mm_video_bridge_m0_limiter_rsp_src_channel),                      //  output,    width = 4,          .channel
		...
		.cmd_src_valid          (mm_video_bridge_m0_limiter_cmd_valid_data)                        //  output,    width = 4, cmd_valid.data
	);

	video_sys_altera_merlin_demultiplexer_1921_4auxzhi cmd_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,        clk.clk
		.reset              (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (mm_video_bridge_m0_limiter_cmd_src_ready),                        //  output,    width = 1,       sink.ready
		.sink_channel       (mm_video_bridge_m0_limiter_cmd_src_channel),                      //   input,    width = 4,           .channel
		.sink_data          (mm_video_bridge_m0_limiter_cmd_src_data),                         //   input,  width = 116,           .data
		...
		.sink_valid         (mm_video_bridge_m0_limiter_cmd_valid_data),                       //   input,    width = 4, sink_valid.data
		...
		.src3_data          (cmd_demux_src3_data),                                             //  output,  width = 116,           .data
	...
	video_sys_altera_merlin_multiplexer_1922_khgvctq cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_multiplexer_1922_khgvctq cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_multiplexer_1922_khgvctq cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_multiplexer_1922_khgvctq cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_003_src_ready),                                           //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_003_src_valid),                                           //  output,    width = 1,          .valid
		.src_data            (cmd_mux_003_src_data),                                            //  output,  width = 116,          .data
		...
		.sink0_data          (cmd_demux_src3_data),                                             //   input,  width = 116,          .data
	...
	video_sys_altera_merlin_demultiplexer_1921_lpm4ray rsp_demux (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_demultiplexer_1921_lpm4ray rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_demultiplexer_1921_lpm4ray rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	video_sys_altera_merlin_demultiplexer_1921_lpm4ray rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (rsp_demux_003_src0_data),                                         //  output,  width = 116,          .data
	...
	video_sys_altera_merlin_multiplexer_1922_y2t6q2i rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset               (mm_video_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink3_data          (rsp_demux_003_src0_data),                                         //   input,  width = 116,          .data
