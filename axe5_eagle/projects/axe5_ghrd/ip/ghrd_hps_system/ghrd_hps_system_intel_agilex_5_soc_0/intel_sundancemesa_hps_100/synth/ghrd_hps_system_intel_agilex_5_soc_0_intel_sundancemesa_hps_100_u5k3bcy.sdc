...
if {[get_collection_size [get_nodes -nowarn sundancemesa_hps_inst~l4_sp_clk]  ] > 0} { 
	 create_clock -name l4_sp_clk_src -period 10.0 [get_nodes -nowarn sundancemesa_hps_inst~l4_sp_clk] 
	 create_generated_clock -divide_by 1 -name l4_sp_clk [get_registers sundancemesa_hps_inst~l4_sp_clk.reg] -master_clock [get_clocks l4_sp_clk_src] -source [get_nodes sundancemesa_hps_inst~l4_sp_clk] 
} 
...
if {[get_collection_size [get_registers sundancemesa_hps_inst~l4_main_clk]  ] > 0} { 
	 create_clock -add -name spim0_clk_src -period 8.0 [get_registers sundancemesa_hps_inst~l4_main_clk] 
} 
