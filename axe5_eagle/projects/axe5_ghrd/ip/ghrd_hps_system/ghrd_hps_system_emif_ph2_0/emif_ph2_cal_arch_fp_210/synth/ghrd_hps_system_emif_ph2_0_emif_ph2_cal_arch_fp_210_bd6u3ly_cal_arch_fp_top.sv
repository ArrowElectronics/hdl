...
module ghrd_hps_system_emif_ph2_0_emif_ph2_cal_arch_fp_210_bd6u3ly_cal_arch_fp_top #(
...
//// User/Debug Interface via NoC
   input                                tniul_rst_n      ,
   output                               s0_noc_axil_clk     ,
   output                               s0_noc_axil_rst_n   ,
   input  [PORT_AXIL_ADDRESS_WIDTH-1:0] s0_noc_axil_awaddr  ,
   input                                s0_noc_axil_awvalid ,
   output                               s0_noc_axil_awready ,
   input  [PORT_AXIL_ADDRESS_WIDTH-1:0] s0_noc_axil_araddr  ,
   input                                s0_noc_axil_arvalid ,
   output                               s0_noc_axil_arready ,
   input  [PORT_AXIL_DATA_WIDTH-1:0]     s0_noc_axil_wdata   ,
   input                                 s0_noc_axil_wvalid  ,
   output                                s0_noc_axil_wready  ,
   output [1:0]                          s0_noc_axil_rresp   ,
   output [PORT_AXIL_DATA_WIDTH-1:0]     s0_noc_axil_rdata   ,
   output                                s0_noc_axil_rvalid  ,
   input                                 s0_noc_axil_rready  ,
   output [1:0]                          s0_noc_axil_bresp   ,
   output                                s0_noc_axil_bvalid  ,
   input                                 s0_noc_axil_bready  ,
   input  [2:0]                          s0_noc_axil_awprot  ,
   input  [2:0]                          s0_noc_axil_arprot  ,
   input  [(PORT_AXIL_DATA_WIDTH/8)-1:0] s0_noc_axil_wstrb   ,

//// User/Debug Interface directy to Fabric
   input                                 s0_axil_clk     ,
   input                                 s0_axil_rst_n   ,
   input   [PORT_AXIL_ADDRESS_WIDTH-1:0] s0_axil_awaddr  ,
   input                                 s0_axil_awvalid ,
   output                                s0_axil_awready ,
   input   [PORT_AXIL_ADDRESS_WIDTH-1:0] s0_axil_araddr  ,
   input                                 s0_axil_arvalid ,
   output                                s0_axil_arready ,
   input   [PORT_AXIL_DATA_WIDTH-1:0]    s0_axil_wdata   ,
   input                                 s0_axil_wvalid  ,
   output                                s0_axil_wready  ,
   output   [1:0]                        s0_axil_rresp   ,
   output  [PORT_AXIL_DATA_WIDTH-1:0]    s0_axil_rdata   ,
   output                                s0_axil_rvalid  ,
   input                                 s0_axil_rready  ,
   output   [1:0]                        s0_axil_bresp   ,
   output                                s0_axil_bvalid  ,
   input                                 s0_axil_bready  ,
   
//// User Interface directy from Fabric (M)
   output                                m0_axil_clk     ,
   output                                m0_axil_rst_n   ,
   output  [PORT_AXIL_ADDRESS_WIDTH-1:0] m0_axil_awaddr  ,
   output                                m0_axil_awvalid ,
   input                                 m0_axil_awready ,
   output  [PORT_AXIL_ADDRESS_WIDTH-1:0] m0_axil_araddr  ,
   output                                m0_axil_arvalid ,
   input                                 m0_axil_arready ,
   output   [PORT_AXIL_DATA_WIDTH-1:0]    m0_axil_wdata   ,
   output                                m0_axil_wvalid  ,
   input                                 m0_axil_wready  ,
   input    [1:0]                        m0_axil_rresp   ,
   input   [PORT_AXIL_DATA_WIDTH-1:0]    m0_axil_rdata   ,
   input                                 m0_axil_rvalid  ,
   output                                m0_axil_rready  ,
   input    [1:0]                        m0_axil_bresp   ,
   input                                 m0_axil_bvalid  ,
   output                                m0_axil_bready  ,
   output [2:0]                          m0_axil_awprot  ,
   output [2:0]                          m0_axil_arprot  ,
   output [(PORT_AXIL_DATA_WIDTH/8)-1:0] m0_axil_wstrb   ,
   

   input  [2:0]                          s0_axil_awprot  ,
   input  [2:0]                          s0_axil_arprot  ,
   input  [(PORT_AXIL_DATA_WIDTH/8)-1:0] s0_axil_wstrb   
   ...
   assign s0_noc_axil_rst_n = tniul_rst_n;
   ...
   altera_emif_cal_gearbox_bidir #(
      ...
      .axi_clk(s0_axil_clk),
      .axi_rst_n(s0_axil_rst_n),
      .c2f_rst_n(PORT_M_AXIL_ENABLE ? fbr_c2f_rst_n : s0_axil_rst_n),

   // AXI-L S INF
      .axi_awvalid(s0_axil_awvalid),
      .axi_awready(s0_axil_awready),
      .axi_awaddr(s0_axil_awaddr),

      .axi_arvalid(s0_axil_arvalid),
      .axi_arready(s0_axil_arready),
      .axi_araddr(s0_axil_araddr),

      .axi_wvalid(s0_axil_wvalid),
      .axi_wready(s0_axil_wready),
      .axi_wdata(s0_axil_wdata),

      .axi_rvalid(s0_axil_rvalid),
      .axi_rready(s0_axil_rready),
      .axi_rresp(s0_axil_rresp),
      .axi_rdata(s0_axil_rdata),

      .axi_bvalid(s0_axil_bvalid),
      .axi_bready(s0_axil_bready),
      .axi_bresp(s0_axil_bresp),

    // AXI-L M INF
      .m_axi_awvalid(m0_axil_awvalid),
      .m_axi_awready(m0_axil_awready),
      .m_axi_awaddr(m0_axil_awaddr),

      .m_axi_arvalid(m0_axil_arvalid),
      .m_axi_arready(m0_axil_arready),
      .m_axi_araddr(m0_axil_araddr),

      .m_axi_wvalid(m0_axil_wvalid),
      .m_axi_wready(m0_axil_wready),
      .m_axi_wdata(m0_axil_wdata),

      .m_axi_rvalid(m0_axil_rvalid),
      .m_axi_rready(m0_axil_rready),
      .m_axi_rresp(m0_axil_rresp),
      .m_axi_rdata(m0_axil_rdata),

      .m_axi_bvalid(m0_axil_bvalid),
      .m_axi_bready(m0_axil_bready),
      .m_axi_bresp(m0_axil_bresp),
   ...
   assign m0_axil_awprot = '0;
   assign m0_axil_arprot = '0;
   assign m0_axil_wstrb = { (PORT_AXIL_DATA_WIDTH/8) {1'b1} }; 
   ...
   stdfn_inst_fa_c2p_ssm #(
      ...
      .FA_CORE_PERIPH_CLK_SEL_DATA_MODE("FA_CORE_PERIPH_CLK_SEL_DATA_MODE_UNUSED"),
...
// synthesis translate_off
                                seq_to_fa__seq_cmd_sync,    //1 bit
// synthesis translate_on
                                cpa_to_fa__lock,            //2 bits
                                iofbradapt_ssm_p2c          
                           };
...
// synthesis translate_off
    initial
        $display("HACK, cal_arch_top seq_to_fa__seq_cmd_sync was removed for synth netlist. Remove hack once HSD: https://hsdes.intel.com/resource/14018365256 is fixed");
// synthesis translate_on
    

   ghrd_hps_system_emif_ph2_0_emif_ph2_cal_arch_fp_210_bd6u3ly_stdfn_inst_iossm #(
   ) u_iossm (
      .iofbradapt_ssm_p2c               (iofbradapt_ssm_p2c), 
      .iofbradapt_ssm_c2p               (iofbradapt_ssm_c2p), 
      .c2p_clk                          (s0_axil_clk),  

       .axil_clk                         (s0_noc_axil_clk    ),
       .axil_wready                      (s0_noc_axil_wready ),
       .axil_rvalid                      (s0_noc_axil_rvalid ),
       .axil_rresp                       (s0_noc_axil_rresp  ),
       .axil_rdata                       (s0_noc_axil_rdata  ),
       .axil_bvalid                      (s0_noc_axil_bvalid ),
       .axil_bresp                       (s0_noc_axil_bresp  ),
       .axil_awready                     (s0_noc_axil_awready),
       .axil_arready                     (s0_noc_axil_arready),
       .axil_wvalid                      (s0_noc_axil_wvalid ),
       .axil_wstrb                       (s0_noc_axil_wstrb  ),
       .axil_wdata                       (s0_noc_axil_wdata  ),
       .axil_rready                      (s0_noc_axil_rready ),
       .axil_bready                      (s0_noc_axil_bready ),
       .axil_awvalid                     (s0_noc_axil_awvalid),
       .axil_awaddr                      (s0_noc_axil_awaddr ),
       .axil_arvalid                     (s0_noc_axil_arvalid),
       .axil_araddr                      (s0_noc_axil_araddr ),
   ...
   ghrd_hps_system_emif_ph2_0_emif_ph2_cal_arch_fp_210_bd6u3ly_stdfn_inst_seq #(
   ) u_seq (
