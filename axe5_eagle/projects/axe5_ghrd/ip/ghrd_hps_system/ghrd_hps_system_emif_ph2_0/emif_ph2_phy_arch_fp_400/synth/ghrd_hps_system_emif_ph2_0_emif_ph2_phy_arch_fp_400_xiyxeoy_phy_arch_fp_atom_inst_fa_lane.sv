...
module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_fa_lane #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::*;
   import ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_lane::*;
   ...
   generate
      if (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::IS_USED[ID])
      begin : gen_lane_c2p_fa
         tennm_lane_c2p_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode        (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
      ...
      if (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_lane::IS_USED[ID])
      begin : gen_lane_p2c_fa
         tennm_lane_p2c_fabric_adaptor # (
            .fa_core_periph_clk_sel_data_mode        (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_lane::FA_CORE_PERIPH_CLK_SEL_DATA_MODE[ID]),
   ...
   generate
   begin   
      if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 100) && (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 225) && (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::IS_USED[ID]))
      ...
      else if ((C2P_REGISTER_STAGE > 0) && (C2P_REGISTER_DELAY_PS == 350) && (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_c2p_lane::IS_USED[ID]))
   ...
   generate
   begin
      if ((P2C_REGISTER_STAGE > 0) && (ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_fa_p2c_lane::IS_USED[ID]))
