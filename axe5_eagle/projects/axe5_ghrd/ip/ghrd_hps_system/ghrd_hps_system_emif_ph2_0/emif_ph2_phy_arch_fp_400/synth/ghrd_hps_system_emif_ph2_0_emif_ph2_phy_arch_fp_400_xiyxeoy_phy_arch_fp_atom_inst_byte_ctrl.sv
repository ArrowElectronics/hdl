...
module ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_byte_ctrl #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_byte_ctrl::*;
...
`define byte_ctrl_pinX_params(X)                                                           \
   ...
   generate 
      if (IS_USED[ID]) begin : gen_used_byte_ctrl
         ...
         localparam int MDELAY = (RX_SAMPLER_MODE[ID] == "RX_SAMPLER_MODE_UNMATCHED_HIGH_COMMON_MODE") ? (1000000 / (VCO_FREQ[ID]/1000000)) : 
