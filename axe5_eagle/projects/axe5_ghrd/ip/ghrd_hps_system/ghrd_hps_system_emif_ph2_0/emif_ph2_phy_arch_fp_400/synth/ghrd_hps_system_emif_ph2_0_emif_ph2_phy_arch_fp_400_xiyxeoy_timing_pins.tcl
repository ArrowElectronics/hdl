...
source "$script_dir/ghrd_hps_system_emif_ph2_0_emif_ph2_phy_arch_fp_400_xiyxeoy_timing_utils.tcl"
...
proc emif_get_ddr_pins { instname allpins var_array_name} {
   ...
   set pins(i_phyclk_div_reg) [add_to_collection $pins(i_phyclk_div_reg) [get_registers ${emif_instname}|calip_${arch_idx}*div_reg]]
...
#
    ...
    set pins(dqs_t_in) [get_nodes *bufs_mem*DQS*ibuf|i]
    set pins(rclk) [list]
