module ghrd_hps_system_emif_ph2_0 (
		...
		input  wire         s0_axil_clk,     //     s0_axil_clk.clk
		input  wire         s0_axil_rst_n,   //   s0_axil_rst_n.reset_n
		input  wire [26:0]  s0_axil_awaddr,  //         s0_axil.awaddr
		input  wire         s0_axil_awvalid, //                .awvalid
		output wire         s0_axil_awready, //                .awready
		input  wire [31:0]  s0_axil_wdata,   //                .wdata
		input  wire [3:0]   s0_axil_wstrb,   //                .wstrb
		input  wire         s0_axil_wvalid,  //                .wvalid
		output wire         s0_axil_wready,  //                .wready
		output wire [1:0]   s0_axil_bresp,   //                .bresp
		output wire         s0_axil_bvalid,  //                .bvalid
		input  wire         s0_axil_bready,  //                .bready
		input  wire [26:0]  s0_axil_araddr,  //                .araddr
		input  wire         s0_axil_arvalid, //                .arvalid
		output wire         s0_axil_arready, //                .arready
		output wire [31:0]  s0_axil_rdata,   //                .rdata
		output wire [1:0]   s0_axil_rresp,   //                .rresp
		output wire         s0_axil_rvalid,  //                .rvalid
		input  wire         s0_axil_rready,  //                .rready
		input  wire [2:0]   s0_axil_awprot,  //                .awprot
		input  wire [2:0]   s0_axil_arprot   //                .arprot
	);
endmodule
