...
source "$script_dir/ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_timing_parameters.tcl"
source "$script_dir/ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_timing_pins.tcl"
...
if { ! [ info exists ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_sdc_cache ] } {
   emif_initialize_ddr_db ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_emif_ddr_db var
   set ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_sdc_cache 1
} else {
   if { $debug } {
...
set instances [ array names ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_emif_ddr_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $ghrd_hps_system_emif_hps_ph2_0_emif_ph2_phy_arch_fp_600_zeq3obi_emif_ddr_db($inst)
