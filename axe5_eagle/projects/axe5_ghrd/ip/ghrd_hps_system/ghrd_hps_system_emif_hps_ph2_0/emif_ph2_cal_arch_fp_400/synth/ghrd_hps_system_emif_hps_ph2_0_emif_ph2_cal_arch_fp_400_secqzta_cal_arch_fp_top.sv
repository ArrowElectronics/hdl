...
module ghrd_hps_system_emif_hps_ph2_0_emif_ph2_cal_arch_fp_400_secqzta_cal_arch_fp_top #(
...
//// User Interface directy from Fabric (M)
   ...
   ghrd_hps_system_emif_hps_ph2_0_emif_ph2_cal_arch_fp_400_secqzta_stdfn_inst_iossm #(
   ) u_iossm (
   ...
   ghrd_hps_system_emif_hps_ph2_0_emif_ph2_cal_arch_fp_400_secqzta_stdfn_inst_seq #(
   ) u_seq (
