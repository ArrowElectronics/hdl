...
module emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_byte_ctrl #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_byte_ctrl::*;
