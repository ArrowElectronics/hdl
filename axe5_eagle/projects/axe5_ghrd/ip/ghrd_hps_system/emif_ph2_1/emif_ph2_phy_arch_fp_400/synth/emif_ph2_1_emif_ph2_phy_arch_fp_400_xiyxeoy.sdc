...
source "$script_dir/emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_timing_parameters.tcl"
source "$script_dir/emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_timing_pins.tcl"
...
if { ! [ info exists emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_sdc_cache ] } {
   emif_initialize_ddr_db emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_emif_ddr_db var
   set emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_sdc_cache 1
} else {
   if { $debug } {
...
set instances [ array names emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_emif_ddr_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_emif_ddr_db($inst)
