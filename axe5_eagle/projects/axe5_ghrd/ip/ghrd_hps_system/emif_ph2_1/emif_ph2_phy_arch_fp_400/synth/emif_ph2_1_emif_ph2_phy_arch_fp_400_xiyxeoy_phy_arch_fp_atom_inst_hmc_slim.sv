...
module emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_phy_arch_fp_atom_inst_hmc_slim #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import emif_ph2_1_emif_ph2_phy_arch_fp_400_xiyxeoy_atom_attr_hmc_slim::*;
