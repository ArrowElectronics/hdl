...
module gmii2rgmii (
	...
	gmii2rgmii_intel_gmii_to_rgmii_converter_101_lvjsziq #(
		.TX_PIPELINE_DEPTH (1),
		.RX_PIPELINE_DEPTH (1)
		...
		.pll_50m_clock_clk      (pll_50m_clock_clk),      //   input,  width = 1,  pll_50m_clock.clk
		.pll_5m_clock_clk       (pll_5m_clock_clk),       //   input,  width = 1,   pll_5m_clock.clk
