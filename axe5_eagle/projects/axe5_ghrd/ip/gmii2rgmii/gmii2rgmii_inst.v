	gmii2rgmii u0 (
		...
		.pll_50m_clock_clk      (_connected_to_pll_50m_clock_clk_),      //   input,  width = 1,  pll_50m_clock.clk
		.pll_5m_clock_clk       (_connected_to_pll_5m_clock_clk_),       //   input,  width = 1,   pll_5m_clock.clk
