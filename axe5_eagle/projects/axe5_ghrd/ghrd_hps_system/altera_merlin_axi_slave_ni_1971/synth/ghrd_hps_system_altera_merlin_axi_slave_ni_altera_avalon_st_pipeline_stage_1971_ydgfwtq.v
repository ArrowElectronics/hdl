// ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ydgfwtq.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ydgfwtq #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 80,
	...
	ghrd_hps_system_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),   //   input,  width = 80,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 80,          .data
