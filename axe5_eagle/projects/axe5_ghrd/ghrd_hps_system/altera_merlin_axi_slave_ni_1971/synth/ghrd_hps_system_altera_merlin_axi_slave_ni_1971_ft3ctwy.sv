...
module ghrd_hps_system_altera_merlin_axi_slave_ni_1971_ft3ctwy
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_nwmkusa #(
        .SYMBOLS_PER_BEAT    (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_cu2dhmy #(
             .SYMBOLS_PER_BEAT (1),
