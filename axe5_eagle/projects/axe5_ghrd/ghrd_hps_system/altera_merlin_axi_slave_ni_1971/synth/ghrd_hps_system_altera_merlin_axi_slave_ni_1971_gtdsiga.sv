...
module ghrd_hps_system_altera_merlin_axi_slave_ni_1971_gtdsiga
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_a6uphgq #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ydgfwtq #(
      .SYMBOLS_PER_BEAT (1),
    ...
    ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_qk7powi #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       ghrd_hps_system_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_7pmt33q #(
             .SYMBOLS_PER_BEAT (1),
