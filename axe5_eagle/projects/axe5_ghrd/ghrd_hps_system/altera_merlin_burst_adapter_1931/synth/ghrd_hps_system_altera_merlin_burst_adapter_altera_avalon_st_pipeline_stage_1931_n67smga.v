// ghrd_hps_system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_n67smga.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_n67smga #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 148,
	...
	ghrd_hps_system_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 148,          .data
		...
		.out_data          (out_data),          //  output,  width = 148,          .data
