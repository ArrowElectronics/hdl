// ghrd_hps_system_altera_mm_interconnect_1920_ei2j4cq.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_ei2j4cq (
		...
		input  wire        crosser_002_in_clk_reset_reset_bridge_in_reset_reset,                   //                   crosser_002_in_clk_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                                          // rsp_mux:src_valid -> agilex_5_soc_hps2fpga_agent:write_rp_valid
	wire  [132:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> agilex_5_soc_hps2fpga_agent:write_rp_data
	wire          rsp_mux_src_ready;                                                          // agilex_5_soc_hps2fpga_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> agilex_5_soc_hps2fpga_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                                                  // rsp_mux:src_startofpacket -> agilex_5_soc_hps2fpga_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                    // rsp_mux:src_endofpacket -> agilex_5_soc_hps2fpga_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                                                      // rsp_mux_001:src_valid -> agilex_5_soc_hps2fpga_agent:read_rp_valid
	wire  [132:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> agilex_5_soc_hps2fpga_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                                      // agilex_5_soc_hps2fpga_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> agilex_5_soc_hps2fpga_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                                              // rsp_mux_001:src_startofpacket -> agilex_5_soc_hps2fpga_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                // rsp_mux_001:src_endofpacket -> agilex_5_soc_hps2fpga_agent:read_rp_endofpacket
	...
	wire  [133:0] peripheral_sys_0_mm_peripheral_bridge_s0_agent_rf_source_data;              // peripheral_sys_0_mm_peripheral_bridge_s0_agent:rf_source_data -> peripheral_sys_0_mm_peripheral_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [133:0] peripheral_sys_0_mm_peripheral_bridge_s0_agent_rsp_fifo_out_data;           // peripheral_sys_0_mm_peripheral_bridge_s0_agent_rsp_fifo:out_data -> peripheral_sys_0_mm_peripheral_bridge_s0_agent:rf_sink_data
	...
	wire  [132:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> peripheral_sys_0_mm_peripheral_bridge_s0_agent:cp_data
	...
	wire          agilex_5_soc_hps2fpga_agent_write_cp_valid;                                 // agilex_5_soc_hps2fpga_agent:write_cp_valid -> router:sink_valid
	wire  [132:0] agilex_5_soc_hps2fpga_agent_write_cp_data;                                  // agilex_5_soc_hps2fpga_agent:write_cp_data -> router:sink_data
	wire          agilex_5_soc_hps2fpga_agent_write_cp_ready;                                 // router:sink_ready -> agilex_5_soc_hps2fpga_agent:write_cp_ready
	wire          agilex_5_soc_hps2fpga_agent_write_cp_startofpacket;                         // agilex_5_soc_hps2fpga_agent:write_cp_startofpacket -> router:sink_startofpacket
	wire          agilex_5_soc_hps2fpga_agent_write_cp_endofpacket;                           // agilex_5_soc_hps2fpga_agent:write_cp_endofpacket -> router:sink_endofpacket
	...
	wire          agilex_5_soc_hps2fpga_agent_read_cp_valid;                                  // agilex_5_soc_hps2fpga_agent:read_cp_valid -> router_001:sink_valid
	wire  [132:0] agilex_5_soc_hps2fpga_agent_read_cp_data;                                   // agilex_5_soc_hps2fpga_agent:read_cp_data -> router_001:sink_data
	wire          agilex_5_soc_hps2fpga_agent_read_cp_ready;                                  // router_001:sink_ready -> agilex_5_soc_hps2fpga_agent:read_cp_ready
	wire          agilex_5_soc_hps2fpga_agent_read_cp_startofpacket;                          // agilex_5_soc_hps2fpga_agent:read_cp_startofpacket -> router_001:sink_startofpacket
	wire          agilex_5_soc_hps2fpga_agent_read_cp_endofpacket;                            // agilex_5_soc_hps2fpga_agent:read_cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [132:0] fpga_only_master_master_agent_cp_data;                                      // fpga_only_master_master_agent:cp_data -> router_002:sink_data
	...
	wire          onchip_sram_axi_s1_agent_write_rp_valid;                                    // onchip_sram_axi_s1_agent:write_rp_valid -> router_003:sink_valid
	wire  [168:0] onchip_sram_axi_s1_agent_write_rp_data;                                     // onchip_sram_axi_s1_agent:write_rp_data -> router_003:sink_data
	wire          onchip_sram_axi_s1_agent_write_rp_ready;                                    // router_003:sink_ready -> onchip_sram_axi_s1_agent:write_rp_ready
	wire          onchip_sram_axi_s1_agent_write_rp_startofpacket;                            // onchip_sram_axi_s1_agent:write_rp_startofpacket -> router_003:sink_startofpacket
	wire          onchip_sram_axi_s1_agent_write_rp_endofpacket;                              // onchip_sram_axi_s1_agent:write_rp_endofpacket -> router_003:sink_endofpacket
	wire          onchip_sram_axi_s1_agent_read_rp_valid;                                     // onchip_sram_axi_s1_agent:read_rp_valid -> router_004:sink_valid
	wire  [168:0] onchip_sram_axi_s1_agent_read_rp_data;                                      // onchip_sram_axi_s1_agent:read_rp_data -> router_004:sink_data
	wire          onchip_sram_axi_s1_agent_read_rp_ready;                                     // router_004:sink_ready -> onchip_sram_axi_s1_agent:read_rp_ready
	wire          onchip_sram_axi_s1_agent_read_rp_startofpacket;                             // onchip_sram_axi_s1_agent:read_rp_startofpacket -> router_004:sink_startofpacket
	wire          onchip_sram_axi_s1_agent_read_rp_endofpacket;                               // onchip_sram_axi_s1_agent:read_rp_endofpacket -> router_004:sink_endofpacket
	wire          peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_valid;                    // peripheral_sys_0_mm_peripheral_bridge_s0_agent:rp_valid -> router_005:sink_valid
	wire  [132:0] peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_data;                     // peripheral_sys_0_mm_peripheral_bridge_s0_agent:rp_data -> router_005:sink_data
	wire          peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_ready;                    // router_005:sink_ready -> peripheral_sys_0_mm_peripheral_bridge_s0_agent:rp_ready
	wire          peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_startofpacket;            // peripheral_sys_0_mm_peripheral_bridge_s0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_endofpacket;              // peripheral_sys_0_mm_peripheral_bridge_s0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [132:0] router_002_src_data;                                                        // router_002:src_data -> fpga_only_master_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                       // fpga_only_master_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                                     // router_002:src_channel -> fpga_only_master_master_limiter:cmd_sink_channel
	...
	wire  [132:0] fpga_only_master_master_limiter_cmd_src_data;                               // fpga_only_master_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	...
	wire    [2:0] fpga_only_master_master_limiter_cmd_src_channel;                            // fpga_only_master_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [132:0] rsp_mux_002_src_data;                                                       // rsp_mux_002:src_data -> fpga_only_master_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                      // fpga_only_master_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                                    // rsp_mux_002:src_channel -> fpga_only_master_master_limiter:rsp_sink_channel
	...
	wire  [132:0] fpga_only_master_master_limiter_rsp_src_data;                               // fpga_only_master_master_limiter:rsp_src_data -> fpga_only_master_master_agent:rp_data
	...
	wire    [2:0] cmd_demux_002_src2_channel;                                                 // cmd_demux_002:src2_channel -> cmd_mux_002:sink0_channel
	...
	wire    [2:0] rsp_demux_002_src0_channel;                                                 // rsp_demux_002:src0_channel -> rsp_mux_002:sink2_channel
	...
	wire  [132:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> onchip_sram_axi_s1_wr_cmd_width_adapter:in_data
	...
	wire  [168:0] onchip_sram_axi_s1_wr_cmd_width_adapter_src_data;                           // onchip_sram_axi_s1_wr_cmd_width_adapter:out_data -> onchip_sram_axi_s1_agent:write_cp_data
	...
	wire  [132:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> onchip_sram_axi_s1_rd_cmd_width_adapter:in_data
	...
	wire  [168:0] onchip_sram_axi_s1_rd_cmd_width_adapter_src_data;                           // onchip_sram_axi_s1_rd_cmd_width_adapter:out_data -> onchip_sram_axi_s1_agent:read_cp_data
	...
	wire          router_003_src_valid;                                                       // router_003:src_valid -> onchip_sram_axi_s1_wr_rsp_width_adapter:in_valid
	wire  [168:0] router_003_src_data;                                                        // router_003:src_data -> onchip_sram_axi_s1_wr_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                       // onchip_sram_axi_s1_wr_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                                     // router_003:src_channel -> onchip_sram_axi_s1_wr_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                               // router_003:src_startofpacket -> onchip_sram_axi_s1_wr_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                                 // router_003:src_endofpacket -> onchip_sram_axi_s1_wr_rsp_width_adapter:in_endofpacket
	...
	wire  [132:0] onchip_sram_axi_s1_wr_rsp_width_adapter_src_data;                           // onchip_sram_axi_s1_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire          router_004_src_valid;                                                       // router_004:src_valid -> onchip_sram_axi_s1_rd_rsp_width_adapter:in_valid
	wire  [168:0] router_004_src_data;                                                        // router_004:src_data -> onchip_sram_axi_s1_rd_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                       // onchip_sram_axi_s1_rd_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [2:0] router_004_src_channel;                                                     // router_004:src_channel -> onchip_sram_axi_s1_rd_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                               // router_004:src_startofpacket -> onchip_sram_axi_s1_rd_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                                 // router_004:src_endofpacket -> onchip_sram_axi_s1_rd_rsp_width_adapter:in_endofpacket
	...
	wire  [132:0] onchip_sram_axi_s1_rd_rsp_width_adapter_src_data;                           // onchip_sram_axi_s1_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [132:0] cmd_demux_src0_data;                                                        // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [132:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [132:0] cmd_demux_001_src0_data;                                                    // cmd_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [132:0] crosser_001_out_data;                                                       // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [132:0] cmd_demux_002_src0_data;                                                    // cmd_demux_002:src0_data -> crosser_002:in_data
	...
	wire  [132:0] crosser_002_out_data;                                                       // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [132:0] cmd_demux_002_src1_data;                                                    // cmd_demux_002:src1_data -> crosser_003:in_data
	...
	wire  [132:0] crosser_003_out_data;                                                       // crosser_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [132:0] rsp_demux_src0_data;                                                        // rsp_demux:src0_data -> crosser_004:in_data
	...
	wire  [132:0] crosser_004_out_data;                                                       // crosser_004:out_data -> rsp_mux:sink0_data
	...
	wire  [132:0] rsp_demux_src1_data;                                                        // rsp_demux:src1_data -> crosser_005:in_data
	...
	wire  [132:0] crosser_005_out_data;                                                       // crosser_005:out_data -> rsp_mux_002:sink0_data
	...
	wire  [132:0] rsp_demux_001_src0_data;                                                    // rsp_demux_001:src0_data -> crosser_006:in_data
	...
	wire  [132:0] crosser_006_out_data;                                                       // crosser_006:out_data -> rsp_mux_001:sink0_data
	wire          crosser_006_out_ready;                                                      // rsp_mux_001:sink0_ready -> crosser_006:out_ready
	wire    [2:0] crosser_006_out_channel;                                                    // crosser_006:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [132:0] rsp_demux_001_src1_data;                                                    // rsp_demux_001:src1_data -> crosser_007:in_data
	...
	wire  [132:0] crosser_007_out_data;                                                       // crosser_007:out_data -> rsp_mux_002:sink1_data
	...
	wire    [2:0] fpga_only_master_master_limiter_cmd_valid_data;                             // fpga_only_master_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	ghrd_hps_system_altera_merlin_slave_translator_191_x56fcki #(
		...
		.clk                    (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,   width = 1,                      clk.clk
		.reset                  (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
	...
	ghrd_hps_system_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (agilex_5_soc_hps2fpga_agent_write_cp_data),                               //  output,  width = 133,                 .data
		...
		.read_cp_data           (agilex_5_soc_hps2fpga_agent_read_cp_data),                                //  output,  width = 133,                 .data
	...
	ghrd_hps_system_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (fpga_only_master_master_agent_cp_data),                                      //  output,  width = 133,          .data
		...
		.rp_data               (fpga_only_master_master_limiter_rsp_src_data),                               //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_axi_slave_ni_1950_innbb4q #(
		.PKT_QOS_H                   (141),
		.PKT_QOS_L                   (138),
		.PKT_THREAD_ID_H             (147),
		.PKT_THREAD_ID_L             (144),
		...
		.read_cp_data           (onchip_sram_axi_s1_rd_cmd_width_adapter_src_data),                     //   input,  width = 169,                  .data
		...
		.write_cp_data          (onchip_sram_axi_s1_wr_cmd_width_adapter_src_data),                     //   input,  width = 169,                  .data
		...
		.read_rp_data           (onchip_sram_axi_s1_agent_read_rp_data),                                //  output,  width = 169,                  .data
		...
		.write_rp_data          (onchip_sram_axi_s1_agent_write_rp_data),                               //  output,  width = 169,                  .data
	...
	ghrd_hps_system_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_data),                    //  output,  width = 133,                .data
		...
		.cp_data                 (cmd_mux_002_src_data),                                                      //   input,  width = 133,                .data
		...
		.rf_sink_data            (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rsp_fifo_out_data),          //   input,  width = 134,                .data
		...
		.rf_source_data          (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rf_source_data),             //  output,  width = 134,                .data
	...
	ghrd_hps_system_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rf_source_data),             //   input,  width = 134,        in.data
		...
		.out_data          (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rsp_fifo_out_data),          //  output,  width = 134,       out.data
	...
	ghrd_hps_system_altera_merlin_router_1921_rll7eki router (
		...
		.sink_data          (agilex_5_soc_hps2fpga_agent_write_cp_data),                              //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_d7ensma router_001 (
		...
		.sink_data          (agilex_5_soc_hps2fpga_agent_read_cp_data),                               //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_rhhu2rq router_002 (
		...
		.sink_data          (fpga_only_master_master_agent_cp_data),                                //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_w2nyv4a router_003 (
		...
		.sink_data          (onchip_sram_axi_s1_agent_write_rp_data),                              //   input,  width = 169,          .data
		...
		.src_data           (router_003_src_data),                                                 //  output,  width = 169,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_7g6q6pi router_004 (
		...
		.sink_data          (onchip_sram_axi_s1_agent_read_rp_data),                               //   input,  width = 169,          .data
		...
		.src_data           (router_004_src_data),                                                 //  output,  width = 169,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_yquktui router_005 (
		...
		.sink_data          (peripheral_sys_0_mm_peripheral_bridge_s0_agent_rp_data),                 //   input,  width = 133,          .data
		...
		.src_data           (router_005_src_data),                                                    //  output,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_sink_data          (router_002_src_data),                                                  //   input,  width = 133,          .data
		...
		.cmd_src_data           (fpga_only_master_master_limiter_cmd_src_data),                         //  output,  width = 133,          .data
		...
		.rsp_sink_data          (rsp_mux_002_src_data),                                                 //   input,  width = 133,          .data
		...
		.rsp_src_data           (fpga_only_master_master_limiter_rsp_src_data),                         //  output,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_zq6pm7y cmd_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_zq6pm7y cmd_demux_001 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_3ub3axq cmd_demux_002 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                       //   input,    width = 1,        clk.clk
		.reset              (fpga_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (fpga_only_master_master_limiter_cmd_src_data),                         //   input,  width = 133,           .data
		...
		.src0_data          (cmd_demux_002_src0_data),                                              //  output,  width = 133,           .data
		...
		.src1_data          (cmd_demux_002_src1_data),                                              //  output,  width = 133,           .data
		...
		.src2_data          (cmd_demux_002_src2_data),                                              //  output,  width = 133,           .data
		.src2_channel       (cmd_demux_002_src2_channel),                                           //  output,    width = 3,           .channel
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_zybekxy cmd_mux (
		.clk                 (agilex_5_soc_h2f_user0_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset               (onchip_sram_axi_s1_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (crosser_out_data),                                                    //   input,  width = 133,          .data
		...
		.sink1_channel       (crosser_002_out_channel),                                             //   input,    width = 3,          .channel
		.sink1_data          (crosser_002_out_data),                                                //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_zybekxy cmd_mux_001 (
		.clk                 (agilex_5_soc_h2f_user0_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset               (onchip_sram_axi_s1_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (crosser_001_out_data),                                                //   input,  width = 133,          .data
		...
		.sink1_data          (crosser_003_out_data),                                                //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_wbxn6mq cmd_mux_002 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_002_src2_channel),                                             //   input,    width = 3,          .channel
		.sink0_data          (cmd_demux_002_src2_data),                                                //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_o2qhgby rsp_demux (
		.clk                (agilex_5_soc_h2f_user0_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (onchip_sram_axi_s1_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (onchip_sram_axi_s1_wr_rsp_width_adapter_src_data),                    //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_o2qhgby rsp_demux_001 (
		.clk                (agilex_5_soc_h2f_user0_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (onchip_sram_axi_s1_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (onchip_sram_axi_s1_rd_rsp_width_adapter_src_data),                    //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_zq6pm7y rsp_demux_002 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_005_src_ready),                                                   //  output,    width = 1,      sink.ready
		.sink_channel       (router_005_src_channel),                                                 //   input,    width = 3,          .channel
		.sink_data          (router_005_src_data),                                                    //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_z4jfblq rsp_mux (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (crosser_004_out_channel),                                                //   input,    width = 3,          .channel
		.sink0_data          (crosser_004_out_data),                                                   //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_z4jfblq rsp_mux_001 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                         //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_hps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (crosser_006_out_channel),                                                //   input,    width = 3,          .channel
		.sink0_data          (crosser_006_out_data),                                                   //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_3szlfoa rsp_mux_002 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                       //   input,    width = 1,       clk.clk
		.reset               (fpga_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_002_src_ready),                                                //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_002_src_valid),                                                //  output,    width = 1,          .valid
		.src_data            (rsp_mux_002_src_data),                                                 //  output,  width = 133,          .data
		...
		.sink0_channel       (crosser_005_out_channel),                                              //   input,    width = 3,          .channel
		.sink0_data          (crosser_005_out_data),                                                 //   input,  width = 133,          .data
		...
		.sink1_channel       (crosser_007_out_channel),                                              //   input,    width = 3,          .channel
		.sink1_data          (crosser_007_out_data),                                                 //   input,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_pbqrx2q #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.out_data             (onchip_sram_axi_s1_wr_cmd_width_adapter_src_data),                    //  output,  width = 169,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_pbqrx2q #(
		...
		.in_data              (cmd_mux_001_src_data),                                                //   input,  width = 133,          .data
		.out_endofpacket      (onchip_sram_axi_s1_rd_cmd_width_adapter_src_endofpacket),             //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_sram_axi_s1_rd_cmd_width_adapter_src_data),                    //  output,  width = 169,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_fyrgmwi #(
		.IN_PKT_ADDR_H                 (103),
		.IN_PKT_ADDR_L                 (72),
		.IN_PKT_DATA_H                 (63),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_003_src_data),                                                 //   input,  width = 169,          .data
		.out_endofpacket      (onchip_sram_axi_s1_wr_rsp_width_adapter_src_endofpacket),             //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_sram_axi_s1_wr_rsp_width_adapter_src_data),                    //  output,  width = 133,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_fyrgmwi #(
		...
		.in_data              (router_004_src_data),                                                 //   input,  width = 169,          .data
		.out_endofpacket      (onchip_sram_axi_s1_rd_rsp_width_adapter_src_endofpacket),             //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_sram_axi_s1_rd_rsp_width_adapter_src_data),                    //  output,  width = 133,          .data
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		.DATA_WIDTH          (133),
		.BITS_PER_SYMBOL     (133),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.in_reset          (peripheral_sys_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  in_clk_reset.reset
		...
		.out_data          (crosser_out_data),                                   //  output,  width = 133,              .data
		.in_empty          (1'b0),                                               // (terminated),                             
		.in_error          (1'b0),                                               // (terminated),                             
		.out_empty         (),                                                   // (terminated),                             
		.out_error         ()                                                    // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.out_data          (crosser_001_out_data),                               //  output,  width = 133,              .data
		.in_empty          (1'b0),                                               // (terminated),                             
		.in_error          (1'b0),                                               // (terminated),                             
		.out_empty         (),                                                   // (terminated),                             
		.out_error         ()                                                    // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.in_data           (cmd_demux_002_src0_data),                              //   input,  width = 133,              .data
		...
		.out_data          (crosser_002_out_data),                                 //  output,  width = 133,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.in_data           (cmd_demux_002_src1_data),                              //   input,  width = 133,              .data
		...
		.out_data          (crosser_003_out_data),                                 //  output,  width = 133,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.out_reset         (peripheral_sys_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset
		...
		.out_channel       (crosser_004_out_channel),                            //  output,    width = 3,              .channel
		.out_data          (crosser_004_out_data),                               //  output,  width = 133,              .data
		.in_empty          (1'b0),                                               // (terminated),                             
		.in_error          (1'b0),                                               // (terminated),                             
		.out_empty         (),                                                   // (terminated),                             
		.out_error         ()                                                    // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.out_channel       (crosser_005_out_channel),                              //  output,    width = 3,              .channel
		.out_data          (crosser_005_out_data),                                 //  output,  width = 133,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.in_data           (rsp_demux_001_src0_data),                            //   input,  width = 133,              .data
		...
		.out_channel       (crosser_006_out_channel),                            //  output,    width = 3,              .channel
		.out_data          (crosser_006_out_data),                               //  output,  width = 133,              .data
		.in_empty          (1'b0),                                               // (terminated),                             
		.in_error          (1'b0),                                               // (terminated),                             
		.out_empty         (),                                                   // (terminated),                             
		.out_error         ()                                                    // (terminated),                             
	...
	ghrd_hps_system_hs_clk_xer_1940_mmunkgi #(
		...
		.in_data           (rsp_demux_001_src1_data),                              //   input,  width = 133,              .data
		...
		.out_channel       (crosser_007_out_channel),                              //  output,    width = 3,              .channel
		.out_data          (crosser_007_out_data),                                 //  output,  width = 133,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
