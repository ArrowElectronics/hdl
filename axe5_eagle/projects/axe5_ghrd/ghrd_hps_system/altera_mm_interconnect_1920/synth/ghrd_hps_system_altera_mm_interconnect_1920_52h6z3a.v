// ghrd_hps_system_altera_mm_interconnect_1920_52h6z3a.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_52h6z3a (
	...
	wire  [179:0] rsp_mux_src_data;                                                              // rsp_mux:src_data -> video_sys_0_hdmi_dmac_master_agent:write_rp_data
	...
	wire  [179:0] rsp_mux_001_src_data;                                                          // rsp_mux_001:src_data -> video_sys_0_hdmi_dmac_master_agent:read_rp_data
	...
	wire  [179:0] cmd_mux_src_data;                                                              // cmd_mux:src_data -> agilex_5_soc_f2sdram_agent:write_cp_data
	...
	wire  [179:0] cmd_mux_001_src_data;                                                          // cmd_mux_001:src_data -> agilex_5_soc_f2sdram_agent:read_cp_data
	...
	wire  [179:0] video_sys_0_hdmi_dmac_master_agent_write_cp_data;                              // video_sys_0_hdmi_dmac_master_agent:write_cp_data -> router:sink_data
	...
	wire  [179:0] router_src_data;                                                               // router:src_data -> cmd_demux:sink_data
	...
	wire  [179:0] video_sys_0_hdmi_dmac_master_agent_read_cp_data;                               // video_sys_0_hdmi_dmac_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [179:0] router_001_src_data;                                                           // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [143:0] f2sdram_only_master_master_agent_cp_data;                                      // f2sdram_only_master_master_agent:cp_data -> router_002:sink_data
	...
	wire  [179:0] agilex_5_soc_f2sdram_agent_write_rp_data;                                      // agilex_5_soc_f2sdram_agent:write_rp_data -> router_003:sink_data
	...
	wire  [179:0] router_003_src_data;                                                           // router_003:src_data -> rsp_demux:sink_data
	...
	wire  [179:0] agilex_5_soc_f2sdram_agent_read_rp_data;                                       // agilex_5_soc_f2sdram_agent:read_rp_data -> router_004:sink_data
	...
	wire  [179:0] router_004_src_data;                                                           // router_004:src_data -> rsp_demux_001:sink_data
	...
	wire  [143:0] router_002_src_data;                                                           // router_002:src_data -> f2sdram_only_master_master_limiter:cmd_sink_data
	...
	wire  [143:0] f2sdram_only_master_master_limiter_rsp_src_data;                               // f2sdram_only_master_master_limiter:rsp_src_data -> f2sdram_only_master_master_agent:rp_data
	...
	wire  [179:0] cmd_demux_src0_data;                                                           // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [179:0] cmd_demux_001_src0_data;                                                       // cmd_demux_001:src0_data -> cmd_mux_001:sink0_data
	...
	wire  [179:0] cmd_demux_002_src0_data;                                                       // cmd_demux_002:src0_data -> cmd_mux:sink1_data
	...
	wire  [179:0] cmd_demux_002_src1_data;                                                       // cmd_demux_002:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [179:0] rsp_demux_src0_data;                                                           // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [179:0] rsp_demux_src1_data;                                                           // rsp_demux:src1_data -> rsp_mux_002:sink0_data
	...
	wire  [179:0] rsp_demux_001_src0_data;                                                       // rsp_demux_001:src0_data -> rsp_mux_001:sink0_data
	...
	wire  [179:0] rsp_demux_001_src1_data;                                                       // rsp_demux_001:src1_data -> rsp_mux_002:sink1_data
	...
	wire  [143:0] f2sdram_only_master_master_limiter_cmd_src_data;                               // f2sdram_only_master_master_limiter:cmd_src_data -> f2sdram_only_master_master_cmd_width_adapter:in_data
	...
	wire  [179:0] f2sdram_only_master_master_cmd_width_adapter_src_data;                         // f2sdram_only_master_master_cmd_width_adapter:out_data -> cmd_demux_002:sink_data
	...
	wire  [179:0] rsp_mux_002_src_data;                                                          // rsp_mux_002:src_data -> f2sdram_only_master_master_rsp_width_adapter:in_data
	...
	wire  [143:0] f2sdram_only_master_master_rsp_width_adapter_src_data;                         // f2sdram_only_master_master_rsp_width_adapter:out_data -> f2sdram_only_master_master_limiter:rsp_sink_data
	...
	ghrd_hps_system_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (video_sys_0_hdmi_dmac_master_agent_write_cp_data),                         //  output,  width = 180,                 .data
		...
		.write_rp_data          (rsp_mux_src_data),                                                         //   input,  width = 180,                 .data
		...
		.read_cp_data           (video_sys_0_hdmi_dmac_master_agent_read_cp_data),                          //  output,  width = 180,                 .data
		...
		.read_rp_data           (rsp_mux_001_src_data),                                                     //   input,  width = 180,                 .data
	...
	ghrd_hps_system_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (f2sdram_only_master_master_agent_cp_data),                                      //  output,  width = 144,          .data
		...
		.rp_data               (f2sdram_only_master_master_limiter_rsp_src_data),                               //   input,  width = 144,          .data
	...
	ghrd_hps_system_altera_merlin_axi_slave_ni_1950_7zoaisq #(
		.PKT_QOS_H                   (155),
		.PKT_QOS_L                   (152),
		.PKT_THREAD_ID_H             (158),
		.PKT_THREAD_ID_L             (158),
		...
		.read_cp_data           (cmd_mux_001_src_data),                                                     //   input,  width = 180,                  .data
		...
		.write_cp_data          (cmd_mux_src_data),                                                         //   input,  width = 180,                  .data
		...
		.read_rp_data           (agilex_5_soc_f2sdram_agent_read_rp_data),                                  //  output,  width = 180,                  .data
		...
		.write_rp_data          (agilex_5_soc_f2sdram_agent_write_rp_data),                                 //  output,  width = 180,                  .data
	...
	ghrd_hps_system_altera_merlin_router_1921_xvuxruy router (
		...
		.sink_data          (video_sys_0_hdmi_dmac_master_agent_write_cp_data),                        //   input,  width = 180,          .data
		...
		.src_data           (router_src_data),                                                         //  output,  width = 180,          .data
		.src_channel        (router_src_channel),                                                      //  output,    width = 3,          .channel
		.src_startofpacket  (router_src_startofpacket),                                                //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_src_endofpacket)                                                   //  output,    width = 1,          .endofpacket
	);

	ghrd_hps_system_altera_merlin_router_1921_cijrtpi router_001 (
		...
		.sink_data          (video_sys_0_hdmi_dmac_master_agent_read_cp_data),                         //   input,  width = 180,          .data
		...
		.src_data           (router_001_src_data),                                                     //  output,  width = 180,          .data
		.src_channel        (router_001_src_channel),                                                  //  output,    width = 3,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                                            //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                               //  output,    width = 1,          .endofpacket
	);

	ghrd_hps_system_altera_merlin_router_1921_mcflmxq router_002 (
		...
		.sink_data          (f2sdram_only_master_master_agent_cp_data),                                //   input,  width = 144,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_rzqs6cy router_003 (
		...
		.sink_data          (agilex_5_soc_f2sdram_agent_write_rp_data),                                //   input,  width = 180,          .data
		...
		.src_data           (router_003_src_data),                                                     //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_mldvohy router_004 (
		...
		.sink_data          (agilex_5_soc_f2sdram_agent_read_rp_data),                                 //   input,  width = 180,          .data
		...
		.src_data           (router_004_src_data),                                                     //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (f2sdram_only_master_master_limiter_cmd_src_data),                         //  output,  width = 144,          .data
		...
		.rsp_sink_data          (f2sdram_only_master_master_rsp_width_adapter_src_data),                   //   input,  width = 144,          .data
		...
		.rsp_src_data           (f2sdram_only_master_master_limiter_rsp_src_data),                         //  output,  width = 144,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_3fcoa2q cmd_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_src_ready),                                                        //  output,    width = 1,      sink.ready
		.sink_channel       (router_src_channel),                                                      //   input,    width = 3,          .channel
		.sink_data          (router_src_data),                                                         //   input,  width = 180,          .data
		...
		.src0_data          (cmd_demux_src0_data),                                                     //  output,  width = 180,          .data
		.src0_channel       (cmd_demux_src0_channel),                                                  //  output,    width = 3,          .channel
		.src0_startofpacket (cmd_demux_src0_startofpacket),                                            //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (cmd_demux_src0_endofpacket)                                               //  output,    width = 1,          .endofpacket
	);

	ghrd_hps_system_altera_merlin_demultiplexer_1921_3fcoa2q cmd_demux_001 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                                                    //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                                                  //   input,    width = 3,          .channel
		.sink_data          (router_001_src_data),                                                     //   input,  width = 180,          .data
		...
		.src0_data          (cmd_demux_001_src0_data),                                                 //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_xojkd3q cmd_demux_002 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (f2sdram_only_master_master_cmd_width_adapter_src_data),                   //   input,  width = 180,          .data
		...
		.src0_data          (cmd_demux_002_src0_data),                                                 //  output,  width = 180,          .data
		...
		.src1_data          (cmd_demux_002_src1_data),                                                 //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_6fngomq cmd_mux (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                                                       //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                                                       //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                                                        //  output,  width = 180,          .data
		...
		.sink0_data          (cmd_demux_src0_data),                                                     //   input,  width = 180,          .data
		...
		.sink1_data          (cmd_demux_002_src0_data),                                                 //   input,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_6fngomq cmd_mux_001 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                                                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                                                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                                                    //  output,  width = 180,          .data
		...
		.sink0_data          (cmd_demux_001_src0_data),                                                 //   input,  width = 180,          .data
		...
		.sink1_data          (cmd_demux_002_src1_data),                                                 //   input,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_xojkd3q rsp_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_003_src_ready),                                                    //  output,    width = 1,      sink.ready
		.sink_channel       (router_003_src_channel),                                                  //   input,    width = 3,          .channel
		.sink_data          (router_003_src_data),                                                     //   input,  width = 180,          .data
		...
		.src0_data          (rsp_demux_src0_data),                                                     //  output,  width = 180,          .data
		...
		.src1_data          (rsp_demux_src1_data),                                                     //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_xojkd3q rsp_demux_001 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_004_src_ready),                                                    //  output,    width = 1,      sink.ready
		.sink_channel       (router_004_src_channel),                                                  //   input,    width = 3,          .channel
		.sink_data          (router_004_src_data),                                                     //   input,  width = 180,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                                 //  output,  width = 180,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                                 //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_n6lxdgy rsp_mux (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                                       //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                                       //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                                        //  output,  width = 180,          .data
		...
		.sink0_data          (rsp_demux_src0_data),                                                     //   input,  width = 180,          .data
		.sink0_startofpacket (rsp_demux_src0_startofpacket),                                            //   input,    width = 1,          .startofpacket
		.sink0_endofpacket   (rsp_demux_src0_endofpacket)                                               //   input,    width = 1,          .endofpacket
	);

	ghrd_hps_system_altera_merlin_multiplexer_1921_n6lxdgy rsp_mux_001 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_001_src_ready),                                                   //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_001_src_valid),                                                   //  output,    width = 1,          .valid
		.src_data            (rsp_mux_001_src_data),                                                    //  output,  width = 180,          .data
		...
		.sink0_data          (rsp_demux_001_src0_data),                                                 //   input,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_multiplexer_1921_bvxfr4q rsp_mux_002 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_002_src_ready),                                                   //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_002_src_valid),                                                   //  output,    width = 1,          .valid
		.src_data            (rsp_mux_002_src_data),                                                    //  output,  width = 180,          .data
		...
		.sink0_data          (rsp_demux_src1_data),                                                     //   input,  width = 180,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                                                 //   input,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_riwobpq #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (f2sdram_only_master_master_limiter_cmd_src_data),                         //   input,  width = 144,          .data
		.out_endofpacket      (f2sdram_only_master_master_cmd_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (f2sdram_only_master_master_cmd_width_adapter_src_data),                   //  output,  width = 180,          .data
	...
	ghrd_hps_system_altera_merlin_width_adapter_1920_7l6r2hy #(
		.IN_PKT_ADDR_H                 (103),
		.IN_PKT_ADDR_L                 (72),
		.IN_PKT_DATA_H                 (63),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (rsp_mux_002_src_data),                                                    //   input,  width = 180,          .data
		.out_endofpacket      (f2sdram_only_master_master_rsp_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (f2sdram_only_master_master_rsp_width_adapter_src_data),                   //  output,  width = 144,          .data
