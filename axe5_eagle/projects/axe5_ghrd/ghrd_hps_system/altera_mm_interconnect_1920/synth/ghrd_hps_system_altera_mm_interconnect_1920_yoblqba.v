// ghrd_hps_system_altera_mm_interconnect_1920_yoblqba.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_yoblqba (
	...
	wire  [209:0] hps_only_master_master_agent_cp_data;                                      // hps_only_master_master_agent:cp_data -> router:sink_data
	...
	wire  [209:0] router_src_data;                                                           // router:src_data -> hps_only_master_master_limiter:cmd_sink_data
	...
	wire  [209:0] hps_only_master_master_limiter_cmd_src_data;                               // hps_only_master_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [209:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> hps_only_master_master_limiter:rsp_sink_data
	...
	wire  [209:0] hps_only_master_master_limiter_rsp_src_data;                               // hps_only_master_master_limiter:rsp_src_data -> hps_only_master_master_agent:rp_data
	...
	ghrd_hps_system_altera_merlin_master_translator_192_lykd4la #(
		...
		.reset                  (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset),       //   input,   width = 1,                     reset.reset
		.uav_address            (hps_only_master_master_translator_avalon_universal_master_0_address),       //  output,  width = 32, avalon_universal_master_0.address
		.uav_burstcount         (hps_only_master_master_translator_avalon_universal_master_0_burstcount),    //  output,   width = 3,                          .burstcount
		.uav_read               (hps_only_master_master_translator_avalon_universal_master_0_read),          //  output,   width = 1,                          .read
		.uav_write              (hps_only_master_master_translator_avalon_universal_master_0_write),         //  output,   width = 1,                          .write
		.uav_waitrequest        (hps_only_master_master_translator_avalon_universal_master_0_waitrequest),   //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (hps_only_master_master_translator_avalon_universal_master_0_readdatavalid), //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (hps_only_master_master_translator_avalon_universal_master_0_byteenable),    //  output,   width = 4,                          .byteenable
		.uav_readdata           (hps_only_master_master_translator_avalon_universal_master_0_readdata),      //   input,  width = 32,                          .readdata
		.uav_writedata          (hps_only_master_master_translator_avalon_universal_master_0_writedata),     //  output,  width = 32,                          .writedata
		.uav_lock               (hps_only_master_master_translator_avalon_universal_master_0_lock),          //  output,   width = 1,                          .lock
		.uav_debugaccess        (hps_only_master_master_translator_avalon_universal_master_0_debugaccess),   //  output,   width = 1,                          .debugaccess
		.av_address             (hps_only_master_master_address),                                            //   input,  width = 32,      avalon_anti_master_0.address
		.av_waitrequest         (hps_only_master_master_waitrequest),                                        //  output,   width = 1,                          .waitrequest
		.av_byteenable          (hps_only_master_master_byteenable),                                         //   input,   width = 4,                          .byteenable
		.av_read                (hps_only_master_master_read),                                               //   input,   width = 1,                          .read
		.av_readdata            (hps_only_master_master_readdata),                                           //  output,  width = 32,                          .readdata
		.av_readdatavalid       (hps_only_master_master_readdatavalid),                                      //  output,   width = 1,                          .readdatavalid
		.av_write               (hps_only_master_master_write),                                              //   input,   width = 1,                          .write
		.av_writedata           (hps_only_master_master_writedata),                                          //   input,  width = 32,                          .writedata
	...
	ghrd_hps_system_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.clk                   (agilex_5_soc_h2f_user1_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset                 (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		.av_address            (hps_only_master_master_translator_avalon_universal_master_0_address),       //   input,   width = 32,        av.address
		.av_write              (hps_only_master_master_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (hps_only_master_master_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (hps_only_master_master_translator_avalon_universal_master_0_writedata),     //   input,   width = 32,          .writedata
		.av_readdata           (hps_only_master_master_translator_avalon_universal_master_0_readdata),      //  output,   width = 32,          .readdata
		.av_waitrequest        (hps_only_master_master_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (hps_only_master_master_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (hps_only_master_master_translator_avalon_universal_master_0_byteenable),    //   input,    width = 4,          .byteenable
		.av_burstcount         (hps_only_master_master_translator_avalon_universal_master_0_burstcount),    //   input,    width = 3,          .burstcount
		.av_debugaccess        (hps_only_master_master_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (hps_only_master_master_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (hps_only_master_master_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (hps_only_master_master_agent_cp_data),                                      //  output,  width = 210,          .data
		.cp_startofpacket      (hps_only_master_master_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (hps_only_master_master_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (hps_only_master_master_agent_cp_ready),                                     //   input,    width = 1,          .ready
		.rp_valid              (hps_only_master_master_limiter_rsp_src_valid),                              //   input,    width = 1,        rp.valid
		.rp_data               (hps_only_master_master_limiter_rsp_src_data),                               //   input,  width = 210,          .data
		.rp_channel            (hps_only_master_master_limiter_rsp_src_channel),                            //   input,    width = 2,          .channel
		.rp_startofpacket      (hps_only_master_master_limiter_rsp_src_startofpacket),                      //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (hps_only_master_master_limiter_rsp_src_endofpacket),                        //   input,    width = 1,          .endofpacket
		.rp_ready              (hps_only_master_master_limiter_rsp_src_ready),                              //  output,    width = 1,          .ready
		.av_response           (),                                                                          // (terminated),                         
		.av_writeresponsevalid ()                                                                           // (terminated),                         
	);
	...
	ghrd_hps_system_altera_merlin_router_1921_i5d5uoq router (
		.sink_ready         (hps_only_master_master_agent_cp_ready),                               //  output,    width = 1,      sink.ready
		.sink_valid         (hps_only_master_master_agent_cp_valid),                               //   input,    width = 1,          .valid
		.sink_data          (hps_only_master_master_agent_cp_data),                                //   input,  width = 210,          .data
		.sink_startofpacket (hps_only_master_master_agent_cp_startofpacket),                       //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (hps_only_master_master_agent_cp_endofpacket),                         //   input,    width = 1,          .endofpacket
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_ready          (hps_only_master_master_limiter_cmd_src_ready),                        //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (hps_only_master_master_limiter_cmd_src_data),                         //  output,  width = 210,          .data
		.cmd_src_channel        (hps_only_master_master_limiter_cmd_src_channel),                      //  output,    width = 2,          .channel
		.cmd_src_startofpacket  (hps_only_master_master_limiter_cmd_src_startofpacket),                //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (hps_only_master_master_limiter_cmd_src_endofpacket),                  //  output,    width = 1,          .endofpacket
		...
		.rsp_src_ready          (hps_only_master_master_limiter_rsp_src_ready),                        //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (hps_only_master_master_limiter_rsp_src_valid),                        //  output,    width = 1,          .valid
		.rsp_src_data           (hps_only_master_master_limiter_rsp_src_data),                         //  output,  width = 210,          .data
		.rsp_src_channel        (hps_only_master_master_limiter_rsp_src_channel),                      //  output,    width = 2,          .channel
		.rsp_src_startofpacket  (hps_only_master_master_limiter_rsp_src_startofpacket),                //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (hps_only_master_master_limiter_rsp_src_endofpacket),                  //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (hps_only_master_master_limiter_cmd_valid_data)                        //  output,    width = 2, cmd_valid.data
	);

	ghrd_hps_system_altera_merlin_demultiplexer_1921_pliadaa cmd_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                      //   input,    width = 1,        clk.clk
		.reset              (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (hps_only_master_master_limiter_cmd_src_ready),                        //  output,    width = 1,       sink.ready
		.sink_channel       (hps_only_master_master_limiter_cmd_src_channel),                      //   input,    width = 2,           .channel
		.sink_data          (hps_only_master_master_limiter_cmd_src_data),                         //   input,  width = 210,           .data
		.sink_startofpacket (hps_only_master_master_limiter_cmd_src_startofpacket),                //   input,    width = 1,           .startofpacket
		.sink_endofpacket   (hps_only_master_master_limiter_cmd_src_endofpacket),                  //   input,    width = 1,           .endofpacket
		.sink_valid         (hps_only_master_master_limiter_cmd_valid_data),                       //   input,    width = 2, sink_valid.data
