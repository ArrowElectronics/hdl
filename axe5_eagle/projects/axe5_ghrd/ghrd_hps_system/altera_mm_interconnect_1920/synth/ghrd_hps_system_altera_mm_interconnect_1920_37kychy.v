// ghrd_hps_system_altera_mm_interconnect_1920_37kychy.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_37kychy (
	...
	wire  [134:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> agilex_5_soc_lwhps2fpga_agent:write_rp_data
	wire          rsp_mux_src_ready;                                                  // agilex_5_soc_lwhps2fpga_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> agilex_5_soc_lwhps2fpga_agent:write_rp_channel
	...
	wire  [134:0] rsp_mux_001_src_data;                                               // rsp_mux_001:src_data -> agilex_5_soc_lwhps2fpga_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                              // agilex_5_soc_lwhps2fpga_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                            // rsp_mux_001:src_channel -> agilex_5_soc_lwhps2fpga_agent:read_rp_channel
	...
	wire  [135:0] video_sys_0_mm_video_bridge_s0_agent_rf_source_data;                // video_sys_0_mm_video_bridge_s0_agent:rf_source_data -> video_sys_0_mm_video_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [135:0] video_sys_0_mm_video_bridge_s0_agent_rsp_fifo_out_data;             // video_sys_0_mm_video_bridge_s0_agent_rsp_fifo:out_data -> video_sys_0_mm_video_bridge_s0_agent:rf_sink_data
	...
	wire  [134:0] agilex_5_soc_lwhps2fpga_agent_write_cp_data;                        // agilex_5_soc_lwhps2fpga_agent:write_cp_data -> router:sink_data
	...
	wire  [134:0] agilex_5_soc_lwhps2fpga_agent_read_cp_data;                         // agilex_5_soc_lwhps2fpga_agent:read_cp_data -> router_001:sink_data
	...
	wire  [134:0] router_001_src_data;                                                // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire          video_sys_0_mm_video_bridge_s0_agent_rp_valid;                      // video_sys_0_mm_video_bridge_s0_agent:rp_valid -> router_002:sink_valid
	wire  [134:0] video_sys_0_mm_video_bridge_s0_agent_rp_data;                       // video_sys_0_mm_video_bridge_s0_agent:rp_data -> router_002:sink_data
	wire          video_sys_0_mm_video_bridge_s0_agent_rp_ready;                      // router_002:sink_ready -> video_sys_0_mm_video_bridge_s0_agent:rp_ready
	wire          video_sys_0_mm_video_bridge_s0_agent_rp_startofpacket;              // video_sys_0_mm_video_bridge_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          video_sys_0_mm_video_bridge_s0_agent_rp_endofpacket;                // video_sys_0_mm_video_bridge_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                  // video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> video_sys_0_mm_video_bridge_s0_burst_adapter:sink0_endofpacket
	...
	wire  [134:0] video_sys_0_mm_video_bridge_s0_burst_adapter_source0_data;          // video_sys_0_mm_video_bridge_s0_burst_adapter:source0_data -> video_sys_0_mm_video_bridge_s0_agent:cp_data
	...
	wire    [1:0] video_sys_0_mm_video_bridge_s0_burst_adapter_source0_channel;       // video_sys_0_mm_video_bridge_s0_burst_adapter:source0_channel -> video_sys_0_mm_video_bridge_s0_agent:cp_channel
	...
	ghrd_hps_system_altera_merlin_axi_master_ni_1962_2kryw2a #(
		...
		.write_cp_data          (agilex_5_soc_lwhps2fpga_agent_write_cp_data),                               //  output,  width = 135,                 .data
		...
		.write_rp_data          (rsp_mux_src_data),                                                          //   input,  width = 135,                 .data
		...
		.read_cp_data           (agilex_5_soc_lwhps2fpga_agent_read_cp_data),                                //  output,  width = 135,                 .data
		...
		.read_rp_data           (rsp_mux_001_src_data),                                                      //   input,  width = 135,                 .data
	...
	ghrd_hps_system_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (video_sys_0_mm_video_bridge_s0_agent_rp_data),                             //  output,  width = 135,                .data
		...
		.cp_data                 (video_sys_0_mm_video_bridge_s0_burst_adapter_source0_data),                //   input,  width = 135,                .data
		...
		.cp_channel              (video_sys_0_mm_video_bridge_s0_burst_adapter_source0_channel),             //   input,    width = 2,                .channel
		...
		.rf_sink_data            (video_sys_0_mm_video_bridge_s0_agent_rsp_fifo_out_data),                   //   input,  width = 136,                .data
		...
		.rf_source_data          (video_sys_0_mm_video_bridge_s0_agent_rf_source_data),                      //  output,  width = 136,                .data
	...
	ghrd_hps_system_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (video_sys_0_mm_video_bridge_s0_agent_rf_source_data),             //   input,  width = 136,        in.data
		...
		.out_data          (video_sys_0_mm_video_bridge_s0_agent_rsp_fifo_out_data),          //  output,  width = 136,       out.data
	...
	ghrd_hps_system_altera_merlin_router_1921_wtcnjaq router (
		...
		.sink_data          (agilex_5_soc_lwhps2fpga_agent_write_cp_data),                              //   input,  width = 135,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_wtcnjaq router_001 (
		...
		.sink_data          (agilex_5_soc_lwhps2fpga_agent_read_cp_data),                               //   input,  width = 135,          .data
	...
	ghrd_hps_system_altera_merlin_router_1921_fkksg5i router_002 (
		...
		.sink_data          (video_sys_0_mm_video_bridge_s0_agent_rp_data),                             //   input,  width = 135,          .data
	...
	ghrd_hps_system_altera_merlin_burst_adapter_1931_cmqelci #(
		.PKT_ADDR_H                (64),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (96),
		.PKT_BYTE_CNT_H            (81),
		...
		.source0_data          (video_sys_0_mm_video_bridge_s0_burst_adapter_source0_data),                //  output,  width = 135,          .data
		.source0_channel       (video_sys_0_mm_video_bridge_s0_burst_adapter_source0_channel),             //  output,    width = 2,          .channel
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_2574wpy cmd_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_src_ready),                                                         //  output,    width = 1,      sink.ready
		.sink_channel       (router_src_channel),                                                       //   input,    width = 2,          .channel
		.sink_data          (router_src_data),                                                          //   input,  width = 135,          .data
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_2574wpy cmd_demux_001 (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_multiplexer_1922_yhg4amy cmd_mux (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_demultiplexer_1921_kksguhi rsp_demux (
		.clk                (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_multiplexer_1922_evedfpy rsp_mux (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_multiplexer_1922_evedfpy rsp_mux_001 (
		.clk                 (agilex_5_soc_h2f_user1_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (agilex_5_soc_lwhps2fpga_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
