// ghrd_hps_system_altera_mm_interconnect_1920_dvozvda.v
...
`timescale 1 ps / 1 ps
module ghrd_hps_system_altera_mm_interconnect_1920_dvozvda (
	...
	ghrd_hps_system_altera_merlin_slave_translator_191_x56fcki #(
		...
		.clk                    (agilex_5_soc_h2f_user1_clk_clk),                                      //   input,   width = 1,                      clk.clk
		.reset                  (onchip_sram_axi_s1_translator_clk_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
	...
	ghrd_hps_system_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (agilex_5_soc_h2f_user1_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset             (onchip_sram_reset1_reset_bridge_in_reset_reset),                            //   input,    width = 1, clk_reset.reset
	...
	ghrd_hps_system_altera_merlin_traffic_limiter_1921_74hvqpa #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (107),
		.PKT_DEST_ID_L                        (107),
		.PKT_SRC_ID_H                         (106),
