...
# 
# axi_ad469x_if "axi_ad469x_if" v1.0
#  2021.10.09
# axi_ad469x_if Interface
# 
...
# 
set_module_property DESCRIPTION "AXI AD469x Interface"
set_module_property NAME axi_ad469x_if
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Analog Devices"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME axi_ad469x_if
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property REPORT_TO_TALKBACK false
set_module_property ALLOW_GREYBOX_GENERATION false
set_module_property REPORT_HIERARCHY false
set_module_property ELABORATION_CALLBACK ad469x_elaborate

# 
# file sets
# 
add_fileset quartus_synth QUARTUS_SYNTH "" "Quartus Synthesis"
set_fileset_property QUARTUS_SYNTH TOP_LEVEL axi_ad469x_if
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file axi_ad469x_if.v 		VERILOG PATH axi_ad469x_if.v TOP_LEVEL_FILE
...
add_fileset_file spi_engine_execution_1.v 	VERILOG PATH $ad_hdl_dir/library/spi_engine/spi_engine_execution_1/spi_engine_execution_1.v

#add_fileset_file util_cpack2.v 			VERILOG PATH $ad_hdl_dir/library/util_pack/util_cpack2/util_cpack2.v
add_fileset_file util_cpack2_impl.v 		VERILOG PATH $ad_hdl_dir/library/util_pack/util_cpack2/util_cpack2_impl.v
add_fileset_file pack_shell.v 			VERILOG PATH $ad_hdl_dir/library/util_pack/util_pack_common/pack_shell.v
add_fileset_file pack_network.v 		VERILOG PATH $ad_hdl_dir/library/util_pack/util_pack_common/pack_network.v
add_fileset_file pack_ctrl.v 			VERILOG PATH $ad_hdl_dir/library/util_pack/util_pack_common/pack_ctrl.v
add_fileset_file ad_perfect_shuffle.v 		VERILOG PATH $ad_hdl_dir/library/common/ad_perfect_shuffle.v
add_fileset_file pack_interconnect.v 		VERILOG PATH $ad_hdl_dir/library/util_pack/util_pack_common/pack_interconnect.v
...
add_parameter NUM_OF_CHANNELS INTEGER 16
set_parameter_property NUM_OF_CHANNELS DEFAULT_VALUE 16
...
set_parameter_property NUM_OF_CHANNELS ALLOWED_RANGES {4,6,8,10,12,14,16,18}
...
add_parameter DATA_BUS INTEGER 32
set_parameter_property DATA_BUS DEFAULT_VALUE 32
set_parameter_property DATA_BUS DISPLAY_NAME DATA_BUS 
set_parameter_property DATA_BUS TYPE INTEGER
set_parameter_property DATA_BUS UNITS None
set_parameter_property DATA_BUS ALLOWED_RANGES 8:64
set_parameter_property DATA_BUS HDL_PARAMETER true
...
# 
# connection point AD469x_interface
# 
add_interface ad469x_interface conduit end
set_interface_property ad469x_interface associatedClock s_axi_aclk
set_interface_property ad469x_interface associatedReset s_axi_aresetn
set_interface_property ad469x_interface ENABLED true
set_interface_property ad469x_interface EXPORT_OF ""
set_interface_property ad469x_interface PORT_NAME_MAP ""
set_interface_property ad469x_interface CMSIS_SVD_VARIABLES ""
set_interface_property ad469x_interface SVD_ADDRESS_GROUP ""

add_interface_port ad469x_interface rx_sclk sclk Output 1
add_interface_port ad469x_interface rx_sdi sdi Input "(NUM_OF_SDI-1) - (0) + 1"
add_interface_port ad469x_interface rx_sdo sdo Output 1
...
# 
proc ad469x_elaborate {} {
set num_channels [get_parameter_value NUM_OF_CHANNELS]
set adc_resolution [get_parameter_value ADC_RESOLUTION]

ad_interface signal adc_en_packed output 1 valid
ad_interface signal adc_sync_packed output 1 sync
ad_interface signal adc_data_packed output ($adc_resolution*$num_channels) data
ad_interface signal adc_ovf_packed input 1 ovf
ad_interface signal adc_wr_overflow output 1 ovf

add_interface enable_in conduit end
add_interface_port enable_in enable_in enable Input $num_channels
