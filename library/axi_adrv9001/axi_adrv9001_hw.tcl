...
# used only for LVDS interface to activate a single channel at a time this limitation is because of PLL limitations
#(RX2TX2_RX1TX1_N -0 for channel RX1TX1 and RX2TX2_RX1TX1_N -1 for channel RX2TX2)
#ad_ip_parameter RX2TX2_RX1TX1_N INTEGER 0  
...
add_interface_port device_if tx1_strobe_out_n_NC         tx1_strobe_out_n_NC         Output 1
...
add_interface_port device_if tx2_strobe_out_n_NC         tx2_strobe_out_n_NC         Output 1
...
if ($m_cmos_lvds_n==1) {
  add_hdl_instance clk_buf altclkctrl
  set_instance_parameter_value clk_buf {DEVICE_FAMILY} {ARRIA 10}
  set_instance_parameter_value clk_buf {CLOCK_TYPE} {Global Clock}
}
