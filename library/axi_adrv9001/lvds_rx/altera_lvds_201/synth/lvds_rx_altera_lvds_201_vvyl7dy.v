// lvds_rx_altera_lvds_201_vvyl7dy.v
...
`timescale 1 ps / 1 ps
module lvds_rx_altera_lvds_201_vvyl7dy (
	...
	lvds_rx_altera_lvds_core20_201_f27ih4y #(
		.NUM_CHANNELS                       (3),
		.J_FACTOR                           (8),
		...
		.pll_input_clock_frequency          ("442.365 MHz"),
		.pll_vco_clock_frequency            ("884.73 MHz"),
		.m_cnt_hi_div                       (2),
		.m_cnt_lo_div                       (2),
		.n_cnt_hi_div                       (1),
		.n_cnt_lo_div                       (1),
		...
		.pll_output_clock_frequency_0       ("884.73 MHz"),
		.pll_output_phase_shift_0           ("565 ps"),
		.pll_output_duty_cycle_0            (50),
		.pll_output_clock_frequency_1       ("110.59125 MHz"),
		.pll_output_phase_shift_1           ("7912 ps"),
		.pll_output_duty_cycle_1            (13),
		.pll_output_clock_frequency_2       ("110.59125 MHz"),
		...
		.pll_output_clock_frequency_5       ("221.1825 MHz"),
		.pll_output_phase_shift_5           ("1978 ps"),
		.pll_output_duty_cycle_5            (50),
		.pll_output_clock_frequency_6       ("30.507931 MHz"),
		.pll_output_phase_shift_6           ("28539 ps"),
		.pll_output_duty_cycle_6            (14),
		.pll_output_clock_frequency_7       ("30.507931 MHz"),
