...
set libname lvds_rx_altera_lvds_core20_201_23mc34a 
...
set j_factor 8 
set ref_clock_period_ns 8.143 
set slow_clock_period_ns 32.568 
set fast_clock_period_ns 4.071 
set sclk_multiply_by 8 
set sclk_divide_by 32 
set sclk_phase 0.0 
set fclk_multiply_by 8 
set fclk_divide_by 4 
set fclk_phase 180 
set loaden_multiply_by 8 
set loaden_divide_by 32 
set loaden_phase 315.0 
set loaden_duty 12.5 
set tx_outclock_fclk_multiply_by 8 
set tx_outclock_fclk_divide_by 32 
set tx_outclock_fclk_phase 0 
set tx_outclock_loaden_multiply_by 8 
set tx_outclock_loaden_divide_by 1 
set tx_outclock_loaden_phase 0.0 
set tx_outclock_loaden_duty 12.5 
set c5_phase_degree 0
set c5_duty_cycle 50.00
set c5_multiply_by 8
set c5_divide_by 4
set c6_phase_degree 0
set c6_duty_cycle 50.00
set c6_multiply_by 8
set c6_divide_by 32
set c7_phase_degree 0
set c7_duty_cycle 50.00
set c7_multiply_by 8
set c7_divide_by 32
...
foreach lvds_instance_name $lvds_instance_name_list {  
   ...
   if {[catch {set pll_out_pin [get_node_info -name [altera_iosubsystem_get_src_pll_out_pin ${lvds_core_instance_name}|channels[0].rx_non_dpa.rx_reg[0]]]}]} { set pll_out_pin "" } 
   ...
   if  {!$use_external_pll && $pll_ref_ck_name != "" && $pll_out_pin != ""} { 
      altera_iosubsystem_create_generated_clock -source "${pll_ref_ck_name}" -divide_by $c5_divide_by -multiply_by $c5_multiply_by -phase $c5_phase_degree -duty_cycle $c5_duty_cycle -name "${pll_out_pin_base}[5]"  -target "${pll_out_pin_base}[5]" 
      lappend core_clocks "${pll_out_pin_base}[5]" 
      altera_iosubsystem_create_generated_clock -source "${pll_ref_ck_name}" -divide_by $c6_divide_by -multiply_by $c6_multiply_by -phase $c6_phase_degree -duty_cycle $c6_duty_cycle -name "${pll_out_pin_base}[6]"  -target "${pll_out_pin_base}[6]" 
      lappend core_clocks "${pll_out_pin_base}[6]" 
      altera_iosubsystem_create_generated_clock -source "${pll_ref_ck_name}" -divide_by $c7_divide_by -multiply_by $c7_multiply_by -phase $c7_phase_degree -duty_cycle $c7_duty_cycle -name "${pll_out_pin_base}[7]"  -target "${pll_out_pin_base}[7]" 
      lappend core_clocks "${pll_out_pin_base}[7]" 
   } 
   ...
   foreach_in_collection i_lvdsin_node $lvdsin_nodes {
      ...
      foreach i_lvdsin_port [array names my_lvdsin_result] {
         if {$::RSKM_USE_MICRO == 1} {
            set_input_delay -clock $ref_ck_pin $half_RCCS($lvds_instance_name) [get_node_info -name $i_lvdsin_port]
         } else {
            if {$sta_flow} {
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|fiforeset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|fiforeset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|fiforeset] 
      } 
   } 
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|dpareset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|dpareset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.serdes_dpa_inst|dpareset] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].rx_non_dpa.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
      } 
   } 
