...
localparam long_strb = 16'hFF00;
localparam short_strb = 16'h8000;

wire[15:0] strb_data;

assign strb_data = CMOS_LVDS_N ? short_strb : long_strb;
  ...
  //assign dac_data_clk = dac_clk_div;
...
generate
  if (CMOS_LVDS_N == 0) begin
		assign ld_next = (CLK_DIV_IS_FAST_CLK == 0) ? 1'b1 : valid_gen[2]; // for higher data rate
	end else begin
