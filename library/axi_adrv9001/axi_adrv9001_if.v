...
module axi_adrv9001_if #(
  ...
  //assigned ref_clk to dac_1_clk for tx_dac_clk
  //assign dac_1_clk_div = ref_clk;
  
   
generate 
//if ((CMOS_LVDS_N == 1) || ((CMOS_LVDS_N == 0)&&(RX2TX2_RX1TX1_N == 0))) begin
if ((CMOS_LVDS_N == 1) || (CMOS_LVDS_N == 0)) begin
