...
set_module_property DESCRIPTION "AXI HDMI Transmit Interface 19.1"
...
add_fileset_file ad_rst.v                 VERILOG PATH common/ad_rst.v
add_fileset_file ad_csc.v                 VERILOG PATH common/ad_csc.v
add_fileset_file ad_csc_RGB2CrYCb.v       VERILOG PATH common/ad_csc_RGB2CrYCb.v
add_fileset_file ad_ss_444to422.v         VERILOG PATH common/ad_ss_444to422.v
add_fileset_file up_axi.v                 VERILOG PATH common/up_axi.v
add_fileset_file up_xfer_cntrl.v          VERILOG PATH common/up_xfer_cntrl.v
add_fileset_file up_xfer_status.v         VERILOG PATH common/up_xfer_status.v
add_fileset_file up_clock_mon.v           VERILOG PATH common/up_clock_mon.v
add_fileset_file up_hdmi_tx.v             VERILOG PATH common/up_hdmi_tx.v
add_fileset_file ad_mul.v                 VERILOG PATH intel/common/ad_mul.v
...
add_fileset_file up_xfer_cntrl_constr.sdc   SDC PATH  intel/common/up_xfer_cntrl_constr.sdc
add_fileset_file up_xfer_status_constr.sdc  SDC PATH  intel/common/up_xfer_status_constr.sdc
add_fileset_file up_clock_mon_constr.sdc    SDC PATH  intel/common/up_clock_mon_constr.sdc
add_fileset_file up_rst_constr.sdc          SDC PATH  intel/common/up_rst_constr.sdc
...
ad_ip_parameter FPGA_TECHNOLOGY INTEGER 101 true { \
  ...
  ALLOWED_RANGES { "101:Cyclone V" "110:Arria 10"}
}
