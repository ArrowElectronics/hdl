...
set_module_property NAME spi_engine_execution_v1_1
set_module_property DESCRIPTION "SPI Engine execution_1"
set_module_property VERSION 1.1
set_module_property GROUP "Analog Devices"
set_module_property DISPLAY_NAME spi_engine_execution_v1_1
set_module_property ELABORATION_CALLBACK spi_engine_execution_elaborate

# files

add_fileset quartus_synth QUARTUS_SYNTH "" "Quartus Synthesis"
set_fileset_property quartus_synth TOP_LEVEL spi_engine_execution_1
add_fileset_file spi_engine_execution_1.v VERILOG PATH $ad_hdl_dir/library/spi_engine/spi_engine_execution_1/spi_engine_execution_1.v VERILOG
