...
# 
# axi_ad463x_if "axi_ad463x_if" v1.0
#  2021.10.09
# axi_ad463x_if Interface
# 
...
# 
set_module_property DESCRIPTION "AXI AD463x Interface"
set_module_property NAME axi_ad463x_if
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Analog Devices"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME axi_ad463x_if
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property REPORT_TO_TALKBACK false
set_module_property ALLOW_GREYBOX_GENERATION false
set_module_property REPORT_HIERARCHY false
set_module_property ELABORATION_CALLBACK ad463x_elaborate

# 
# file sets
# 
add_fileset quartus_synth QUARTUS_SYNTH "" "Quartus Synthesis"
set_fileset_property QUARTUS_SYNTH TOP_LEVEL axi_ad463x_if
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file axi_ad463x_if.v 		VERILOG PATH axi_ad463x_if.v TOP_LEVEL_FILE
add_fileset_file ad463x_data_capture.v		VERILOG PATH ad463x_data_capture.v
...
add_fileset_file spi_engine_execution_2.v 	VERILOG PATH spi_engine_execution_2.v
...
set_parameter_property NUM_OF_CHANNELS ALLOWED_RANGES {1,2,4,6,8}
...
# 
# connection point AD463x_interface
# 
add_interface ad463x_interface conduit end
set_interface_property ad463x_interface associatedClock s_axi_aclk
set_interface_property ad463x_interface associatedReset s_axi_aresetn
set_interface_property ad463x_interface ENABLED true
set_interface_property ad463x_interface EXPORT_OF ""
set_interface_property ad463x_interface PORT_NAME_MAP ""
set_interface_property ad463x_interface CMSIS_SVD_VARIABLES ""
set_interface_property ad463x_interface SVD_ADDRESS_GROUP ""

add_interface_port ad463x_interface rx_sclk sclk Output 1
add_interface_port ad463x_interface rx_sdi sdi Input "(NUM_OF_SDI-1) - (0) + 1"
add_interface_port ad463x_interface rx_sdo sdo Output 1
add_interface_port ad463x_interface rx_cs_n cs_n Output 1
add_interface_port ad463x_interface rx_cnv cnv Output 1
add_interface_port ad463x_interface echo_clk echo_clk input 1
add_interface_port ad463x_interface rx_busy master_clk input 1

# 
# connection point packed signal
# 
proc ad463x_elaborate {} {
set num_channels [get_parameter_value NUM_OF_CHANNELS]

add_interface m_axis axi4stream start
set_interface_property m_axis associatedClock spi_clk
set_interface_property m_axis associatedReset s_axi_aresetn
...
add_interface_port m_axis adc_data tdata Output (32*$num_channels)
add_interface_port m_axis adc_ready tready Input 1
add_interface_port m_axis adc_valid tvalid Output 1
