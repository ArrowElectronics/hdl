...
//assign sdi_enabled = (SDI_DELAY == 2'b11)?cmd_d1_t:cmd_d1[9]; //user added
...
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_1_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_2_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_3_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_4_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_5_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_6_t;
wire [(DATA_WIDTH-1) : 0] data_sdi_shift_7_t;

generate if (ONE_BIT_SHIFT)begin

assign    data_sdi_shift_t = {data_sdi_shift[(DATA_WIDTH-2):0], sdi};
assign    data_sdi_shift_1_t = {data_sdi_shift_1[(DATA_WIDTH-2):0], sdi_1};
assign    data_sdi_shift_2_t = {data_sdi_shift_2[(DATA_WIDTH-2):0], sdi_2};
assign    data_sdi_shift_3_t = {data_sdi_shift_3[(DATA_WIDTH-2):0], sdi_3};
assign    data_sdi_shift_4_t = {data_sdi_shift_4[(DATA_WIDTH-2):0], sdi_4};
assign    data_sdi_shift_5_t = {data_sdi_shift_5[(DATA_WIDTH-2):0], sdi_5};
assign    data_sdi_shift_6_t = {data_sdi_shift_6[(DATA_WIDTH-2):0], sdi_6};
assign    data_sdi_shift_7_t = {data_sdi_shift_7[(DATA_WIDTH-2):0], sdi_7}; end

else begin

assign    data_sdi_shift_t = data_sdi_shift;
assign    data_sdi_shift_1_t = data_sdi_shift_1;
assign    data_sdi_shift_2_t = data_sdi_shift_2;
assign    data_sdi_shift_3_t = data_sdi_shift_3;
assign    data_sdi_shift_4_t = data_sdi_shift_4;
assign    data_sdi_shift_5_t = data_sdi_shift_5;
assign    data_sdi_shift_6_t = data_sdi_shift_6;
assign    data_sdi_shift_7_t = data_sdi_shift_7;end
...
assign sdi_data = (NUM_OF_SDI == 1) ? data_sdi_shift_t :
                  ...
                  (NUM_OF_SDI == 4) ? {data_sdi_shift_3_t, data_sdi_shift_2_t,
                                       data_sdi_shift_1_t, data_sdi_shift_t} :
                  (NUM_OF_SDI == 5) ? {data_sdi_shift_4_t, data_sdi_shift_3_t,
                                       data_sdi_shift_2_t, data_sdi_shift_1_t,
                                                         data_sdi_shift_t} :
                  (NUM_OF_SDI == 6) ? {data_sdi_shift_5_t, data_sdi_shift_4_t,
                                       data_sdi_shift_3_t, data_sdi_shift_2_t,
                                       data_sdi_shift_1_t, data_sdi_shift_t} :
                  (NUM_OF_SDI == 7) ? {data_sdi_shift_6_t, data_sdi_shift_5_t,
                                       data_sdi_shift_4_t, data_sdi_shift_3_t,
                                       data_sdi_shift_2_t, data_sdi_shift_1_t,
                                                         data_sdi_shift_t} :
                  (NUM_OF_SDI == 8) ? {data_sdi_shift_7_t, data_sdi_shift_6_t,
                                       data_sdi_shift_5_t, data_sdi_shift_4_t,
                                       data_sdi_shift_3_t, data_sdi_shift_2_t,
                                       data_sdi_shift_1_t, data_sdi_shift_t} : data_sdi_shift_t;
