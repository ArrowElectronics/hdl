...
# File: ad40xx_fmc_tei0022_assignments.tcl
# Generated on: Sun Apr 26 13:46:24 2020
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "ad40xx_fmc_tei0022"]} {
		puts "Project ad40xx_fmc_tei0022 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists ad40xx_fmc_tei0022]} {
		project_open -revision ad40xx_fmc_tei0022 ad40xx_fmc_tei0022
	} else {
		project_new -revision ad40xx_fmc_tei0022 ad40xx_fmc_tei0022
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "20:46:35  APRIL 25, 2020"
	set_global_assignment -name LAST_QUARTUS_VERSION "18.1.0 Lite Edition"
	set_global_assignment -name IP_SEARCH_PATHS "C:/altera/qdesigns/18.1/examples/ArrowElectronics_github/staging/hdl/library/**/*;C:/altera/qdesigns/18.1/examples/ArrowElectronics_github/staging/ghdl/library/**/*"
	...
	set_global_assignment -name TIMING_ANALYZER_REPORT_SCRIPT "C:/altera/qdesigns/18.1/examples/ArrowElectronics_github/staging/hdl/projects/scripts/adi_tquest.tcl"
	...
	set_location_assignment PIN_C13 -to ad40xx_spi_clk
	set_location_assignment PIN_B12 -to ad40xx_spi_csn
	set_location_assignment PIN_F15 -to ad40xx_spi_miso
	set_location_assignment PIN_A11 -to ad40xx_spi_mosi
