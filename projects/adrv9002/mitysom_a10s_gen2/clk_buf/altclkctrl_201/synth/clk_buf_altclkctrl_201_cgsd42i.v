...
module  clk_buf_altclkctrl_201_cgsd42i_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //clk_buf_altclkctrl_201_cgsd42i_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clk_buf_altclkctrl_201_cgsd42i  (
    inclk,
    outclk);
    ...
    clk_buf_altclkctrl_201_cgsd42i_sub  clk_buf_altclkctrl_201_cgsd42i_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
