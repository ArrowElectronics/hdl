...
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_GPIO57] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_GPIO57]
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_GPIO58] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_GPIO58]
