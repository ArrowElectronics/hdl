...
(
    ...
    // ( 0x40000 .. 0x50000 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 20'h40000  && read_transaction  ) begin
            src_channel = 13'b000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x50000 .. 0x50800 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 20'h50000  && read_transaction  ) begin
            src_channel = 13'b000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x90000 .. 0x90800 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 20'h90000  && read_transaction  ) begin
            src_channel = 13'b000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0xa0000 .. 0xb0000 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 20'ha0000  && read_transaction  ) begin
