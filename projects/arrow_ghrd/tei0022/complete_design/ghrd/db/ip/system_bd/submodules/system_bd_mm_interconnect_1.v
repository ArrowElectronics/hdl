...
module system_bd_mm_interconnect_1 (
		...
		input  wire        axi_dmac_0_m_src_axi_id_pad_clk_reset_reset_bridge_in_reset_reset, // axi_dmac_0_m_src_axi_id_pad_clk_reset_reset_bridge_in_reset.reset
		input  wire        axi_dmac_0_m_src_axi_reset_reset_bridge_in_reset_reset             //            axi_dmac_0_m_src_axi_reset_reset_bridge_in_reset.reset
	);
	...
	altera_merlin_axi_translator #(
		...
		.S0_LOCK_WIDTH                     (2),
		.S0_AXI_VERSION                    ("AXI3")
	) axi_dmac_0_m_src_axi_id_pad (
		.aclk        (sys_hps_h2f_user1_clock_clk),                                          //       clk.clk
		.aresetn     (~axi_dmac_0_m_src_axi_id_pad_clk_reset_reset_bridge_in_reset_reset),   // clk_reset.reset_n
		...
		.s0_awid     (axi_dmac_0_m_src_axi_awid),                                            //        s0.awid
		.s0_awaddr   (axi_dmac_0_m_src_axi_awaddr),                                          //          .awaddr
		.s0_awlen    (axi_dmac_0_m_src_axi_awlen),                                           //          .awlen
		.s0_awsize   (axi_dmac_0_m_src_axi_awsize),                                          //          .awsize
		.s0_awburst  (axi_dmac_0_m_src_axi_awburst),                                         //          .awburst
		.s0_awlock   (axi_dmac_0_m_src_axi_awlock),                                          //          .awlock
		.s0_awcache  (axi_dmac_0_m_src_axi_awcache),                                         //          .awcache
		.s0_awprot   (axi_dmac_0_m_src_axi_awprot),                                          //          .awprot
		.s0_awvalid  (axi_dmac_0_m_src_axi_awvalid),                                         //          .awvalid
		.s0_awready  (axi_dmac_0_m_src_axi_awready),                                         //          .awready
		.s0_wid      (axi_dmac_0_m_src_axi_wid),                                             //          .wid
		.s0_wdata    (axi_dmac_0_m_src_axi_wdata),                                           //          .wdata
		.s0_wstrb    (axi_dmac_0_m_src_axi_wstrb),                                           //          .wstrb
		.s0_wlast    (axi_dmac_0_m_src_axi_wlast),                                           //          .wlast
		.s0_wvalid   (axi_dmac_0_m_src_axi_wvalid),                                          //          .wvalid
		.s0_wready   (axi_dmac_0_m_src_axi_wready),                                          //          .wready
		.s0_bid      (axi_dmac_0_m_src_axi_bid),                                             //          .bid
		.s0_bresp    (axi_dmac_0_m_src_axi_bresp),                                           //          .bresp
		.s0_bvalid   (axi_dmac_0_m_src_axi_bvalid),                                          //          .bvalid
		.s0_bready   (axi_dmac_0_m_src_axi_bready),                                          //          .bready
		.s0_arid     (axi_dmac_0_m_src_axi_arid),                                            //          .arid
		.s0_araddr   (axi_dmac_0_m_src_axi_araddr),                                          //          .araddr
		.s0_arlen    (axi_dmac_0_m_src_axi_arlen),                                           //          .arlen
		.s0_arsize   (axi_dmac_0_m_src_axi_arsize),                                          //          .arsize
		.s0_arburst  (axi_dmac_0_m_src_axi_arburst),                                         //          .arburst
		.s0_arlock   (axi_dmac_0_m_src_axi_arlock),                                          //          .arlock
		.s0_arcache  (axi_dmac_0_m_src_axi_arcache),                                         //          .arcache
		.s0_arprot   (axi_dmac_0_m_src_axi_arprot),                                          //          .arprot
		.s0_arvalid  (axi_dmac_0_m_src_axi_arvalid),                                         //          .arvalid
		.s0_arready  (axi_dmac_0_m_src_axi_arready),                                         //          .arready
		.s0_rid      (axi_dmac_0_m_src_axi_rid),                                             //          .rid
		.s0_rdata    (axi_dmac_0_m_src_axi_rdata),                                           //          .rdata
		.s0_rresp    (axi_dmac_0_m_src_axi_rresp),                                           //          .rresp
		.s0_rlast    (axi_dmac_0_m_src_axi_rlast),                                           //          .rlast
		.s0_rvalid   (axi_dmac_0_m_src_axi_rvalid),                                          //          .rvalid
		.s0_rready   (axi_dmac_0_m_src_axi_rready),                                          //          .rready
