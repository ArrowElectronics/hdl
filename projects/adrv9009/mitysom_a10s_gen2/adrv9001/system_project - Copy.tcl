...
set_location_assignment PIN_T7   -to dev_mcs_fpga_out_n  ; ## FMCA_HPC_LA14_N
set_location_assignment PIN_T6   -to dev_mcs_fpga_out_p  ; ## FMCA_HPC_LA14_P
set_location_assignment PIN_AG18   -to dgpio_0             ; ## FMCA_HPC_LA16_P
set_location_assignment PIN_AG19  -to dgpio_1             ; ## FMCA_HPC_LA16_N
...
#set_location_assignment PIN_V8   -to tx2_dclk_in_n       ; ## FMCA_HPC_LA18_CC_N
#set_location_assignment PIN_U8   -to tx2_dclk_in_p       ; ## FMCA_HPC_LA18_CC_P
#set_location_assignment PIN_AB15   -to tx2_dclk_out_n      ; ## FMCA_HPC_LA22_N
#set_location_assignment PIN_AC15   -to tx2_dclk_out_p      ; ## FMCA_HPC_LA22_P
...
set_location_assignment PIN_Y16  -to rx2_strobe_in_n     ; ## FMCA_HPC_LA21_N
set_location_assignment PIN_Y15  -to rx2_strobe_in_p     ; ## FMCA_HPC_LA21_P
set_location_assignment PIN_AB25  -to tx1_dclk_in_n       ; ## FMCA_HPC_LA01_CC_N
set_location_assignment PIN_AB26  -to tx1_dclk_in_p       ; ## FMCA_HPC_LA01_CC_P
set_location_assignment PIN_L3   -to tx2_dclk_in_n       ; ## FMCA_HPC_LA18_CC_N
set_location_assignment PIN_L2   -to tx2_dclk_in_p       ; ## FMCA_HPC_LA18_CC_P
set_location_assignment PIN_W2  -to tx2_dclk_out_n      ; ## FMCA_HPC_LA22_N
set_location_assignment PIN_V2  -to tx2_dclk_out_p      ; ## FMCA_HPC_LA22_P
set_location_assignment PIN_AD20  -to rx1_dclk_in_n       ; ## FMCA_HPC_LA00_CC_N
set_location_assignment PIN_AD19  -to rx1_dclk_in_p       ; ## FMCA_HPC_LA00_CC_P

set_location_assignment PIN_U6  -to tx2_idata_out_n     ; ## FMCA_HPC_LA23_N
set_location_assignment PIN_V7  -to tx2_idata_out_p     ; ## FMCA_HPC_LA23_P
...
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_dclk_in_n 
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_dclk_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_idata_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_idata_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_qdata_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_qdata_in_p

set_instance_assignment -name IO_STANDARD LVDS  -to rx1_strobe_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx1_strobe_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_dclk_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_dclk_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_idata_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_idata_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_qdata_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_qdata_in_p
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_strobe_in_n
set_instance_assignment -name IO_STANDARD LVDS  -to rx2_strobe_in_p

set_instance_assignment -name IO_STANDARD LVDS  -to tx1_dclk_out_n
set_instance_assignment -name IO_STANDARD LVDS  -to tx1_dclk_out_p
set_instance_assignment -name IO_STANDARD LVDS  -to tx1_dclk_in_n
set_instance_assignment -name IO_STANDARD LVDS -to tx1_dclk_in_p
set_instance_assignment -name IO_STANDARD LVDS -to tx1_idata_out_n
set_instance_assignment -name IO_STANDARD LVDS -to tx1_idata_out_p
set_instance_assignment -name IO_STANDARD LVDS -to tx1_qdata_out_n
set_instance_assignment -name IO_STANDARD LVDS -to tx1_qdata_out_p
set_instance_assignment -name IO_STANDARD LVDS -to tx1_strobe_out_n
set_instance_assignment -name IO_STANDARD LVDS -to tx1_strobe_out_p

set_instance_assignment -name IO_STANDARD LVDS -to tx2_dclk_out_n 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_dclk_out_p 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_dclk_in_n 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_dclk_in_p 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_idata_out_n 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_idata_out_p 
set_instance_assignment -name IO_STANDARD LVDS -to tx2_qdata_out_n
set_instance_assignment -name IO_STANDARD LVDS -to tx2_qdata_out_p
set_instance_assignment -name IO_STANDARD LVDS -to tx2_strobe_out_n 
