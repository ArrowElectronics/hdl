...
module  clk1_altclkctrl_201_e3v3a7q_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //clk1_altclkctrl_201_e3v3a7q_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clk1_altclkctrl_201_e3v3a7q  (
    inclk,
    outclk);
    ...
    clk1_altclkctrl_201_e3v3a7q_sub  clk1_altclkctrl_201_e3v3a7q_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
