// lvds_rx1_altera_lvds_201_2mu6chy.v
...
`timescale 1 ps / 1 ps
module lvds_rx1_altera_lvds_201_2mu6chy (
	...
	lvds_rx1_altera_lvds_core20_201_h4ceduq #(
		.NUM_CHANNELS                       (3),
		.J_FACTOR                           (8),
		...
		.rx_coreclock            (rx_outclock),                  // rx_coreclock_conduit_end.export
		.inclock                 (rx_inclock),                   //      inclock_conduit_end.export
		.pll_areset              (pll_areset),                   //   pll_areset_conduit_end.export
		.pll_locked              (rx_locked),                    //   pll_locked_conduit_end.export
