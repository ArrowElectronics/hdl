module lvds_rx1_altera_lvds_core20_201_h4ceduq #(
   ...
   input  logic [23:0]     tx_in,
   output logic [2:0]      tx_out,
   output logic            tx_outclock,
   output logic            tx_coreclock,
   input  logic [2:0]      rx_in,
   output logic [23:0]     rx_out,
   input  logic [2:0]      rx_bitslip_reset,
   input  logic [2:0]      rx_bitslip_ctrl,
   output logic [2:0]      rx_bitslip_max,
   ...
   output logic [2:0]      rx_dpa_locked,
   input  logic [2:0]      rx_dpa_hold,
   input  logic [2:0]      rx_dpa_reset,
   input  logic [2:0]      rx_fifo_reset,
   output logic [2:0]      rx_divfwdclk,
   input  logic [2:0]      loopback_in,
   output logic [2:0]      loopback_out,
