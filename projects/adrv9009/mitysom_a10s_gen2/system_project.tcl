...
adi_project adrv9009_mitysom_a10s
...
set_location_assignment PIN_AD25  -to "rx_serial_data[0](n)" ; ## A03  FMC_HPC_DP1_M2C_N
set_location_assignment PIN_AB26  -to rx_serial_data[1]      ; ## A06  FMC_HPC_DP2_M2C_P
set_location_assignment PIN_AB25  -to "rx_serial_data[1](n)" ; ## A07  FMC_HPC_DP2_M2C_N
set_location_assignment PIN_AF26  -to rx_serial_data[2]      ; ## C06  FMC_HPC_DP0_M2C_P
set_location_assignment PIN_AF25  -to "rx_serial_data[2](n)" ; ## C07  FMC_HPC_DP0_M2C_N
set_location_assignment PIN_Y26  -to rx_serial_data[3]      ; ## A10  FMC_HPC_DP3_M2C_P
set_location_assignment PIN_Y25  -to "rx_serial_data[3](n)" ; ## A11  FMC_HPC_DP3_M2C_N
set_location_assignment PIN_AE28  -to tx_serial_data[0]      ; ## A22  FMC_HPC_DP1_C2M_P (tx_serial_data_p[3])
set_location_assignment PIN_AE27  -to "tx_serial_data[0](n)" ; ## A23  FMC_HPC_DP1_C2M_N (tx_serial_data_n[3])
set_location_assignment PIN_AC28  -to tx_serial_data[1]      ; ## A26  FMC_HPC_DP2_C2M_P (tx_serial_data_p[0])
set_location_assignment PIN_AC27  -to "tx_serial_data[1](n)" ; ## A27  FMC_HPC_DP2_C2M_N (tx_serial_data_n[0])
set_location_assignment PIN_AG28  -to tx_serial_data[2]      ; ## C02  FMC_HPC_DP0_C2M_P (tx_serial_data_p[1])
set_location_assignment PIN_AG27  -to "tx_serial_data[2](n)" ; ## C03  FMC_HPC_DP0_C2M_N (tx_serial_data_n[1])
set_location_assignment PIN_AA28  -to tx_serial_data[3]      ; ## A30  FMC_HPC_DP3_C2M_P (tx_serial_data_p[2])
set_location_assignment PIN_AA27  -to "tx_serial_data[3](n)" ; ## A31  FMC_HPC_DP3_C2M_N (tx_serial_data_n[2])
...
set_location_assignment PIN_AG14  -to sysref                ; ## G06  FMC_HPC_LA00_CC_P		(different to 9371, changed fpga pin) 
set_location_assignment PIN_AG15  -to sysref(n)             ; ## G07  FMC_HPC_LA00_CC_N 	(different to 9371, changed fpga pin)
set_location_assignment PIN_M3    -to tx_sync_1             ; ## H28  FMC_HPC_LA24_P 		(additional signal added fpga pin)
set_location_assignment PIN_M4    -to tx_sync_1(n)          ; ## H29  FMC_HPC_LA24_N 		(additional signal added fpga pin)
...
set_location_assignment PIN_AD14  -to spi_csn_adrv9009      ; ## D14  FMC_HPC_LA09_P
...
set_location_assignment PIN_AE17  -to adrv9009_tx1_enable     ; ## D17  FMC_HPC_LA13_P
set_location_assignment PIN_AE15  -to adrv9009_tx2_enable     ; ## C18  FMC_HPC_LA14_P
set_location_assignment PIN_AD17  -to adrv9009_rx1_enable     ; ## D18  FMC_HPC_LA13_N
set_location_assignment PIN_AE14  -to adrv9009_rx2_enable     ; ## C19  FMC_HPC_LA14_N
set_location_assignment PIN_AF17  -to adrv9009_test           ; ## H16  FMC_HPC_LA11_P (different to 9371, changed fpga pin, 9371 comment was DNI/NC)
set_location_assignment PIN_AF13  -to adrv9009_reset_b        ; ## H10  FMC_HPC_LA04_P
set_location_assignment PIN_AF14  -to adrv9009_gpint          ; ## H11  FMC_HPC_LA04_N
...
set_location_assignment PIN_AG16  -to adrv9009_gpio[0]        ; ## H19  FMC_HPC_LA15_P
set_location_assignment PIN_AF16  -to adrv9009_gpio[1]        ; ## H20  FMC_HPC_LA15_N
set_location_assignment PIN_AG18  -to adrv9009_gpio[2]        ; ## G18  FMC_HPC_LA16_P
set_location_assignment PIN_AF19  -to adrv9009_gpio[3]        ; ## G19  FMC_HPC_LA16_N
set_location_assignment PIN_P3    -to adrv9009_gpio[4]        ; ## H25  FMC_HPC_LA21_P
set_location_assignment PIN_P4    -to adrv9009_gpio[5]        ; ## H26  FMC_HPC_LA21_N
set_location_assignment PIN_AC15  -to adrv9009_gpio[6]        ; ## C22  FMC_HPC_LA18_CC_P
set_location_assignment PIN_AB15  -to adrv9009_gpio[7]        ; ## C23  FMC_HPC_LA18_CC_N
set_location_assignment PIN_V8    -to adrv9009_gpio[8]        ; ## G25  FMC_HPC_LA22_N     (LVDS_1N)
set_location_assignment PIN_AE19  -to adrv9009_gpio[9]        ; ## H22  FMC_HPC_LA19_P     (LVDS_2P)
set_location_assignment PIN_AE20  -to adrv9009_gpio[10]       ; ## H23  FMC_HPC_LA19_N     (LVDS_2N)
set_location_assignment PIN_AD18  -to adrv9009_gpio[11]       ; ## G21  FMC_HPC_LA20_P     (LVDS_3P)
set_location_assignment PIN_AC18  -to adrv9009_gpio[12]       ; ## G22  FMC_HPC_LA20_N     (LVDS_3N)
set_location_assignment PIN_AC17  -to adrv9009_gpio[13]       ; ## G16  FMC_HPC_LA12_N     (LVDS_4N) 
set_location_assignment PIN_AC16  -to adrv9009_gpio[14]       ; ## G15  FMC_HPC_LA12_P     (LVDS_4P)
set_location_assignment PIN_U8    -to adrv9009_gpio[15]       ; ## G24  FMC_HPC_LA22_P     (LVDS_1P)
set_location_assignment PIN_AF11  -to adrv9009_gpio[16]       ; ## C11  FMC_HPC_LA06_N     (LVDS_5N)	(different to 9371, changed fpga pin)
set_location_assignment PIN_AF12  -to adrv9009_gpio[17]       ; ## C10  FMC_HPC_LA06_P     (LVDS_5P) 	(different to 9371, changed fpga pin)
set_location_assignment PIN_AF18  -to adrv9009_gpio[18]       ; ## H17  FMC_HPC_LA05_N					(different to 9371, changed fpga pin)
